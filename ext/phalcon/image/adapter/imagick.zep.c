...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, check) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "defined", NULL, 24, &_2);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, __construct) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_image"), &_1);
	zephir_read_property(&_2, this_ptr, ZEND_STRL("_file"), PH_NOISY_CC | PH_READONLY);
	if ((zephir_file_exists(&_2) == SUCCESS)) {
		zephir_read_property(&_3$$4, this_ptr, ZEND_STRL("_file"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&_4$$4, "realpath", NULL, 53, &_3$$4);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, ZEND_STRL("_realpath"), &_4$$4);
		zephir_read_property(&_5$$4, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
		zephir_read_property(&_7$$4, this_ptr, ZEND_STRL("_realpath"), PH_NOISY_CC | PH_READONLY);
		...
		if (!(zephir_is_true(&_6$$4))) {
			...
			zephir_read_property(&_9$$5, this_ptr, ZEND_STRL("_file"), PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property(&_11$$4, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
		...
		if (!(zephir_is_true(&_12$$4))) {
			...
			ZEPHIR_CALL_FUNCTION(&_15$$6, "constant", NULL, 25, &_14$$6);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, &_13$$6, "setimagealphachannel", NULL, 0, &_15$$6);
			zephir_check_call_status();
		}
		zephir_read_property(&_16$$4, this_ptr, ZEND_STRL("_type"), PH_NOISY_CC | PH_READONLY);
		if (ZEPHIR_IS_LONG(&_16$$4, 1)) {
			zephir_read_property(&_17$$7, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(&image, &_17$$7, "coalesceimages", NULL, 0);
			zephir_check_call_status();
			zephir_read_property(&_18$$7, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(NULL, &_18$$7, "clear", NULL, 0);
			zephir_check_call_status();
			zephir_read_property(&_19$$7, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
		...
		if (_20$$8) {
			...
			zephir_read_property(&_22$$9, this_ptr, ZEND_STRL("_file"), PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property(&_24$$8, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		zephir_read_property(&_27$$8, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&_26$$8);
		ZVAL_STRING(&_26$$8, "png");
		ZEPHIR_CALL_METHOD(NULL, &_27$$8, "setformat", NULL, 0, &_26$$8);
		zephir_check_call_status();
		zephir_read_property(&_28$$8, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&_26$$8);
		ZVAL_STRING(&_26$$8, "png");
		ZEPHIR_CALL_METHOD(NULL, &_28$$8, "setimageformat", NULL, 0, &_26$$8);
		zephir_check_call_status();
		zephir_read_property(&_29$$8, this_ptr, ZEND_STRL("_file"), PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_realpath"), &_29$$8);
	}
	zephir_read_property(&_30, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_31, &_30, "getimagewidth", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_width"), &_31);
	zephir_read_property(&_32, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_33, &_32, "getimageheight", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_height"), &_33);
	zephir_read_property(&_34, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_35, &_34, "getimagetype", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_type"), &_35);
	zephir_read_property(&_36, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_37, &_36, "getimageformat", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_38);
	ZEPHIR_CONCAT_SV(&_38, "image/", &_37);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_mime"), &_38);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _resize) {
	...
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_width"), &_6);
	ZEPHIR_CALL_METHOD(&_7, &image, "getimageheight", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_height"), &_7);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _liquidRescale) {
	...
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_width"), &_8);
	ZEPHIR_CALL_METHOD(&_9, &image, "getimageheight", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_height"), &_9);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _crop) {
	...
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_width"), &_9);
	ZEPHIR_CALL_METHOD(&_10, &image, "getimageheight", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_height"), &_10);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _rotate) {
	...
	while (1) {
		zephir_read_property(&_2$$3, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property(&_4$$3, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		zephir_read_property(&_6$$3, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_height"), &_11);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _reflection) {
	...
	if (ZEPHIR_GE_LONG(&_0, 30100)) {
		zephir_read_property(&_1$$3, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_20$$7, "constant", &_21, 25, &_19$$7);
		zephir_check_call_status();
		ZVAL_LONG(&_22$$7, 0);
		ZVAL_LONG(&_23$$7, 0);
		...
		ZEPHIR_CALL_FUNCTION(&_25$$7, "constant", &_21, 25, &_19$$7);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_19$$7);
		ZVAL_STRING(&_19$$7, "Imagick::CHANNEL_ALPHA");
		ZEPHIR_CALL_FUNCTION(&_26$$7, "constant", &_21, 25, &_19$$7);
		zephir_check_call_status();
	...
	zephir_read_property(&_31, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_32, 0);
	ZEPHIR_CALL_METHOD(NULL, &_31, "setiteratorindex", NULL, 0, &_32);
	zephir_check_call_status();
	while (1) {
		zephir_read_property(&_33$$10, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC | PH_READONLY);
		...
		ZEPHIR_CALL_FUNCTION(&_37$$10, "constant", &_21, 25, &_36$$10);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &image, "setimagealphachannel", &_38, 0, &_37$$10);
		zephir_check_call_status();
		zephir_read_property(&_34$$10, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_39$$10, &_34$$10, "getcolorspace", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &image, "setcolorspace", &_40, 0, &_39$$10);
		zephir_check_call_status();
		zephir_read_property(&_41$$10, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_42$$10, &_41$$10, "getimagedelay", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &image, "setimagedelay", &_43, 0, &_42$$10);
		zephir_check_call_status();
		zephir_read_property(&_44$$10, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&_36$$10);
		ZVAL_STRING(&_36$$10, "Imagick::COMPOSITE_SRC");
		ZEPHIR_CALL_FUNCTION(&_45$$10, "constant", &_21, 25, &_36$$10);
		zephir_check_call_status();
		ZVAL_LONG(&_46$$10, 0);
		ZVAL_LONG(&_47$$10, 0);
		...
		zephir_read_property(&_46$$10, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_51$$13, "constant", &_21, 25, &_50$$13);
		zephir_check_call_status();
		zephir_read_property(&_52$$13, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_53$$13, 0);
	...
	zephir_check_call_status();
	zephir_read_property(&_58, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, &_58, "destroy", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_image"), &image);
	zephir_read_property(&_59, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_60, &_59, "getimagewidth", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_width"), &_60);
	zephir_read_property(&_61, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_62, &_61, "getimageheight", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_height"), &_62);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _watermark) {
	...
	bool is_null_true = 1;
	ZEND_PARSE_PARAMETERS_START(4, 4)
		Z_PARAM_OBJECT_OF_CLASS(image, phalcon_image_adapter_ce)
		Z_PARAM_LONG(offsetX)
		Z_PARAM_LONG(offsetY)
		Z_PARAM_LONG(opacity)
	ZEND_PARSE_PARAMETERS_END();
	...
	zephir_check_call_status();
	while (1) {
		zephir_read_property(&_4$$5, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&_5$$5);
		ZVAL_STRING(&_5$$5, "Imagick::COMPOSITE_OVER");
		ZEPHIR_CALL_FUNCTION(&_6$$5, "constant", &_7, 25, &_5$$5);
		zephir_check_call_status();
		...
		zephir_read_property(&_8$$5, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _text) {
	...
	ZVAL_LONG(&_2, g);
	ZVAL_LONG(&_3, b);
	ZEPHIR_CALL_FUNCTION(&color, "sprintf", NULL, 138, &_0, &_1, &_2, &_3);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
			...
			if (Z_TYPE_P(offsetY) == IS_LONG) {
				...
				if (zephir_is_true(offsetX)) {
					...
					if (y < 0) {
						...
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 25, &_11$$17);
						zephir_check_call_status();
					} else {
						ZVAL_LONG(offsetX, 0);
						ZEPHIR_INIT_VAR(&_12$$18);
						ZVAL_STRING(&_12$$18, "Imagick::GRAVITY_NORTHEAST");
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 25, &_12$$18);
						zephir_check_call_status();
					}
				} else {
					ZEPHIR_INIT_NVAR(offsetX);
					if (y < 0) {
						...
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 25, &_13$$20);
						zephir_check_call_status();
					} else {
						ZVAL_LONG(offsetX, 0);
						ZEPHIR_INIT_VAR(&_14$$21);
						ZVAL_STRING(&_14$$21, "Imagick::GRAVITY_NORTH");
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 25, &_14$$21);
						zephir_check_call_status();
					}
				}
			}
				...
				if (((Z_TYPE_P(offsetY) == IS_TRUE || Z_TYPE_P(offsetY) == IS_FALSE) == 1)) {
					if (zephir_is_true(offsetY)) {
						...
						if (x < 0) {
							...
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 25, &_15$$27);
							zephir_check_call_status();
						} else {
							ZVAL_LONG(offsetY, 0);
							ZEPHIR_INIT_VAR(&_16$$28);
							ZVAL_STRING(&_16$$28, "Imagick::GRAVITY_SOUTH");
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 25, &_16$$28);
							zephir_check_call_status();
						}
					} else {
						ZEPHIR_INIT_NVAR(offsetY);
						if (x < 0) {
							...
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 25, &_17$$30);
							zephir_check_call_status();
						} else {
							ZVAL_LONG(offsetY, 0);
							ZEPHIR_INIT_VAR(&_18$$31);
							ZVAL_STRING(&_18$$31, "Imagick::GRAVITY_WEST");
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 25, &_18$$31);
							zephir_check_call_status();
						}
					}
				} else {
					if (Z_TYPE_P(offsetY) == IS_LONG) {
						...
						if (x < 0) {
							...
							if (y < 0) {
								...
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 25, &_19$$35);
								zephir_check_call_status();
							} else {
								ZVAL_LONG(offsetX, (x * -1));
								ZEPHIR_INIT_VAR(&_20$$36);
								ZVAL_STRING(&_20$$36, "Imagick::GRAVITY_NORTHEAST");
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 25, &_20$$36);
								zephir_check_call_status();
							}
						} else {
							ZEPHIR_INIT_NVAR(offsetX);
							if (y < 0) {
								...
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 25, &_21$$38);
								zephir_check_call_status();
							} else {
								ZVAL_LONG(offsetX, 0);
								ZEPHIR_INIT_VAR(&_22$$39);
								ZVAL_STRING(&_22$$39, "Imagick::GRAVITY_NORTHWEST");
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 25, &_22$$39);
								zephir_check_call_status();
							}
						}
					}
	...
	zephir_check_call_status();
	while (1) {
		zephir_read_property(&_23$$40, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_24$$40, 0);
		ZEPHIR_CALL_METHOD(NULL, &_23$$40, "annotateimage", NULL, 0, &draw, offsetX, offsetY, &_24$$40, &text);
		zephir_check_call_status();
		zephir_read_property(&_24$$40, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _mask) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_6$$3, "constant", &_7, 25, &_5$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_8$$3, 0);
		ZVAL_LONG(&_9$$3, 0);
		...
		zephir_read_property(&_8$$3, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _background) {
	...
	while (1) {
		...
		if (!(zephir_is_true(&_7$$3))) {
			...
			ZEPHIR_CALL_FUNCTION(&_10$$4, "constant", &_11, 25, &_9$$4);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_15$$3, "constant", &_11, 25, &_14$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_14$$3);
		ZVAL_STRING(&_14$$3, "Imagick::CHANNEL_ALPHA");
		ZEPHIR_CALL_FUNCTION(&_16$$3, "constant", &_11, 25, &_14$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_17$$3, opacity);
		ZEPHIR_CALL_METHOD(NULL, &background, "evaluateimage", &_18, 0, &_15$$3, &_17$$3, &_16$$3);
		zephir_check_call_status();
		zephir_read_property(&_17$$3, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_19$$3, &_17$$3, "getcolorspace", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &background, "setcolorspace", &_20, 0, &_19$$3);
		zephir_check_call_status();
		zephir_read_property(&_21$$3, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&_14$$3);
		ZVAL_STRING(&_14$$3, "Imagick::COMPOSITE_DISSOLVE");
		ZEPHIR_CALL_FUNCTION(&_22$$3, "constant", &_11, 25, &_14$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_23$$3, 0);
		ZVAL_LONG(&_24$$3, 0);
	...
	zephir_check_call_status();
	zephir_read_property(&_3, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _pixelate) {
	...
	while (1) {
		...
		zephir_check_call_status();
		zephir_read_property(&_5$$3, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
		zephir_read_property(&_6$$3, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC | PH_READONLY);
		zephir_read_property(&_7$$3, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _save) {
	...
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_type"), &_3);
	zephir_read_property(&_4, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_5, &_4, "getimageformat", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_6);
	ZEPHIR_CONCAT_SV(&_6, "image/", &_5);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_mime"), &_6);
	ZEPHIR_INIT_VAR(&_7);
	ZVAL_STRING(&_7, "gif");
	...
	if (ZEPHIR_IS_LONG(&_8, 0)) {
		...
		ZVAL_STRING(&_10$$3, "w");
		ZEPHIR_CALL_FUNCTION(&fp, "fopen", NULL, 229, &file, &_10$$3);
		zephir_check_call_status();
		...
		if (_14$$4) {
			zephir_read_property(&_16$$5, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_INIT_VAR(&_17$$5);
			ZVAL_STRING(&_17$$5, "Imagick::COMPRESSION_JPEG");
			ZEPHIR_CALL_FUNCTION(&_18$$5, "constant", NULL, 25, &_17$$5);
			zephir_check_call_status();
		...
		if (quality >= 0) {
			...
			zephir_read_property(&_19$$6, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
			ZVAL_LONG(&_20$$6, quality);
			ZEPHIR_CALL_METHOD(NULL, &_19$$6, "setimagecompressionquality", NULL, 0, &_20$$6);
			zephir_check_call_status();
		}
		zephir_read_property(&_21$$4, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _render) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_mime"), &_2);
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "gif");
	...
	if (ZEPHIR_IS_LONG_IDENTICAL(&_4, 0)) {
		...
		if (_7$$4) {
			...
			ZEPHIR_CALL_FUNCTION(&_10$$5, "constant", NULL, 25, &_9$$5);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, __destruct) {
	...
	ZEPHIR_OBS_VAR(&_0);
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_image"), PH_NOISY_CC);
