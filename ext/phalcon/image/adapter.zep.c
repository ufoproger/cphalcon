...
PHP_METHOD(Phalcon_Image_Adapter, resize) {
	...
	if (master == 7) {
		...
		if (master == 4) {
			...
			zephir_read_property(&_3$$6, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC | PH_READONLY);
			zephir_read_property(&_4$$6, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC | PH_READONLY);
		...
		if (master == 5) {
			...
			zephir_read_property(&_7$$8, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC | PH_READONLY);
			zephir_read_property(&_8$$8, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC | PH_READONLY);
		...
		do {
			if (master == 2) {
				...
				zephir_read_property(&_9$$10, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC | PH_READONLY);
				zephir_read_property(&_10$$10, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC | PH_READONLY);
			...
			if (master == 3) {
				...
				zephir_read_property(&_11$$12, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC | PH_READONLY);
				zephir_read_property(&_12$$12, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC | PH_READONLY);
			...
			if (master == 6) {
				...
				zephir_read_property(&_14$$14, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC | PH_READONLY);
				zephir_read_property(&_15$$14, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC | PH_READONLY);
				...
				if ((zephir_safe_div_long_long(width, height)) > ratio) {
					zephir_read_property(&_17$$16, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC | PH_READONLY);
					zephir_read_property(&_18$$16, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC | PH_READONLY);
					height = (long) (zephir_safe_div_long_zval((zephir_get_numberval(&_17$$16) * width), &_18$$16));
				} else {
					zephir_read_property(&_19$$17, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC | PH_READONLY);
					zephir_read_property(&_20$$17, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC | PH_READONLY);
			...
			if (master == 1) {
				if (!(width)) {
					...
					zephir_read_property(&_21$$19, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC);
					width = zephir_get_intval(&_21$$19);
				}
				if (!(height)) {
					ZEPHIR_OBS_VAR(&_22$$20);
					zephir_read_property(&_22$$20, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC);
	...
	ZVAL_LONG(&_25, 1);
	ZEPHIR_CALL_FUNCTION(&_26, "max", NULL, 61, &_23, &_25);
	...
	ZVAL_LONG(&_28, 1);
	ZEPHIR_CALL_FUNCTION(&_29, "max", NULL, 61, &_27, &_28);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter, crop) {
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		zephir_read_property(&_1$$3, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC | PH_READONLY);
		offsetX = (long) ((zephir_safe_div_long_long(((zephir_get_numberval(&_1$$3) - width)), 2)));
	} else {
		if (offsetX < 0) {
			zephir_read_property(&_2$$5, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC | PH_READONLY);
			offsetX = ((zephir_get_numberval(&_2$$5) - width) + offsetX);
		}
		zephir_read_property(&_3$$4, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC | PH_READONLY);
		if (ZEPHIR_LT_LONG(&_3$$4, offsetX)) {
			ZEPHIR_OBS_VAR(&_4$$6);
			zephir_read_property(&_4$$6, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC);
			offsetX = zephir_get_intval(&_4$$6);
		}
	}
	ZVAL_LONG(&_5, offsetY);
	if (Z_TYPE_P(&_5) == IS_NULL) {
		zephir_read_property(&_6$$7, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC | PH_READONLY);
		offsetY = (long) ((zephir_safe_div_long_long(((zephir_get_numberval(&_6$$7) - height)), 2)));
	} else {
		if (offsetY < 0) {
			zephir_read_property(&_7$$9, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC | PH_READONLY);
			offsetY = ((zephir_get_numberval(&_7$$9) - height) + offsetY);
		}
		zephir_read_property(&_8$$8, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC | PH_READONLY);
		if (ZEPHIR_LT_LONG(&_8$$8, offsetY)) {
			ZEPHIR_OBS_VAR(&_9$$10);
			zephir_read_property(&_9$$10, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC);
			offsetY = zephir_get_intval(&_9$$10);
		}
	}
	zephir_read_property(&_10, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC | PH_READONLY);
	if (width > ((zephir_get_numberval(&_10) - offsetX))) {
		zephir_read_property(&_11$$11, this_ptr, ZEND_STRL("_width"), PH_NOISY_CC | PH_READONLY);
		width = (zephir_get_numberval(&_11$$11) - offsetX);
	}
	zephir_read_property(&_12, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC | PH_READONLY);
	if (height > ((zephir_get_numberval(&_12) - offsetY))) {
		zephir_read_property(&_13$$12, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter, reflection) {
	...
	if (_0) {
		ZEPHIR_OBS_VAR(&_2$$3);
		zephir_read_property(&_2$$3, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Image_Adapter, watermark) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_height"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter, text) {
	...
	if (zephir_fast_strlen_ev(&color) == 3) {
		...
		ZEPHIR_CALL_FUNCTION(&_8$$7, "preg_replace", NULL, 28, &_6$$7, &_7$$7, &color);
		zephir_check_call_status();
		zephir_get_strval(&color, &_8$$7);
	}
	ZVAL_LONG(&_9, 2);
	ZEPHIR_CALL_FUNCTION(&_10, "str_split", NULL, 62, &color, &_9);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_11);
	ZVAL_STRING(&_11, "hexdec");
	ZEPHIR_CALL_FUNCTION(&colors, "array_map", NULL, 63, &_11, &_10);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter, background) {
	...
	if (zephir_fast_strlen_ev(&color) == 3) {
		...
		ZEPHIR_CALL_FUNCTION(&_8$$4, "preg_replace", NULL, 28, &_6$$4, &_7$$4, &color);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter, save) {
	...
	if (!(!(Z_TYPE_P(&file) == IS_UNDEF) && Z_STRLEN_P(&file))) {
		ZEPHIR_OBS_VAR(&_0$$3);
		zephir_read_property(&_0$$3, this_ptr, ZEND_STRL("_realpath"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Image_Adapter, render) {
	...
	if (!(!(Z_TYPE_P(&ext) == IS_UNDEF) && Z_STRLEN_P(&ext))) {
		zephir_read_property(&_0$$3, this_ptr, ZEND_STRL("_file"), PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_1$$3, 4);
		ZEPHIR_CALL_FUNCTION(&_2$$3, "pathinfo", NULL, 64, &_0$$3, &_1$$3);
		zephir_check_call_status();
