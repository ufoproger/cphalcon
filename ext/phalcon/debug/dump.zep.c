...
PHP_METHOD(Phalcon_Debug_Dump, setDetailed) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_detailed"), detailed);
	RETURN_THISW();
...
PHP_METHOD(Phalcon_Debug_Dump, __construct) {
	...
	if (detailed) {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_detailed"), &__$true);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_detailed"), &__$false);
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Debug_Dump, getStyle) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_styles"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Debug_Dump, setStyles) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_styles"), &_0);
...
PHP_METHOD(Phalcon_Debug_Dump, output) {
	...
	if (Z_TYPE_P(variable) == IS_ARRAY) {
		...
		if (Z_TYPE_P(variable) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(variable), _6$$4, _7$$4, _4$$4)
			{
				...
				ZVAL_LONG(&_8$$5, tab);
				ZEPHIR_CALL_FUNCTION(&_9$$5, "str_repeat", &_10, 126, &space, &_8$$5);
				zephir_check_call_status();
				...
				if (_17$$5) {
					...
					ZEPHIR_CALL_METHOD(&_18$$7, this_ptr, "output", &_21, 162, &value, &_19$$7, &_20$$7);
					zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZVAL_LONG(&_23$$8, tab);
					ZEPHIR_CALL_FUNCTION(&_24$$8, "str_repeat", &_10, 126, &space, &_23$$8);
					zephir_check_call_status();
					...
					if (_31$$8) {
						...
						ZEPHIR_CALL_METHOD(&_32$$10, this_ptr, "output", &_21, 162, &value, &_33$$10, &_34$$10);
						zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_37$$4, "str_repeat", &_10, 126, &space, &_36$$4);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_OBJECT) {
		...
		ZEPHIR_CALL_FUNCTION(&_41$$11, "get_parent_class", NULL, 163, variable);
		zephir_check_call_status();
		if (zephir_is_true(&_41$$11)) {
			...
			ZEPHIR_CALL_FUNCTION(&_43$$12, "get_parent_class", NULL, 163, variable);
			zephir_check_call_status();
		...
		zephir_read_property(&_45$$11, this_ptr, ZEND_STRL("_detailed"), PH_NOISY_CC | PH_READONLY);
		...
		if (zephir_instance_of_ev(variable, phalcon_di_ce)) {
			...
			ZEPHIR_CALL_FUNCTION(&_48$$13, "str_repeat", &_10, 126, &space, &_47$$13);
			zephir_check_call_status();
			...
			if (Z_TYPE_P(&_50$$14) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_50$$14), _53$$14, _54$$14, _51$$14)
				{
					...
					ZEPHIR_CALL_FUNCTION(&_56$$15, "str_repeat", &_10, 126, &space, &_55$$15);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_61$$15, this_ptr, "output", &_21, 162, &value, &_59$$15, &_55$$15);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						ZEPHIR_CALL_FUNCTION(&_64$$16, "str_repeat", &_10, 126, &space, &_63$$16);
						zephir_check_call_status();
						...
						ZEPHIR_CALL_METHOD(&_69$$16, this_ptr, "output", &_21, 162, &value, &_67$$16, &_63$$16);
						zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(NULL, &reflect$$17, "__construct", NULL, 80, variable);
			zephir_check_call_status();
			ZVAL_LONG(&_71$$17, ((1 | 2) | 4));
			ZEPHIR_CALL_METHOD(&props$$17, &reflect$$17, "getproperties", NULL, 84, &_71$$17);
			zephir_check_call_status();
			...
			if (Z_TYPE_P(&props$$17) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&props$$17), _72$$17)
				{
					...
					ZEPHIR_CALL_FUNCTION(&_83$$18, "str_repeat", &_10, 126, &space, &_74$$18);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_88$$18, this_ptr, "output", &_21, 162, &_89$$18, &_86$$18, &_74$$18);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						ZEPHIR_CALL_FUNCTION(&_100$$19, "str_repeat", &_10, 126, &space, &_92$$19);
						zephir_check_call_status();
						...
						ZEPHIR_CALL_METHOD(&_105$$19, this_ptr, "output", &_21, 162, &_106$$19, &_103$$19, &_92$$19);
						zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&attr, "get_class_methods", NULL, 164, variable);
		zephir_check_call_status();
		ZVAL_LONG(&_109$$11, tab);
		ZEPHIR_CALL_FUNCTION(&_110$$11, "str_repeat", &_10, 126, &space, &_109$$11);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(&_40$$11);
		zephir_get_class(&_40$$11, variable, 0);
		zephir_read_property(&_109$$11, this_ptr, ZEND_STRL("_methods"), PH_NOISY_CC | PH_READONLY);
		if (zephir_fast_in_array(&_40$$11, &_109$$11)) {
			ZVAL_LONG(&_114$$20, tab);
			ZEPHIR_CALL_FUNCTION(&_115$$20, "str_repeat", &_10, 126, &space, &_114$$20);
			zephir_check_call_status();
			...
			if (Z_TYPE_P(&attr) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attr), _117$$21)
				{
					...
					if (ZEPHIR_IS_STRING(&value, "__construct")) {
						...
						ZEPHIR_CALL_FUNCTION(&_121$$23, "str_repeat", &_10, 126, &space, &_120$$23);
						zephir_check_call_status();
						...
						ZEPHIR_CALL_FUNCTION(&_127$$24, "str_repeat", &_10, 126, &space, &_126$$24);
						zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						if (ZEPHIR_IS_STRING(&value, "__construct")) {
							...
							ZEPHIR_CALL_FUNCTION(&_134$$26, "str_repeat", &_10, 126, &space, &_133$$26);
							zephir_check_call_status();
							...
							ZEPHIR_CALL_FUNCTION(&_140$$27, "str_repeat", &_10, 126, &space, &_139$$27);
							zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_146$$21, "str_repeat", &_10, 126, &space, &_145$$21);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_149$$11, "str_repeat", &_10, 126, &space, &_148$$11);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_153, "is_float", NULL, 165, variable);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_STRING) {
		...
		ZEPHIR_CALL_FUNCTION(&_161$$31, "htmlentities", NULL, 150, variable, &_163$$31, &_162$$31);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_164$$31, "nl2br", NULL, 166, &_161$$31);
		zephir_check_call_status();
...
zend_object *zephir_init_properties_Phalcon_Debug_Dump(zend_class_entry *class_type) {
	...
	
	{
		...
		zephir_read_property_ex(&_0, this_ptr, ZEND_STRL("_methods"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_0) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_1$$3);
			array_init(&_1$$3);
			zephir_update_property_zval_ex(this_ptr, ZEND_STRL("_methods"), &_1$$3);
		}
		ZEPHIR_MM_RESTORE();
