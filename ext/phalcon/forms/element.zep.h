...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_forms_element_getfilters, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_forms_element_getdefault, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_forms_element_getvalue, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_forms_element_zephir_init_properties_phalcon_forms_element, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_forms_element_method_entry) {
	...
	PHP_ME(Phalcon_Forms_Element, getFilters, arginfo_phalcon_forms_element_getfilters, ZEND_ACC_PUBLIC)
#else
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Forms_Element, getDefault, arginfo_phalcon_forms_element_getdefault, ZEND_ACC_PUBLIC)
#else
	PHP_ME(Phalcon_Forms_Element, getDefault, NULL, ZEND_ACC_PUBLIC)
#endif
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Forms_Element, getValue, arginfo_phalcon_forms_element_getvalue, ZEND_ACC_PUBLIC)
#else
