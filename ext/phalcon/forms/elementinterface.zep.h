...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_forms_elementinterface_getfilters, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_forms_elementinterface_getdefault, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_forms_elementinterface_getvalue, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_forms_elementinterface_getmessages, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_forms_elementinterface_method_entry) {
	...
	PHP_ABSTRACT_ME(Phalcon_Forms_ElementInterface, getFilters, arginfo_phalcon_forms_elementinterface_getfilters)
	...
	PHP_ABSTRACT_ME(Phalcon_Forms_ElementInterface, getDefault, arginfo_phalcon_forms_elementinterface_getdefault)
	PHP_ABSTRACT_ME(Phalcon_Forms_ElementInterface, getValue, arginfo_phalcon_forms_elementinterface_getvalue)
