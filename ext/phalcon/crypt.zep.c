...
PHP_METHOD(Phalcon_Crypt, setPadding) {
	...
	ZVAL_LONG(&_0, scheme);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_padding"), &_0);
	RETURN_THISW();
...
PHP_METHOD(Phalcon_Crypt, setCipher) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_cipher"), &cipher);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Crypt, setKey) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_key"), &key);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Crypt, _cryptPadText) {
	...
	if (_0) {
		...
		do {
			if (paddingType == 1) {
				ZVAL_LONG(&_1$$5, 0);
				ZEPHIR_CALL_FUNCTION(&_2$$5, "chr", NULL, 125, &_1$$5);
				zephir_check_call_status();
				ZVAL_LONG(&_1$$5, (paddingSize - 1));
				ZEPHIR_CALL_FUNCTION(&_3$$5, "str_repeat", NULL, 126, &_2$$5, &_1$$5);
				zephir_check_call_status();
				ZVAL_LONG(&_1$$5, paddingSize);
				ZEPHIR_CALL_FUNCTION(&_4$$5, "chr", NULL, 125, &_1$$5);
				zephir_check_call_status();
			...
			if (paddingType == 2) {
				...
				ZEPHIR_CALL_FUNCTION(&_6$$6, "chr", NULL, 125, &_5$$6);
				zephir_check_call_status();
				ZVAL_LONG(&_5$$6, paddingSize);
				ZEPHIR_CALL_FUNCTION(&padding, "str_repeat", NULL, 126, &_6$$6, &_5$$6);
				zephir_check_call_status();
				break;
			}
			if (paddingType == 3) {
				...
				if (_8$$7 <= _9$$7) {
					while (1) {
						...
						i = _8$$7;
						ZEPHIR_CALL_FUNCTION(&_10$$8, "rand", &_11, 103);
						zephir_check_call_status();
						ZEPHIR_CALL_FUNCTION(&_12$$8, "chr", NULL, 125, &_10$$8);
						zephir_check_call_status();
						zephir_concat_self(&padding, &_12$$8);
					}
				}
				ZVAL_LONG(&_13$$7, paddingSize);
				ZEPHIR_CALL_FUNCTION(&_14$$7, "chr", NULL, 125, &_13$$7);
				zephir_check_call_status();
			...
			if (paddingType == 4) {
				...
				ZEPHIR_CALL_FUNCTION(&_16$$9, "chr", NULL, 125, &_15$$9);
				zephir_check_call_status();
				ZVAL_LONG(&_15$$9, 0);
				ZEPHIR_CALL_FUNCTION(&_17$$9, "chr", NULL, 125, &_15$$9);
				zephir_check_call_status();
				ZVAL_LONG(&_15$$9, (paddingSize - 1));
				ZEPHIR_CALL_FUNCTION(&_18$$9, "str_repeat", NULL, 126, &_17$$9, &_15$$9);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&padding);
			...
			if (paddingType == 5) {
				ZVAL_LONG(&_19$$10, 0);
				ZEPHIR_CALL_FUNCTION(&_20$$10, "chr", NULL, 125, &_19$$10);
				zephir_check_call_status();
				ZVAL_LONG(&_19$$10, paddingSize);
				ZEPHIR_CALL_FUNCTION(&padding, "str_repeat", NULL, 126, &_20$$10, &_19$$10);
				zephir_check_call_status();
				break;
			}
			if (paddingType == 6) {
				...
				ZEPHIR_CALL_FUNCTION(&padding, "str_repeat", NULL, 126, &_21$$11, &_22$$11);
				zephir_check_call_status();
				break;
			}
			paddingSize = 0;
	...
	if (_1) {
		do {
			if (paddingType == 1) {
				...
				ZEPHIR_CALL_FUNCTION(&_5$$4, "ord", NULL, 127, &last);
				zephir_check_call_status();
				ord = zephir_get_intval(&_5$$4);
				if (ord <= blockSize) {
					paddingSize = ord;
					ZVAL_LONG(&_6$$5, 0);
					ZEPHIR_CALL_FUNCTION(&_7$$5, "chr", NULL, 125, &_6$$5);
					zephir_check_call_status();
					ZVAL_LONG(&_6$$5, (paddingSize - 1));
					ZEPHIR_CALL_FUNCTION(&_8$$5, "str_repeat", NULL, 126, &_7$$5, &_6$$5);
					zephir_check_call_status();
					ZEPHIR_INIT_VAR(&padding);
			...
			if (paddingType == 2) {
				...
				ZEPHIR_CALL_FUNCTION(&_12$$7, "ord", NULL, 127, &last);
				zephir_check_call_status();
				ord = zephir_get_intval(&_12$$7);
				if (ord <= blockSize) {
					paddingSize = ord;
					ZVAL_LONG(&_13$$8, paddingSize);
					ZEPHIR_CALL_FUNCTION(&_14$$8, "chr", NULL, 125, &_13$$8);
					zephir_check_call_status();
					ZVAL_LONG(&_13$$8, paddingSize);
					ZEPHIR_CALL_FUNCTION(&padding, "str_repeat", NULL, 126, &_14$$8, &_13$$8);
					zephir_check_call_status();
			...
			if (paddingType == 3) {
				...
				ZEPHIR_CALL_FUNCTION(&_18$$10, "ord", NULL, 127, &last);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Crypt, encrypt) {
	...
	if (EXPECTED(ZEPHIR_IS_EMPTY(&key))) {
		...
		zephir_read_property(&encryptKey, this_ptr, ZEND_STRL("_key"), PH_NOISY_CC);
	} else {
	...
	zephir_read_property(&cipher, this_ptr, ZEND_STRL("_cipher"), PH_NOISY_CC);
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "-");
	ZEPHIR_CALL_FUNCTION(&_1, "strrpos", NULL, 128, &cipher, &_0);
	zephir_check_call_status();
	...
	if (EXPECTED(ZEPHIR_GT_LONG(&ivLength, 0))) {
		...
		ZVAL_STRING(&_5$$7, "");
		ZEPHIR_CALL_FUNCTION(&_6$$7, "str_ireplace", NULL, 129, &_4$$7, &_5$$7, &cipher);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&blockSize, this_ptr, "getivlength", NULL, 0, &_6$$7);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_FUNCTION(&iv, "openssl_random_pseudo_bytes", NULL, 130, &ivLength);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&paddingType);
	zephir_read_property(&paddingType, this_ptr, ZEND_STRL("_padding"), PH_NOISY_CC);
	...
	ZVAL_LONG(&_3, 1);
	ZEPHIR_CALL_FUNCTION(&encrypted, "openssl_encrypt", NULL, 131, &padded, &cipher, &encryptKey, &_3, &iv);
	zephir_check_call_status();
	...
	if (zephir_is_true(&_3)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&digest$$10, "hash_hmac", NULL, 132, &hashAlgo$$10, &padded, &encryptKey, &__$true);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Crypt, decrypt) {
	...
	if (EXPECTED(ZEPHIR_IS_EMPTY(&key))) {
		...
		zephir_read_property(&decryptKey, this_ptr, ZEND_STRL("_key"), PH_NOISY_CC);
	} else {
	...
	ZEPHIR_INIT_VAR(&_7);
	ZVAL_STRING(&_7, "8bit");
	ZEPHIR_CALL_FUNCTION(&iv, "mb_substr", NULL, 133, &text, &_3, &ivLength, &_7);
	zephir_check_call_status();
	zephir_read_property(&_3, this_ptr, ZEND_STRL("useSigning"), PH_NOISY_CC | PH_READONLY);
	if (zephir_is_true(&_3)) {
		...
		ZVAL_STRING(&_8$$8, "");
		ZEPHIR_CALL_FUNCTION(&_9$$8, "hash", NULL, 134, &hashAlgo, &_8$$8, &__$true);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&hashLength);
		ZVAL_LONG(&hashLength, zephir_fast_strlen_ev(&_9$$8));
		ZEPHIR_INIT_NVAR(&_8$$8);
		ZVAL_STRING(&_8$$8, "8bit");
		ZEPHIR_CALL_FUNCTION(&hash, "mb_substr", NULL, 133, &text, &ivLength, &hashLength, &_8$$8);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_10$$8);
		zephir_add_function(&_10$$8, &ivLength, &hashLength);
		ZEPHIR_INIT_NVAR(&_8$$8);
		ZVAL_STRING(&_8$$8, "8bit");
		ZEPHIR_CALL_FUNCTION(&ciphertext, "mb_substr", NULL, 133, &text, &_10$$8, &__$null, &_8$$8);
		zephir_check_call_status();
		ZVAL_LONG(&_11$$8, 1);
		ZEPHIR_CALL_FUNCTION(&decrypted, "openssl_decrypt", NULL, 135, &ciphertext, &cipher, &decryptKey, &_11$$8, &iv);
		zephir_check_call_status();
		...
		if (_12$$8) {
			zephir_read_property(&_14$$9, this_ptr, ZEND_STRL("_padding"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(&_13$$9, this_ptr, "_cryptunpadtext", NULL, 0, &decrypted, &mode, &blockSize, &_14$$9);
			zephir_check_call_status();
			ZEPHIR_CPY_WRT(&decrypted, &_13$$9);
		}
		ZEPHIR_CALL_FUNCTION(&_15$$8, "hash_hmac", NULL, 132, &hashAlgo, &decrypted, &decryptKey, &__$true);
		zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_7);
	ZVAL_STRING(&_7, "8bit");
	ZEPHIR_CALL_FUNCTION(&ciphertext, "mb_substr", NULL, 133, &text, &ivLength, &__$null, &_7);
	zephir_check_call_status();
	ZVAL_LONG(&_16, 1);
	ZEPHIR_CALL_FUNCTION(&decrypted, "openssl_decrypt", NULL, 135, &ciphertext, &cipher, &decryptKey, &_16, &iv);
	zephir_check_call_status();
	...
	if (_17) {
		zephir_read_property(&_19$$11, this_ptr, ZEND_STRL("_padding"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Crypt, getAvailableHashAlgos) {
	...
	if (EXPECTED((zephir_function_exists_ex(ZEND_STRL("hash_hmac_algos")) == SUCCESS))) {
		ZEPHIR_CALL_FUNCTION(&algos, "hash_hmac_algos", NULL, 136);
		zephir_check_call_status();
	} else {
		ZEPHIR_CALL_FUNCTION(&algos, "hash_algos", NULL, 137);
		zephir_check_call_status();
	}
	RETURN_CCTOR(&algos);
...
PHP_METHOD(Phalcon_Crypt, assertCipherIsAvailable) {
	...
	if (!(zephir_fast_in_array(&cipher, &availableCiphers))) {
		...
		ZEPHIR_CALL_FUNCTION(&_2$$3, "sprintf", NULL, 138, &_1$$3, &cipher);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Crypt, assertHashAlgorithmAvailable) {
	...
	if (!(zephir_fast_in_array(&hashAlgo, &availableAlgorithms))) {
		...
		ZEPHIR_CALL_FUNCTION(&_2$$3, "sprintf", NULL, 138, &_1$$3, &hashAlgo);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 4, &_2$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Crypt, getIvLength) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_cipher_iv_length", NULL, 139, &cipher);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Crypt, initializeAvailableCiphers) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "openssl_get_cipher_methods", NULL, 140, &__$true);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("availableCiphers"), &_0);
	ZEPHIR_MM_RESTORE();
