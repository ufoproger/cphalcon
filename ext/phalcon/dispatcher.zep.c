...
PHP_METHOD(Phalcon_Dispatcher, setModuleName) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_moduleName"), &moduleName);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Dispatcher, setNamespaceName) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_namespaceName"), &namespaceName);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Dispatcher, getParam) {
	...
	zephir_read_property(&params, this_ptr, ZEND_STRL("_params"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Dispatcher, hasParam) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_params"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Dispatcher, getActiveMethod) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_actionName"), PH_NOISY_CC | PH_READONLY);
	zephir_read_property(&_1, this_ptr, ZEND_STRL("_actionSuffix"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Dispatcher, setReturnedValue) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_returnedValue"), value);
...
PHP_METHOD(Phalcon_Dispatcher, setModelBinding) {
	...
	if (value) {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_modelBinding"), &__$true);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_modelBinding"), &__$false);
	}
	if (value) {
		ZEPHIR_INIT_VAR(&_1$$4);
		object_init_ex(&_1$$4, phalcon_mvc_model_binder_ce);
		ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 60, cache);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, ZEND_STRL("_modelBinder"), &_1$$4);
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Dispatcher, dispatch) {
	...
	if (1) {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_finished"), &__$true);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_finished"), &__$false);
	}
	if (hasEventsManager) {
		...
		/* try_start_1: */
			...
			if (_5$$5) {
				zephir_read_property(&_6$$5, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
		...
		if (EG(exception)) {
			...
			Z_ADDREF_P(&_7$$4);
			if (zephir_instance_of_ev(&_7$$4, zend_ce_exception)) {
				zend_clear_exception();
				ZEPHIR_CPY_WRT(&e, &_7$$4);
				ZEPHIR_CALL_METHOD(&status, this_ptr, "_handleexception", NULL, 0, &e);
				zephir_check_call_status();
				zephir_read_property(&_8$$7, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
				if (!ZEPHIR_IS_FALSE_IDENTICAL(&_8$$7)) {
					if (ZEPHIR_IS_FALSE_IDENTICAL(&status)) {
						RETURN_MM_BOOL(0);
					}
					zephir_throw_exception_debug(&e, "phalcon/dispatcher.zep", 461);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
	...
	zephir_read_property(&actionSuffix, this_ptr, ZEND_STRL("_actionSuffix"), PH_NOISY_CC);
	if (0) {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_finished"), &__$true);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_finished"), &__$false);
	...
	while (1) {
		zephir_read_property(&_0, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
		...
		if (hasEventsManager) {
			...
			/* try_start_2: */
				...
				if (!(_16$$13)) {
					zephir_read_property(&_17$$13, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
			...
			if (EG(exception)) {
				...
				Z_ADDREF_P(&_18$$12);
				if (zephir_instance_of_ev(&_18$$12, zend_ce_exception)) {
					zend_clear_exception();
					...
					if (!(_21$$15)) {
						zephir_read_property(&_22$$15, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
						_21$$15 = ZEPHIR_IS_FALSE_IDENTICAL(&_22$$15);
					}
					if (_21$$15) {
						continue;
					}
					zephir_throw_exception_debug(&e, "phalcon/dispatcher.zep", 497);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
		...
		if (!(hasService)) {
			...
			if (_29$$18) {
				zephir_read_property(&_27$$18, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
		...
		if (Z_TYPE_P(&handler) != IS_OBJECT) {
			...
			if (_35$$20) {
				zephir_read_property(&_33$$20, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
		...
		zephir_update_property_zval(this_ptr, ZEND_STRL("_activeHandler"), &handler);
		ZEPHIR_OBS_NVAR(&namespaceName);
		zephir_read_property(&namespaceName, this_ptr, ZEND_STRL("_namespaceName"), PH_NOISY_CC);
		ZEPHIR_OBS_NVAR(&handlerName);
		zephir_read_property(&handlerName, this_ptr, ZEND_STRL("_handlerName"), PH_NOISY_CC);
		ZEPHIR_OBS_NVAR(&actionName);
		zephir_read_property(&actionName, this_ptr, ZEND_STRL("_actionName"), PH_NOISY_CC);
		...
		if (Z_TYPE_P(&params) != IS_ARRAY) {
			...
			if (_39$$22) {
				zephir_read_property(&_37$$22, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
		...
		if (!(zephir_is_callable(&_41$$10))) {
			if (hasEventsManager) {
				...
				zephir_read_property(&_45$$25, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
			...
			if (_49$$24) {
				zephir_read_property(&_47$$24, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
		...
		if (hasEventsManager) {
			...
			/* try_start_3: */
				...
				if (!(_53$$30)) {
					zephir_read_property(&_54$$30, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
			...
			if (EG(exception)) {
				...
				Z_ADDREF_P(&_56$$29);
				if (zephir_instance_of_ev(&_56$$29, zend_ce_exception)) {
					zend_clear_exception();
					...
					if (!(_59$$32)) {
						zephir_read_property(&_60$$32, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
					...
					zephir_throw_exception_debug(&e, "phalcon/dispatcher.zep", 591);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
		...
		if ((zephir_method_exists_ex(&handler, ZEND_STRL("beforeexecuteroute")) == SUCCESS)) {
			...
			/* try_start_4: */
				...
				if (!(_63$$35)) {
					zephir_read_property(&_64$$35, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
			...
			if (EG(exception)) {
				...
				Z_ADDREF_P(&_66$$34);
				if (zephir_instance_of_ev(&_66$$34, zend_ce_exception)) {
					zend_clear_exception();
					...
					if (!(_69$$37)) {
						zephir_read_property(&_70$$37, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
					...
					zephir_throw_exception_debug(&e, "phalcon/dispatcher.zep", 608);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
		...
		if (ZEPHIR_IS_TRUE_IDENTICAL(&wasFresh)) {
			if ((zephir_method_exists_ex(&handler, ZEND_STRL("initialize")) == SUCCESS)) {
				...
				/* try_start_5: */
					...
					if (1) {
						zephir_update_property_zval(this_ptr, ZEND_STRL("_isControllerInitialize"), &__$true);
					} else {
						zephir_update_property_zval(this_ptr, ZEND_STRL("_isControllerInitialize"), &__$false);
					}
				...
				if (EG(exception)) {
					...
					Z_ADDREF_P(&_72$$40);
					if (zephir_instance_of_ev(&_72$$40, zend_ce_exception)) {
						zend_clear_exception();
						...
						if (!(_75$$42)) {
							zephir_read_property(&_76$$42, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
							_75$$42 = ZEPHIR_IS_FALSE_IDENTICAL(&_76$$42);
						}
						if (_75$$42) {
							continue;
						}
						zephir_throw_exception_debug(&e, "phalcon/dispatcher.zep", 641);
						ZEPHIR_MM_RESTORE();
						return;
					}
				}
			...
			if (zephir_is_true(&eventsManager)) {
				...
				/* try_start_6: */
					...
					if (!(_80$$45)) {
						zephir_read_property(&_81$$45, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
				...
				if (EG(exception)) {
					...
					Z_ADDREF_P(&_82$$44);
					if (zephir_instance_of_ev(&_82$$44, zend_ce_exception)) {
						zend_clear_exception();
						...
						if (!(_85$$47)) {
							zephir_read_property(&_86$$47, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
							_85$$47 = ZEPHIR_IS_FALSE_IDENTICAL(&_86$$47);
						}
						if (_85$$47) {
							continue;
						}
						zephir_throw_exception_debug(&e, "phalcon/dispatcher.zep", 658);
						ZEPHIR_MM_RESTORE();
						return;
					}
				}
		...
		zephir_read_property(&_87$$10, this_ptr, ZEND_STRL("_modelBinding"), PH_NOISY_CC | PH_READONLY);
		...
		if (hasEventsManager) {
			...
			zephir_read_property(&_92$$50, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
		...
		if ((zephir_method_exists_ex(&handler, ZEND_STRL("afterbinding")) == SUCCESS)) {
			...
			zephir_read_property(&_94$$53, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
			if (ZEPHIR_IS_FALSE_IDENTICAL(&_94$$53)) {
				continue;
			}
		}
		zephir_update_property_zval(this_ptr, ZEND_STRL("_lastHandler"), &handler);
		...
		/* try_start_7: */
			...
			zephir_update_property_zval(this_ptr, ZEND_STRL("_returnedValue"), &_95$$56);
			zephir_read_property(&_97$$56, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
		...
		if (EG(exception)) {
			...
			Z_ADDREF_P(&_98$$10);
			if (zephir_instance_of_ev(&_98$$10, zend_ce_exception)) {
				zend_clear_exception();
				...
				if (!(_101$$58)) {
					zephir_read_property(&_102$$58, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
					_101$$58 = ZEPHIR_IS_FALSE_IDENTICAL(&_102$$58);
				}
				if (_101$$58) {
					continue;
				}
				zephir_throw_exception_debug(&e, "phalcon/dispatcher.zep", 708);
				ZEPHIR_MM_RESTORE();
				return;
			}
		}
		if (hasEventsManager) {
			...
			/* try_start_8: */
				...
				if (!(_106$$61)) {
					zephir_read_property(&_107$$61, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
			...
			if (EG(exception)) {
				...
				Z_ADDREF_P(&_108$$60);
				if (zephir_instance_of_ev(&_108$$60, zend_ce_exception)) {
					zend_clear_exception();
					...
					if (!(_111$$63)) {
						zephir_read_property(&_112$$63, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
						_111$$63 = ZEPHIR_IS_FALSE_IDENTICAL(&_112$$63);
					}
					if (_111$$63) {
						continue;
					}
					zephir_throw_exception_debug(&e, "phalcon/dispatcher.zep", 722);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
		...
		if ((zephir_method_exists_ex(&handler, ZEND_STRL("afterexecuteroute")) == SUCCESS)) {
			...
			/* try_start_9: */
				...
				if (!(_114$$66)) {
					zephir_read_property(&_115$$66, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
			...
			if (EG(exception)) {
				...
				Z_ADDREF_P(&_116$$65);
				if (zephir_instance_of_ev(&_116$$65, zend_ce_exception)) {
					zend_clear_exception();
					...
					if (!(_119$$68)) {
						zephir_read_property(&_120$$68, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
						_119$$68 = ZEPHIR_IS_FALSE_IDENTICAL(&_120$$68);
					}
					if (_119$$68) {
						continue;
					}
					zephir_throw_exception_debug(&e, "phalcon/dispatcher.zep", 737);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
		...
		if (hasEventsManager) {
			...
			if (EG(exception)) {
				...
				Z_ADDREF_P(&_123$$70);
				if (zephir_instance_of_ev(&_123$$70, zend_ce_exception)) {
					zend_clear_exception();
					...
					if (!(_126$$72)) {
						zephir_read_property(&_127$$72, this_ptr, ZEND_STRL("_finished"), PH_NOISY_CC | PH_READONLY);
						_126$$72 = ZEPHIR_IS_FALSE_IDENTICAL(&_127$$72);
					}
					if (_126$$72) {
						continue;
					}
					zephir_throw_exception_debug(&e, "phalcon/dispatcher.zep", 751);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
	...
	if (hasEventsManager) {
		...
		if (EG(exception)) {
			...
			Z_ADDREF_P(&_129$$74);
			if (zephir_instance_of_ev(&_129$$74, zend_ce_exception)) {
				zend_clear_exception();
				...
				zephir_throw_exception_debug(&e, "phalcon/dispatcher.zep", 768);
				ZEPHIR_MM_RESTORE();
				return;
			}
		}
...
PHP_METHOD(Phalcon_Dispatcher, forward) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_isControllerInitialize"), PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property(&_1, this_ptr, ZEND_STRL("_namespaceName"), PH_NOISY_CC | PH_READONLY);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_previousNamespaceName"), &_1);
	zephir_read_property(&_2, this_ptr, ZEND_STRL("_handlerName"), PH_NOISY_CC | PH_READONLY);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_previousHandlerName"), &_2);
	zephir_read_property(&_3, this_ptr, ZEND_STRL("_actionName"), PH_NOISY_CC | PH_READONLY);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_previousActionName"), &_3);
	...
	if (zephir_array_isset_string_fetch(&controllerName, forward, SL("controller"), 1)) {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_handlerName"), &controllerName);
	...
	if (1) {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_forwarded"), &__$true);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_forwarded"), &__$false);
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Dispatcher, getHandlerClass) {
	...
	zephir_read_property(&handlerSuffix, this_ptr, ZEND_STRL("_handlerSuffix"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Dispatcher, _resolveEmptyProperties) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_namespaceName"), PH_NOISY_CC | PH_READONLY);
	if (!(zephir_is_true(&_0))) {
		zephir_read_property(&_1$$3, this_ptr, ZEND_STRL("_defaultNamespace"), PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_namespaceName"), &_1$$3);
	}
	zephir_read_property(&_2, this_ptr, ZEND_STRL("_handlerName"), PH_NOISY_CC | PH_READONLY);
	if (!(zephir_is_true(&_2))) {
		zephir_read_property(&_3$$4, this_ptr, ZEND_STRL("_defaultHandler"), PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_handlerName"), &_3$$4);
	}
	zephir_read_property(&_4, this_ptr, ZEND_STRL("_actionName"), PH_NOISY_CC | PH_READONLY);
	if (!(zephir_is_true(&_4))) {
		zephir_read_property(&_5$$5, this_ptr, ZEND_STRL("_defaultAction"), PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_actionName"), &_5$$5);
	}

}

zend_object *zephir_init_properties_Phalcon_Dispatcher(zend_class_entry *class_type) {
