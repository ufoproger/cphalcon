...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_dispatcher_getreturnedvalue, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_dispatcher_dispatch, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_dispatcher_zephir_init_properties_phalcon_dispatcher, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_dispatcher_method_entry) {
	...
	PHP_ME(Phalcon_Dispatcher, getReturnedValue, arginfo_phalcon_dispatcher_getreturnedvalue, ZEND_ACC_PUBLIC)
#else
