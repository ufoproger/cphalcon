...
PHP_METHOD(Phalcon_Security, setWorkFactor) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_workFactor"), workFactor);
	RETURN_THISW();
...
PHP_METHOD(Phalcon_Security, __construct) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_random"), &_0);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Security, setRandomBytes) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_numberBytes"), &_0);
	RETURN_THISW();
...
PHP_METHOD(Phalcon_Security, getSaltBytes) {
	...
	if (!(numberBytes)) {
		ZEPHIR_OBS_VAR(&_0$$3);
		zephir_read_property(&_0$$3, this_ptr, ZEND_STRL("_numberBytes"), PH_NOISY_CC);
		numberBytes = zephir_get_intval(&_0$$3);
	}
	while (1) {
		zephir_read_property(&_1$$4, this_ptr, ZEND_STRL("_random"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Security, hash) {
	...
	if (!(workFactor)) {
		ZEPHIR_OBS_VAR(&_0$$3);
		zephir_read_property(&_0$$3, this_ptr, ZEND_STRL("_workFactor"), PH_NOISY_CC);
		workFactor = zephir_get_intval(&_0$$3);
	}
	ZEPHIR_OBS_VAR(&_1);
	zephir_read_property(&_1, this_ptr, ZEND_STRL("_defaultHash"), PH_NOISY_CC);
	...
	do {
		if (hash == 1 || hash == 2) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("crypt", NULL, 354, &password, &saltBytes);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (hash == 3 || hash == 8 || hash == 9) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("crypt", NULL, 354, &password, &_6$$15);
			zephir_check_call_status();
			RETURN_MM();
		}
		ZVAL_LONG(&_7$$17, 22);
		...
		ZEPHIR_CALL_FUNCTION(&_9$$17, "sprintf", NULL, 138, &_8$$17, &_7$$17);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_10$$17);
		ZEPHIR_CONCAT_SVSVSVS(&_10$$17, "$2", &variant, "$", &_9$$17, "$", &saltBytes, "$");
		ZEPHIR_RETURN_CALL_FUNCTION("crypt", NULL, 354, &password, &_10$$17);
		zephir_check_call_status();
		RETURN_MM();
	} while(0);
...
PHP_METHOD(Phalcon_Security, checkHash) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "crypt", NULL, 354, &password, &passwordHash);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security, getTokenKey) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_tokenKey"), PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_read_property(&_1$$3, this_ptr, ZEND_STRL("_random"), PH_NOISY_CC | PH_READONLY);
		zephir_read_property(&_3$$3, this_ptr, ZEND_STRL("_numberBytes"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_2$$3, &_1$$3, "base64safe", NULL, 0, &_3$$3);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, ZEND_STRL("_tokenKey"), &_2$$3);
		ZEPHIR_INIT_VAR(&_5$$3);
		ZVAL_STRING(&_5$$3, "session");
		ZEPHIR_CALL_METHOD(&_4$$3, &dependencyInjector, "getshared", NULL, 0, &_5$$3);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(&session, &_4$$3);
		zephir_read_property(&_6$$3, this_ptr, ZEND_STRL("_tokenKeySessionID"), PH_NOISY_CC | PH_READONLY);
		zephir_read_property(&_7$$3, this_ptr, ZEND_STRL("_tokenKey"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Security, getToken) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_token"), PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_0) == IS_NULL) {
		zephir_read_property(&_1$$3, this_ptr, ZEND_STRL("_random"), PH_NOISY_CC | PH_READONLY);
		zephir_read_property(&_3$$3, this_ptr, ZEND_STRL("_numberBytes"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_2$$3, &_1$$3, "base64safe", NULL, 0, &_3$$3);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, ZEND_STRL("_token"), &_2$$3);
		zephir_read_property(&_4$$3, this_ptr, ZEND_STRL("_dependencyInjector"), PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property(&_4$$3, this_ptr, ZEND_STRL("_tokenValueSessionID"), PH_NOISY_CC | PH_READONLY);
		zephir_read_property(&_7$$3, this_ptr, ZEND_STRL("_token"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Security, checkToken) {
	...
	if (!(zephir_is_true(tokenKey))) {
		zephir_read_property(&_3$$4, this_ptr, ZEND_STRL("_tokenKeySessionID"), PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_tokenValueSessionID"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Security, destroyToken) {
	...
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&session, &_1);
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_tokenKeySessionID"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, &session, "remove", NULL, 0, &_0);
	zephir_check_call_status();
	zephir_read_property(&_3, this_ptr, ZEND_STRL("_tokenValueSessionID"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, &session, "remove", NULL, 0, &_3);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_token"), &__$null);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_tokenKey"), &__$null);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Security, computeHmac) {
	...
	ZEPHIR_CALL_FUNCTION(&hmac, "hash_hmac", NULL, 132, &algo, &data, &key, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security, setDefaultHash) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_defaultHash"), &_0);
	RETURN_THISW();
...
PHP_METHOD(Phalcon_Security, hasLibreSsl) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "defined", NULL, 24, &_0);
	zephir_check_call_status();
