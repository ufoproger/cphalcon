...
PHP_METHOD(Phalcon_Logger_Adapter_File, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&handler, "fopen", NULL, 229, &name, &mode);
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_path"), &name);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_options"), options);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_fileHandler"), &handler);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Logger_Adapter_File, logInternal) {
	...
	zephir_read_property(&fileHandler, this_ptr, ZEND_STRL("_fileHandler"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Logger_Adapter_File, close) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_fileHandler"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Logger_Adapter_File, __wakeup) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "fopen", NULL, 229, &path, &mode);
	zephir_check_call_status();
