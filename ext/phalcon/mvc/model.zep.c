...
PHP_METHOD(Phalcon_Mvc_Model, __construct) {
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_oldSnapshot"), &_0);
...
PHP_METHOD(Phalcon_Mvc_Model, getModelsMetaData) {
	...
	zephir_read_property(&metaData, this_ptr, ZEND_STRL("_modelsMetaData"), PH_NOISY_CC);
	if (Z_TYPE_P(&metaData) != IS_OBJECT) {
		...
		zephir_update_property_zval(this_ptr, ZEND_STRL("_modelsMetaData"), &metaData);
	}
...
PHP_METHOD(Phalcon_Mvc_Model, getReadConnection) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_transaction"), PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&_4) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_4), _5)
		{
			...
			if (zephir_array_isset_fetch(&value, &dataMapped, &attributeField, 0)) {
				...
				if (!(_10$$18)) {
					ZEPHIR_CALL_METHOD(&_11$$18, this_ptr, "_possiblesetter", &_12, 251, &attributeField, &value);
					zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (zephir_array_isset_fetch(&value, &dataMapped, &attributeField, 0)) {
					...
					if (!(_15$$28)) {
						ZEPHIR_CALL_METHOD(&_16$$28, this_ptr, "_possiblesetter", &_12, 251, &attributeField, &value);
						zephir_check_call_status();
				...
				if (_8$$4) {
					...
					do {
						if (ZEPHIR_IS_LONG(&_9$$10, 0)) {
							ZVAL_LONG(&_10$$11, 10);
							ZEPHIR_CALL_FUNCTION(&castValue, "intval", &_11, 26, &value, &_10$$11);
							zephir_check_call_status();
							break;
						}
					...
					if (_15$$19) {
						...
						do {
							if (ZEPHIR_IS_LONG(&_16$$25, 0)) {
								ZVAL_LONG(&_17$$26, 10);
								ZEPHIR_CALL_FUNCTION(&castValue, "intval", &_11, 26, &value, &_17$$26);
								zephir_check_call_status();
								break;
							}
...
PHP_METHOD(Phalcon_Mvc_Model, find) {
	...
	ZEPHIR_CALL_STATIC(&query, "getpreparedquery", &_0, 252, &params);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, findFirst) {
	...
	ZVAL_LONG(&_1, 1);
	ZEPHIR_CALL_STATIC(&query, "getpreparedquery", &_0, 252, &params, &_1);
	zephir_check_call_status();
	ZVAL_BOOL(&_1, 1);
...
PHP_METHOD(Phalcon_Mvc_Model, query) {
	...
	if (zephir_instance_of_ev(dependencyInjector, phalcon_diinterface_ce)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &criteria, "setdi", NULL, 253, dependencyInjector);
		zephir_check_call_status();
	}
	ZEPHIR_INIT_VAR(&_3);
	zephir_get_called_class(&_3);
	ZEPHIR_CALL_METHOD(NULL, &criteria, "setmodelname", NULL, 254, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, _exists) {
	...
	ZEND_PARSE_PARAMETERS_START(2, 3)
		...
		Z_PARAM_OBJECT_OF_CLASS(connection, phalcon_db_adapterinterface_ce)
		Z_PARAM_OPTIONAL
		Z_PARAM_ZVAL(table)
	ZEND_PARSE_PARAMETERS_END();
	...
	zephir_read_property(&uniqueKey, this_ptr, ZEND_STRL("_uniqueKey"), PH_NOISY_CC);
	if (Z_TYPE_P(&uniqueKey) == IS_NULL) {
		...
		zephir_update_property_zval(this_ptr, ZEND_STRL("_uniqueKey"), &joinWhere);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_uniqueParams"), &uniqueParams);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_uniqueTypes"), &uniqueTypes);
		ZEPHIR_CPY_WRT(&uniqueKey, &joinWhere);
	}
	zephir_read_property(&_19, this_ptr, ZEND_STRL("_dirtyState"), PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&uniqueParams) == IS_NULL) {
		...
		zephir_read_property(&uniqueParams, this_ptr, ZEND_STRL("_uniqueParams"), PH_NOISY_CC);
	}
	if (Z_TYPE_P(&uniqueTypes) == IS_NULL) {
		ZEPHIR_OBS_NVAR(&uniqueTypes);
		zephir_read_property(&uniqueTypes, this_ptr, ZEND_STRL("_uniqueTypes"), PH_NOISY_CC);
	}
	...
	if (zephir_is_true(&_24)) {
		...
		ZVAL_LONG(&_25$$30, 0);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_dirtyState"), &_25$$30);
		RETURN_MM_BOOL(1);
	} else {
		ZEPHIR_INIT_ZVAL_NREF(_26$$31);
		ZVAL_LONG(&_26$$31, 1);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_dirtyState"), &_26$$31);
	}
	RETURN_MM_BOOL(0);
...
PHP_METHOD(Phalcon_Mvc_Model, _cancelOperation) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_operationMade"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model, validate) {
	...
	bool is_null_true = 1;
	ZEND_PARSE_PARAMETERS_START(1, 1)
		Z_PARAM_OBJECT_OF_CLASS(validator, phalcon_validationinterface_ce)
	ZEND_PARSE_PARAMETERS_END();
...
PHP_METHOD(Phalcon_Mvc_Model, validationHasFailed) {
	...
	zephir_read_property(&errorMessages, this_ptr, ZEND_STRL("_errorMessages"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Model, getMessages) {
	...
	if (_0) {
		...
		array_init(&filtered);
		zephir_read_property(&_1$$3, this_ptr, ZEND_STRL("_errorMessages"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model, _preSave) {
	...
	if (ZEPHIR_GLOBAL(orm).virtual_foreign_keys) {
		ZEPHIR_CALL_METHOD(&_6$$9, this_ptr, "_checkforeignkeysrestrict", NULL, 255);
		zephir_check_call_status();
	...
	if (ZEPHIR_GLOBAL(orm).events) {
		...
		zephir_read_property(&_44$$59, this_ptr, ZEND_STRL("_skipped"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model, _doLowUpdate) {
	...
	zephir_read_property(&snapshot, this_ptr, ZEND_STRL("_snapshot"), PH_NOISY_CC);
	if (useDynamicUpdate) {
								...
								if (Z_TYPE_P(&snapshotValue) == IS_NULL) {
									...
									do {
										...
										if (ZEPHIR_IS_LONG(&dataType, 3) || ZEPHIR_IS_LONG(&dataType, 7)) {
											ZEPHIR_CALL_FUNCTION(&_11$$24, "floatval", &_12, 256, &snapshotValue);
											zephir_check_call_status();
											ZEPHIR_CALL_FUNCTION(&_13$$24, "floatval", &_12, 256, &value);
											zephir_check_call_status();
								...
								if (Z_TYPE_P(&value) == IS_NULL) {
									...
									if (Z_TYPE_P(&snapshotValue) == IS_NULL) {
										...
										do {
											...
											if (ZEPHIR_IS_LONG(&dataType, 3) || ZEPHIR_IS_LONG(&dataType, 7)) {
												ZEPHIR_CALL_FUNCTION(&_22$$46, "floatval", &_12, 256, &snapshotValue);
												zephir_check_call_status();
												ZEPHIR_CALL_FUNCTION(&_23$$46, "floatval", &_12, 256, &value);
												zephir_check_call_status();
	...
	if (!(zephir_fast_count_int(&fields))) {
		if (useDynamicUpdate) {
			zephir_update_property_zval(this_ptr, ZEND_STRL("_oldSnapshot"), &snapshot);
		}
		RETURN_MM_BOOL(1);
	}
	ZEPHIR_OBS_VAR(&uniqueKey);
	...
	if (_34) {
		if (Z_TYPE_P(&snapshot) == IS_ARRAY) {
			...
			zephir_update_property_zval(this_ptr, ZEND_STRL("_snapshot"), &_35$$68);
		} else {
			ZEPHIR_INIT_VAR(&_36$$69);
			array_init(&_36$$69);
			zephir_update_property_zval(this_ptr, ZEND_STRL("_oldSnapshot"), &_36$$69);
			zephir_update_property_zval(this_ptr, ZEND_STRL("_snapshot"), &newSnapshot);
		}
	}
	RETURN_CCTOR(&success);
...
PHP_METHOD(Phalcon_Mvc_Model, save) {
	...
	zephir_read_property(&related, this_ptr, ZEND_STRL("_related"), PH_NOISY_CC);
	if (Z_TYPE_P(&related) == IS_ARRAY) {
	...
	if (zephir_is_true(&exists)) {
		...
		ZVAL_LONG(&_4$$8, 2);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_operationMade"), &_4$$8);
	} else {
		ZEPHIR_INIT_ZVAL_NREF(_5$$9);
		ZVAL_LONG(&_5$$9, 1);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_operationMade"), &_5$$9);
	}
	ZEPHIR_INIT_NVAR(&_2);
	array_init(&_2);
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_6)) {
		...
		if (ZEPHIR_GLOBAL(orm).exception_on_failed_save) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, &_8$$12, "__construct", NULL, 257, this_ptr, &_9$$12);
			zephir_check_call_status();
	...
	if (zephir_is_true(&success)) {
		...
		ZVAL_LONG(&_10$$15, 0);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_dirtyState"), &_10$$15);
	}
	if (Z_TYPE_P(&related) == IS_ARRAY) {
...
PHP_METHOD(Phalcon_Mvc_Model, create) {
	...
	if (zephir_is_true(&_0)) {
		...
		zephir_update_property_zval(this_ptr, ZEND_STRL("_errorMessages"), &_2$$3);
		RETURN_MM_BOOL(0);
	}
...
PHP_METHOD(Phalcon_Mvc_Model, update) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_dirtyState"), PH_NOISY_CC | PH_READONLY);
	if (zephir_is_true(&_0)) {
		ZEPHIR_CALL_METHOD(&metaData, this_ptr, "getmodelsmetadata", NULL, 0);
		zephir_check_call_status();
		...
		if (!(zephir_is_true(&_1$$3))) {
			...
			zephir_update_property_zval(this_ptr, ZEND_STRL("_errorMessages"), &_3$$4);
			RETURN_MM_BOOL(0);
		}
	}
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "save", NULL, 0, data, whiteList);
...
PHP_METHOD(Phalcon_Mvc_Model, delete) {
	...
	if (ZEPHIR_GLOBAL(orm).virtual_foreign_keys) {
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "_checkforeignkeysreverserestrict", NULL, 258);
		zephir_check_call_status();
	...
	if (ZEPHIR_GLOBAL(orm).events) {
		...
		if (ZEPHIR_IS_FALSE_IDENTICAL(&_24$$20)) {
			...
			zephir_read_property(&_26$$22, this_ptr, ZEND_STRL("_skipped"), PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	if (ZEPHIR_GLOBAL(orm).virtual_foreign_keys) {
		ZEPHIR_CALL_METHOD(&_28$$26, this_ptr, "_checkforeignkeysreversecascade", NULL, 259);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, refresh) {
	...
	zephir_check_call_status();
	zephir_read_property(&_1, this_ptr, ZEND_STRL("_uniqueTypes"), PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_10, 2);
...
PHP_METHOD(Phalcon_Mvc_Model, setSnapshotData) {
	...
	ZEPHIR_OBS_VAR(&_13);
	zephir_read_property(&_13, this_ptr, ZEND_STRL("_snapshot"), PH_NOISY_CC);
	if (Z_TYPE_P(&_13) == IS_ARRAY) {
		zephir_read_property(&_14$$23, this_ptr, ZEND_STRL("_snapshot"), PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_oldSnapshot"), &_14$$23);
	}
	zephir_update_property_zval(this_ptr, ZEND_STRL("_snapshot"), &snapshot);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Mvc_Model, hasSnapshotData) {
	...
	zephir_read_property(&snapshot, this_ptr, ZEND_STRL("_snapshot"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model, hasChanged) {
	...
	if (Z_TYPE_P(fieldName) == IS_STRING) {
		...
		if (allFields) {
			ZEPHIR_CALL_FUNCTION(&_0$$5, "array_intersect", NULL, 260, fieldName, &changedFields);
			zephir_check_call_status();
			RETURN_MM_BOOL(ZEPHIR_IS_EQUAL(&_0$$5, fieldName));
		}
		ZEPHIR_CALL_FUNCTION(&_1$$4, "array_intersect", NULL, 260, fieldName, &changedFields);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, hasUpdated) {
	...
	if (Z_TYPE_P(fieldName) == IS_STRING) {
		...
		if (allFields) {
			ZEPHIR_CALL_FUNCTION(&_0$$5, "array_intersect", NULL, 260, fieldName, &updatedFields);
			zephir_check_call_status();
			RETURN_MM_BOOL(ZEPHIR_IS_EQUAL(&_0$$5, fieldName));
		}
		ZEPHIR_CALL_FUNCTION(&_1$$4, "array_intersect", NULL, 260, fieldName, &updatedFields);
		zephir_check_call_status();
		RETURN_MM_BOOL(zephir_fast_count_int(&_1$$4) > 0);
	}
...
PHP_METHOD(Phalcon_Mvc_Model, getUpdatedFields) {
	...
	zephir_read_property(&oldSnapshot, this_ptr, ZEND_STRL("_oldSnapshot"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Model, _invokeFinder) {
	...
	if (zephir_array_isset(&attributes, &extraMethod)) {
		...
		ZEPHIR_CALL_FUNCTION(&extraMethodFirst, "lcfirst", NULL, 57, &extraMethod);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, __call) {
	...
	ZEPHIR_CALL_SELF(&records, "_invokefinder", &_0, 261, &method, arguments);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, __set) {
	...
	if (Z_TYPE_P(value) == IS_OBJECT) {
		if (zephir_instance_of_ev(value, phalcon_mvc_modelinterface_ce)) {
			...
			zephir_read_property(&dirtyState, this_ptr, ZEND_STRL("_dirtyState"), PH_NOISY_CC);
			...
			zephir_update_property_zval(this_ptr, ZEND_STRL("_dirtyState"), &dirtyState);
	...
	if (Z_TYPE_P(value) == IS_ARRAY) {
		...
		if (zephir_fast_count_int(&related) > 0) {
			...
			ZVAL_LONG(&_13$$17, 1);
			zephir_update_property_zval(this_ptr, ZEND_STRL("_dirtyState"), &_13$$17);
		}
		RETVAL_ZVAL(value, 1, 0);
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&_14, this_ptr, "_possiblesetter", NULL, 251, &property, value);
	zephir_check_call_status();
	if (zephir_is_true(&_14)) {
		RETVAL_ZVAL(value, 1, 0);
		RETURN_MM();
	}
	ZEPHIR_CALL_FUNCTION(&_15, "property_exists", NULL, 262, this_ptr, &property);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, serialize) {
	...
	if (zephir_is_true(&_0)) {
		...
		if (_1$$3) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("serialize", NULL, 54, &_2$$4);
			zephir_check_call_status();
			RETURN_MM();
		}
	}
	ZEPHIR_RETURN_CALL_FUNCTION("serialize", NULL, 54, &attributes);
	zephir_check_call_status();
	RETURN_MM();
	...
	if (Z_TYPE_P(&attributes) == IS_ARRAY) {
		...
		if (zephir_is_true(&_1$$3)) {
			if (zephir_array_isset_string_fetch(&snapshot, &attributes, SL("_snapshot"), 1)) {
				...
				zephir_update_property_zval(this_ptr, ZEND_STRL("_snapshot"), &attributes);
			}
		}
...
PHP_METHOD(Phalcon_Mvc_Model, reset) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_uniqueParams"), &__$null);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_snapshot"), &__$null);
