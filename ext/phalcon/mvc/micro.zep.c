...
PHP_METHOD(Phalcon_Mvc_Micro, mount) {
	...
	if (Z_TYPE_P(&handlers) == IS_ARRAY) {
		...
		if (zephir_is_true(&_0$$5)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &lazyHandler, "__construct", NULL, 245, &mainHandler);
			zephir_check_call_status();
		} else {
...
PHP_METHOD(Phalcon_Mvc_Micro, notFound) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_notFoundHandler"), handler);
	RETURN_THISW();
...
PHP_METHOD(Phalcon_Mvc_Micro, error) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_errorHandler"), handler);
	RETURN_THISW();
...
PHP_METHOD(Phalcon_Mvc_Micro, getRouter) {
	...
	zephir_read_property(&router, this_ptr, ZEND_STRL("_router"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Micro, setService) {
	...
	if (Z_TYPE_P(&dependencyInjector) != IS_OBJECT) {
		...
		ZEPHIR_CALL_METHOD(NULL, &dependencyInjector, "__construct", NULL, 246);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, ZEND_STRL("_dependencyInjector"), &dependencyInjector);
	}
	if (shared) {
	...
	ZEPHIR_RETURN_CALL_METHOD(&dependencyInjector, "set", NULL, 247, &serviceName, definition, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, hasService) {
	...
	ZEPHIR_RETURN_CALL_METHOD(&dependencyInjector, "has", NULL, 248, &serviceName);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, getService) {
	...
	ZEPHIR_RETURN_CALL_METHOD(&dependencyInjector, "get", NULL, 249, &serviceName);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, getSharedService) {
	...
	ZEPHIR_RETURN_CALL_METHOD(&dependencyInjector, "getshared", NULL, 250, serviceName);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, handle) {
	...
	/* try_start_1: */
		...
		if (Z_TYPE_P(&matchedRoute) == IS_OBJECT) {
			...
			zephir_read_property(&_4$$7, this_ptr, ZEND_STRL("_handlers"), PH_NOISY_CC | PH_READONLY);
			...
			if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
				...
				if (ZEPHIR_IS_FALSE_IDENTICAL(&_8$$9)) {
					...
					zephir_read_property(&handler, this_ptr, ZEND_STRL("_activeHandler"), PH_NOISY_CC);
				}
			}
			ZEPHIR_OBS_VAR(&beforeHandlers);
			zephir_read_property(&beforeHandlers, this_ptr, ZEND_STRL("_beforeHandlers"), PH_NOISY_CC);
			if (Z_TYPE_P(&beforeHandlers) == IS_ARRAY) {
				if (0) {
					zephir_update_property_zval(this_ptr, ZEND_STRL("_stopped"), &__$true);
				} else {
					zephir_update_property_zval(this_ptr, ZEND_STRL("_stopped"), &__$false);
				}
					...
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&beforeHandlers), _10$$12)
					{
						...
						if (Z_TYPE_P(&before) == IS_OBJECT) {
							if (zephir_instance_of_ev(&before, phalcon_mvc_micro_middlewareinterface_ce)) {
								...
								zephir_check_call_status_or_jump(try_end_1);
								zephir_read_property(&_12$$15, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
						...
						zephir_check_call_status_or_jump(try_end_1);
						zephir_read_property(&_15$$13, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
						...
						zephir_check_call_status();
							if (Z_TYPE_P(&before) == IS_OBJECT) {
								if (zephir_instance_of_ev(&before, phalcon_mvc_micro_middlewareinterface_ce)) {
									ZEPHIR_CALL_METHOD(&status, &before, "call", NULL, 0, this_ptr);
									zephir_check_call_status_or_jump(try_end_1);
									zephir_read_property(&_16$$21, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
							...
							ZEPHIR_CALL_USER_FUNC(&status, &before);
							zephir_check_call_status_or_jump(try_end_1);
							zephir_read_property(&_19$$19, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
				...
				ZEPHIR_INIT_NVAR(&before);
				zephir_read_property(&_20$$12, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property(&afterBindingHandlers, this_ptr, ZEND_STRL("_afterBindingHandlers"), PH_NOISY_CC);
			if (Z_TYPE_P(&afterBindingHandlers) == IS_ARRAY) {
				...
				if (Z_TYPE_P(&afterBindingHandlers) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&afterBindingHandlers), _32$$36)
					{
						...
						if (_34$$37) {
							...
							zephir_check_call_status_or_jump(try_end_1);
							zephir_read_property(&_35$$38, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
						...
						zephir_check_call_status_or_jump(try_end_1);
						zephir_read_property(&_38$$37, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							if (_39$$42) {
								ZEPHIR_CALL_METHOD(&status, &afterBinding, "call", NULL, 0, this_ptr);
								zephir_check_call_status_or_jump(try_end_1);
								zephir_read_property(&_40$$43, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
							...
							ZEPHIR_CALL_USER_FUNC(&status, &afterBinding);
							zephir_check_call_status_or_jump(try_end_1);
							zephir_read_property(&_43$$42, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
				...
				ZEPHIR_INIT_NVAR(&afterBinding);
				zephir_read_property(&_44$$36, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
				if (zephir_is_true(&_44$$36)) {
					RETURN_CCTOR(&status);
				}
			}
			zephir_update_property_zval(this_ptr, ZEND_STRL("_returnedValue"), &returnedValue);
			if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
			...
			zephir_read_property(&afterHandlers, this_ptr, ZEND_STRL("_afterHandlers"), PH_NOISY_CC);
					...
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&afterHandlers), _46$$49)
					{
						...
						if (Z_TYPE_P(&after) == IS_OBJECT) {
							if (zephir_instance_of_ev(&after, phalcon_mvc_micro_middlewareinterface_ce)) {
								...
								zephir_check_call_status_or_jump(try_end_1);
								zephir_read_property(&_48$$52, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
						...
						zephir_check_call_status_or_jump(try_end_1);
						zephir_read_property(&_51$$50, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
						...
						zephir_check_call_status();
							if (Z_TYPE_P(&after) == IS_OBJECT) {
								if (zephir_instance_of_ev(&after, phalcon_mvc_micro_middlewareinterface_ce)) {
									ZEPHIR_CALL_METHOD(&status, &after, "call", NULL, 0, this_ptr);
									zephir_check_call_status_or_jump(try_end_1);
									zephir_read_property(&_52$$58, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
							...
							ZEPHIR_CALL_USER_FUNC(&status, &after);
							zephir_check_call_status_or_jump(try_end_1);
							zephir_read_property(&_55$$56, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property(&notFoundHandler, this_ptr, ZEND_STRL("_notFoundHandler"), PH_NOISY_CC);
		...
		zephir_read_property(&finishHandlers, this_ptr, ZEND_STRL("_finishHandlers"), PH_NOISY_CC);
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&finishHandlers), _61$$67)
				{
					...
					if (Z_TYPE_P(&finish) == IS_OBJECT) {
						if (zephir_instance_of_ev(&finish, phalcon_mvc_micro_middlewareinterface_ce)) {
							...
							zephir_check_call_status_or_jump(try_end_1);
							zephir_read_property(&_63$$70, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
					...
					zephir_check_call_status_or_jump(try_end_1);
					zephir_read_property(&_67$$68, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
					...
					zephir_check_call_status();
						if (Z_TYPE_P(&finish) == IS_OBJECT) {
							if (zephir_instance_of_ev(&finish, phalcon_mvc_micro_middlewareinterface_ce)) {
								ZEPHIR_CALL_METHOD(&status, &finish, "call", NULL, 0, this_ptr);
								zephir_check_call_status_or_jump(try_end_1);
								zephir_read_property(&_68$$77, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
						...
						ZEPHIR_CALL_USER_FUNC_ARRAY(&status, &finish, &params);
						zephir_check_call_status_or_jump(try_end_1);
						zephir_read_property(&_72$$75, this_ptr, ZEND_STRL("_stopped"), PH_NOISY_CC | PH_READONLY);
	...
	if (EG(exception)) {
		...
		Z_ADDREF_P(&_73);
		if (zephir_instance_of_ev(&_73, zend_ce_exception)) {
			...
			zephir_read_property(&errorHandler, this_ptr, ZEND_STRL("_errorHandler"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Micro, setActiveHandler) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_activeHandler"), activeHandler);
...
zend_object *zephir_init_properties_Phalcon_Mvc_Micro(zend_class_entry *class_type) {
	...
	
	{
		...
		zephir_read_property_ex(&_0, this_ptr, ZEND_STRL("_handlers"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_0) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_1$$3);
			array_init(&_1$$3);
			zephir_update_property_zval_ex(this_ptr, ZEND_STRL("_handlers"), &_1$$3);
		}
		ZEPHIR_MM_RESTORE();
