...
PHP_METHOD(Phalcon_Mvc_Dispatcher, setControllerSuffix) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_handlerSuffix"), &controllerSuffix);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Mvc_Dispatcher, setDefaultController) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_defaultHandler"), &controllerName);
	ZEPHIR_MM_RESTORE();
