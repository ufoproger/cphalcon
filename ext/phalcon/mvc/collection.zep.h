...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_collection_getid, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_collection_getconnection, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_collection_preparecu, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_mvc_collection_method_entry) {
	...
	PHP_ME(Phalcon_Mvc_Collection, getId, arginfo_phalcon_mvc_collection_getid, ZEND_ACC_PUBLIC)
#else
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Mvc_Collection, getConnection, arginfo_phalcon_mvc_collection_getconnection, ZEND_ACC_PUBLIC)
#else
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Mvc_Collection, prepareCU, arginfo_phalcon_mvc_collection_preparecu, ZEND_ACC_PROTECTED)
#else
