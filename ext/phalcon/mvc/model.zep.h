...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_model_getupdatedfields, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_model_reset, 0, 0, 0)
ZEND_END_ARG_INFO()
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Mvc_Model, reset, arginfo_phalcon_mvc_model_reset, ZEND_ACC_PUBLIC)
#else
