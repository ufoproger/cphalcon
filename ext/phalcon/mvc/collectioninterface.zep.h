...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_collectioninterface_getid, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_collectioninterface_getconnection, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_mvc_collectioninterface_method_entry) {
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_CollectionInterface, getId, arginfo_phalcon_mvc_collectioninterface_getid)
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_CollectionInterface, getConnection, arginfo_phalcon_mvc_collectioninterface_getconnection)
