...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_collection_manager_getservicename, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_mvc_collection_manager_method_entry) {
	...
	PHP_ME(Phalcon_Mvc_Collection_Manager, getServiceName, arginfo_phalcon_mvc_collection_manager_getservicename, ZEND_ACC_PUBLIC)
#else
