...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_model_queryinterface_getcacheoptions, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_model_queryinterface_getuniquerow, 0, 0, 0)
ZEND_END_ARG_INFO()
