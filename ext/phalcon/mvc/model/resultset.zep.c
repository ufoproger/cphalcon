...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, __construct) {
	...
	if (Z_TYPE_P(result) != IS_OBJECT) {
		...
		ZVAL_LONG(&_0$$3, 0);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_count"), &_0$$3);
		ZEPHIR_INIT_VAR(&_1$$3);
		array_init(&_1$$3);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_rows"), &_1$$3);
		RETURN_MM_NULL();
	}
	zephir_update_property_zval(this_ptr, ZEND_STRL("_result"), result);
	...
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_count"), &rowCount);
	if (ZEPHIR_IS_LONG(&rowCount, 0)) {
		ZEPHIR_INIT_VAR(&_3$$5);
		array_init(&_3$$5);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_rows"), &_3$$5);
		RETURN_MM_NULL();
	}
	if (ZEPHIR_LE_LONG(&rowCount, 32)) {
		...
		if (Z_TYPE_P(&rows) == IS_ARRAY) {
			zephir_update_property_zval(this_ptr, ZEND_STRL("_rows"), &rows);
		} else {
			ZEPHIR_INIT_VAR(&_4$$8);
			array_init(&_4$$8);
			zephir_update_property_zval(this_ptr, ZEND_STRL("_rows"), &_4$$8);
		}
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, next) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_pointer"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, valid) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_pointer"), PH_NOISY_CC | PH_READONLY);
	zephir_read_property(&_1, this_ptr, ZEND_STRL("_count"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, seek) {
	...
	if (!(_1)) {
		zephir_read_property(&_2, this_ptr, ZEND_STRL("_row"), PH_NOISY_CC | PH_READONLY);
		_1 = Z_TYPE_P(&_2) == IS_NULL;
	}
	if (_1) {
		ZEPHIR_OBS_VAR(&_3$$3);
		zephir_read_property(&_3$$3, this_ptr, ZEND_STRL("_rows"), PH_NOISY_CC);
		if (Z_TYPE_P(&_3$$3) == IS_ARRAY) {
			ZEPHIR_OBS_VAR(&row);
			zephir_read_property(&_4$$4, this_ptr, ZEND_STRL("_rows"), PH_NOISY_CC | PH_READONLY);
			if (zephir_array_isset_fetch(&row, &_4$$4, position, 0)) {
				zephir_update_property_zval(this_ptr, ZEND_STRL("_row"), &row);
			}
			zephir_update_property_zval(this_ptr, ZEND_STRL("_pointer"), position);
			zephir_update_property_zval(this_ptr, ZEND_STRL("_activeRow"), &__$null);
			RETURN_MM_NULL();
		}
		ZEPHIR_OBS_VAR(&result);
		zephir_read_property(&result, this_ptr, ZEND_STRL("_result"), PH_NOISY_CC);
		zephir_read_property(&_5$$3, this_ptr, ZEND_STRL("_row"), PH_NOISY_CC | PH_READONLY);
		_6$$3 = Z_TYPE_P(&_5$$3) == IS_NULL;
		if (_6$$3) {
			zephir_read_property(&_7$$3, this_ptr, ZEND_STRL("_pointer"), PH_NOISY_CC | PH_READONLY);
			_6$$3 = ZEPHIR_IS_LONG_IDENTICAL(&_7$$3, 0);
		}
		if (_6$$3) {
			ZEPHIR_CALL_METHOD(&_8$$6, &result, "fetch", NULL, 0);
			zephir_check_call_status();
			zephir_update_property_zval(this_ptr, ZEND_STRL("_row"), &_8$$6);
		}
		zephir_read_property(&_9$$3, this_ptr, ZEND_STRL("_pointer"), PH_NOISY_CC | PH_READONLY);
		if (ZEPHIR_GT(&_9$$3, position)) {
			...
			zephir_check_call_status();
			zephir_update_property_zval(this_ptr, ZEND_STRL("_row"), &_10$$7);
			zephir_update_property_zval(this_ptr, ZEND_STRL("_pointer"), position);
		}
		while (1) {
			zephir_read_property(&_11$$3, this_ptr, ZEND_STRL("_pointer"), PH_NOISY_CC | PH_READONLY);
			if (!(ZEPHIR_LT(&_11$$3, position))) {
				break;
			}
			ZEPHIR_CALL_METHOD(&_12$$8, &result, "fetch", &_13, 0);
			zephir_check_call_status();
			zephir_update_property_zval(this_ptr, ZEND_STRL("_row"), &_12$$8);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, offsetExists) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_count"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, getType) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZEPHIR_OBS_VAR(&_1);
	zephir_read_property(&_1, this_ptr, ZEND_STRL("_rows"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, getLast) {
	...
	zephir_read_property(&count, this_ptr, ZEND_STRL("_count"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, setIsFresh) {
	...
	if (isFresh) {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_isFresh"), &__$true);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_isFresh"), &__$false);
	}
	RETURN_THISW();
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, setHydrateMode) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_hydrateMode"), &_0);
	RETURN_THISW();
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, update) {
	...
	while (1) {
		...
		if (!(zephir_is_true(&_6$$3))) {
			...
			zephir_check_call_status();
			zephir_update_property_zval(this_ptr, ZEND_STRL("_errorMessages"), &_7$$8);
