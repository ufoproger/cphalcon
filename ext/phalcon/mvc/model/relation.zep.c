...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_referencedModel"), &referencedModel);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_fields"), fields);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_referencedFields"), referencedFields);
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_intermediateFields"), intermediateFields);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_intermediateModel"), &intermediateModel);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_intermediateReferencedFields"), intermediateReferencedFields);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, isThrough) {
	...
	zephir_read_property(&type, this_ptr, ZEND_STRL("_type"), PH_NOISY_CC | PH_READONLY);
