...
PHP_METHOD(Phalcon_Mvc_Model_Query, __construct) {
	...
	if (Z_TYPE_P(phql) != IS_NULL) {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_phql"), phql);
	}
	...
	if (_0) {
		if (ZEPHIR_IS_TRUE(&enableImplicitJoins)) {
			zephir_update_property_zval(this_ptr, ZEND_STRL("_enableImplicitJoins"), &__$true);
		} else {
			zephir_update_property_zval(this_ptr, ZEND_STRL("_enableImplicitJoins"), &__$false);
		}
	} else {
...
PHP_METHOD(Phalcon_Mvc_Model_Query, setDI) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_manager"), &manager);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_metaData"), &metaData);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, setUniqueRow) {
	...
	if (uniqueRow) {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_uniqueRow"), &__$true);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_uniqueRow"), &__$false);
	}
	RETURN_THISW();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getQualified) {
	...
	zephir_read_property(&sqlColumnAliases, this_ptr, ZEND_STRL("_sqlColumnAliases"), PH_NOISY_CC);
	...
	zephir_read_property(&metaData, this_ptr, ZEND_STRL("_metaData"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(&columnDomain);
	if (zephir_array_isset_string_fetch(&columnDomain, &expr, SL("domain"), 0)) {
		ZEPHIR_OBS_VAR(&sqlAliases);
		zephir_read_property(&sqlAliases, this_ptr, ZEND_STRL("_sqlAliases"), PH_NOISY_CC);
		...
		if (!(zephir_array_isset_fetch(&source, &sqlAliases, &columnDomain, 0))) {
			...
			zephir_read_property(&_4$$5, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_GLOBAL(orm).column_renaming) {
			...
			zephir_read_property(&sqlAliasesModelsInstances, this_ptr, ZEND_STRL("_sqlAliasesModelsInstances"), PH_NOISY_CC);
			...
			if (!(zephir_array_isset_fetch(&model, &sqlAliasesModelsInstances, &columnDomain, 0))) {
				...
				zephir_read_property(&_7$$7, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
		...
		if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
			...
			if (!(zephir_array_isset_fetch(&realColumnName, &columnMap, &columnName, 0))) {
				...
				zephir_read_property(&_10$$10, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property(&_12$$12, this_ptr, ZEND_STRL("_modelsInstances"), PH_NOISY_CC | PH_READONLY);
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_12$$12), _13$$12)
			{
				...
				if (zephir_is_true(&_15$$13)) {
					...
					if (number > 1) {
						...
						zephir_read_property(&_18$$15, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
				...
				zephir_check_call_status();
					...
					if (zephir_is_true(&_20$$16)) {
						...
						if (number > 1) {
							...
							zephir_read_property(&_23$$18, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_FALSE_IDENTICAL(&hasModel)) {
			...
			zephir_read_property(&_26$$19, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
		...
		if (!(zephir_array_isset_fetch(&source, &models, &className, 0))) {
			...
			zephir_read_property(&_29$$21, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
		...
		if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
			...
			if (!(zephir_array_isset_fetch(&realColumnName, &columnMap, &columnName, 0))) {
				...
				zephir_read_property(&_32$$25, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getCallArgument) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getexpression", NULL, 274, &argument);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getCaseExpression) {
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
		{
			...
			if (zephir_array_isset_string(&whenExpr, SL("right"))) {
				...
				ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "_getexpression", &_6, 274, &_5$$4);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "_getexpression", &_6, 274, &_7$$4);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_9$$5, this_ptr, "_getexpression", &_6, 274, &_10$$5);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (zephir_array_isset_string(&whenExpr, SL("right"))) {
					...
					ZEPHIR_CALL_METHOD(&_12$$7, this_ptr, "_getexpression", &_6, 274, &_13$$7);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_12$$7, this_ptr, "_getexpression", &_6, 274, &_14$$7);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_16$$8, this_ptr, "_getexpression", &_6, 274, &_17$$8);
					zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_18, this_ptr, "_getexpression", &_6, 274, &_19);
	zephir_check_call_status();
		...
		if (zephir_array_isset_long(&arguments, 0)) {
			...
			if (Z_TYPE_P(&arguments) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&arguments), _0$$6)
				{
					...
					ZEPHIR_CALL_METHOD(&_2$$7, this_ptr, "_getcallargument", &_3, 275, &argument);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_4$$8, this_ptr, "_getcallargument", &_3, 275, &argument);
						zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&_6$$9, this_ptr, "_getcallargument", &_3, 275, &arguments);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getExpression) {
	...
	if (zephir_array_isset_string_fetch(&exprType, expr, SL("type"), 0)) {
		...
		if (!ZEPHIR_IS_LONG(&exprType, 409)) {
			...
			if (zephir_array_isset_string_fetch(&exprLeft, expr, SL("left"), 0)) {
				...
				ZEPHIR_CALL_METHOD(&left, this_ptr, "_getexpression", NULL, 274, &exprLeft, &_0$$5);
				zephir_check_call_status();
			}
			...
			if (zephir_array_isset_string_fetch(&exprRight, expr, SL("right"), 0)) {
				...
				ZEPHIR_CALL_METHOD(&right, this_ptr, "_getexpression", NULL, 274, &exprRight, &_1$$6);
				zephir_check_call_status();
			}
		}
		do {
			...
			if (ZEPHIR_IS_LONG(&exprType, 355)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "_getqualified", NULL, 276, expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&exprType, '+')) {
				...
				if (zephir_memnstr_str(&value, SL(":"), "phalcon/mvc/model/query.zep", 629)) {
					...
					do {
						...
						if (ZEPHIR_IS_STRING(&bindType, "array") || ZEPHIR_IS_STRING(&bindType, "array-str") || ZEPHIR_IS_STRING(&bindType, "array-int")) {
							ZEPHIR_OBS_VAR(&bind);
							zephir_read_property(&_49$$43, this_ptr, ZEND_STRL("_bindParams"), PH_NOISY_CC | PH_READONLY);
			...
			if (ZEPHIR_IS_LONG(&exprType, 350)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "_getfunctioncall", NULL, 277, expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&exprType, 409)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "_getcaseexpression", NULL, 278, expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&exprType, 309)) {
				...
				ZVAL_BOOL(&_82$$68, 1);
				ZEPHIR_CALL_METHOD(&_81$$68, this_ptr, "_prepareselect", NULL, 279, expr, &_82$$68);
				zephir_check_call_status();
	...
	if (zephir_array_isset_string(expr, SL("domain"))) {
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getqualified", NULL, 276, expr);
		zephir_check_call_status();
		RETURN_MM();
	}
	if (zephir_array_isset_long(expr, 0)) {
		...
		if (Z_TYPE_P(expr) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expr), _85$$71)
			{
				...
				ZEPHIR_CALL_METHOD(&_87$$72, this_ptr, "_getexpression", NULL, 274, &exprListItem);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_88$$73, this_ptr, "_getexpression", NULL, 274, &exprListItem);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getSelectColumn) {
	...
	if (ZEPHIR_IS_LONG(&columnType, 352)) {
		zephir_read_property(&_0$$4, this_ptr, ZEND_STRL("_models"), PH_NOISY_CC | PH_READONLY);
		...
		if (Z_TYPE_P(&_0$$4) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_0$$4), _3$$4, _4$$4, _1$$4)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_5$$5, "lcfirst", &_6, 57, &modelName);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_9$$7, "lcfirst", &_6, 57, &modelName);
					zephir_check_call_status();
	...
	if (ZEPHIR_IS_LONG(&columnType, 353)) {
		...
		if (!(zephir_array_isset_fetch(&source, &sqlAliases, &columnDomain, 0))) {
			...
			zephir_read_property(&_12$$11, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property(&sqlAliasesModels, this_ptr, ZEND_STRL("_sqlAliasesModels"), PH_NOISY_CC);
		...
		if (Z_TYPE_P(&preparedAlias) != IS_STRING) {
			if (ZEPHIR_IS_EQUAL(&columnDomain, &modelName)) {
				ZEPHIR_CALL_FUNCTION(&preparedAlias, "lcfirst", &_6, 57, &modelName);
				zephir_check_call_status();
			} else {
	...
	if (ZEPHIR_IS_LONG(&columnType, 354)) {
		...
		ZEPHIR_CALL_METHOD(&sqlExprColumn, this_ptr, "_getexpression", NULL, 274, &columnData);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getJoinType) {
	...
	zephir_read_property(&_1, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_2);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getSingleJoin) {
	...
	ZEND_PARSE_PARAMETERS_START(5, 5)
		...
		Z_PARAM_ZVAL(modelAlias)
		Z_PARAM_ZVAL(joinAlias)
	...
	if (Z_TYPE_P(&fields) != IS_ARRAY) {
		...
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "_getqualified", NULL, 276, &_3$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "_getqualified", NULL, 276, &_4$$3);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _7$$4, _8$$4, _5$$4)
			{
				...
				if (!(zephir_array_isset_fetch(&referencedField, &referencedFields, &position, 0))) {
					...
					zephir_read_property(&_10$$6, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
				...
				ZEPHIR_CALL_METHOD(&_14$$5, this_ptr, "_getqualified", NULL, 276, &_15$$5);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_14$$5, this_ptr, "_getqualified", NULL, 276, &_16$$5);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (!(zephir_array_isset_fetch(&referencedField, &referencedFields, &position, 0))) {
						...
						zephir_read_property(&_18$$8, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
					...
					ZEPHIR_CALL_METHOD(&_21$$7, this_ptr, "_getqualified", NULL, 276, &_22$$7);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_21$$7, this_ptr, "_getqualified", NULL, 276, &_23$$7);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getMultiJoin) {
	...
	zephir_read_property(&manager, this_ptr, ZEND_STRL("_manager"), PH_NOISY_CC);
	...
	if (Z_TYPE_P(&fields) == IS_ARRAY) {
		...
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _2$$3, _3$$3, _0$$3)
			{
				...
				if (!(zephir_array_isset(&referencedFields, &position))) {
					...
					zephir_read_property(&_5$$5, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
				...
				ZEPHIR_CALL_METHOD(&_8$$4, this_ptr, "_getqualified", &_10, 276, &_9$$4);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_8$$4, this_ptr, "_getqualified", &_10, 276, &_11$$4);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					if (!(zephir_array_isset(&referencedFields, &position))) {
						...
						zephir_read_property(&_13$$7, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
					...
					ZEPHIR_CALL_METHOD(&_16$$6, this_ptr, "_getqualified", &_10, 276, &_17$$6);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_16$$6, this_ptr, "_getqualified", &_10, 276, &_18$$6);
					zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_23$$8, this_ptr, "_getqualified", &_10, 276, &_24$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_23$$8, this_ptr, "_getqualified", &_10, 276, &_25$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_23$$8, this_ptr, "_getqualified", &_10, 276, &_26$$8);
		zephir_check_call_status();
		zephir_array_update_string(&_22$$8, SL("left"), &_23$$8, PH_COPY | PH_SEPARATE);
		...
		ZEPHIR_CALL_METHOD(&_23$$8, this_ptr, "_getqualified", &_10, 276, &_27$$8);
		zephir_check_call_status();
		zephir_array_update_string(&_22$$8, SL("right"), &_23$$8, PH_COPY | PH_SEPARATE);
		zephir_array_fast_append(&_21$$8, &_22$$8);
		zephir_array_update_string(&_20$$8, SL("conditions"), &_21$$8, PH_COPY | PH_SEPARATE);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getJoins) {
	...
	zephir_read_property(&sqlModelsAliases, this_ptr, ZEND_STRL("_sqlModelsAliases"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(&sqlAliasesModelsInstances);
	zephir_read_property(&sqlAliasesModelsInstances, this_ptr, ZEND_STRL("_sqlAliasesModelsInstances"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(&modelsInstances);
	zephir_read_property(&modelsInstances, this_ptr, ZEND_STRL("_modelsInstances"), PH_NOISY_CC);
	...
	if (Z_TYPE_P(&selectJoins) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectJoins), _0)
		{
			...
			ZEPHIR_CALL_METHOD(&joinData, this_ptr, "_getjoin", &_2, 280, &manager, &joinItem);
			zephir_check_call_status();
			ZEPHIR_OBS_NVAR(&source);
			...
			ZEPHIR_CALL_METHOD(&joinType, this_ptr, "_getjointype", &_3, 281, &joinItem);
			zephir_check_call_status();
			...
			if (zephir_array_isset_string_fetch(&aliasExpr, &joinItem, SL("alias"), 0)) {
				...
				if (zephir_array_isset(&joinModels, &alias)) {
					...
					zephir_read_property(&_5$$9, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
				...
				if (zephir_array_isset(&joinModels, &realModelName)) {
					...
					zephir_read_property(&_9$$11, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
			...
			zephir_check_call_status();
				...
				if (zephir_array_isset_string_fetch(&aliasExpr, &joinItem, SL("alias"), 0)) {
					...
					if (zephir_array_isset(&joinModels, &alias)) {
						...
						zephir_read_property(&_13$$14, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
					...
					if (zephir_array_isset(&joinModels, &realModelName)) {
						...
						zephir_read_property(&_16$$16, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_sqlAliases"), &sqlAliases);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_sqlAliasesModels"), &sqlAliasesModels);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_sqlModelsAliases"), &sqlModelsAliases);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_sqlAliasesModelsInstances"), &sqlAliasesModelsInstances);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_modelsInstances"), &modelsInstances);
	...
	if (Z_TYPE_P(&joinPrepared) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&joinPrepared), _20, _21, _18)
		{
			...
			if (zephir_array_isset_string_fetch(&joinExpr, &joinItem, SL("conditions"), 0)) {
				ZEPHIR_CALL_METHOD(&_22$$18, this_ptr, "_getexpression", &_23, 274, &joinExpr);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_OBS_NVAR(&joinExpr);
				if (zephir_array_isset_string_fetch(&joinExpr, &joinItem, SL("conditions"), 0)) {
					ZEPHIR_CALL_METHOD(&_24$$20, this_ptr, "_getexpression", &_23, 274, &joinExpr);
					zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&joinItem);
	ZEPHIR_INIT_NVAR(&joinAliasName);
	zephir_read_property(&_25, this_ptr, ZEND_STRL("_enableImplicitJoins"), PH_NOISY_CC | PH_READONLY);
					...
					if (!(zephir_array_isset_fetch(&preCondition, &joinPreCondition, &joinAlias, 0))) {
						...
						if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
							...
							if (Z_TYPE_P(&relations) == IS_ARRAY) {
								if (zephir_fast_count_int(&relations) != 1) {
									...
									zephir_read_property(&_53$$31, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
						...
						if (Z_TYPE_P(&relation) == IS_OBJECT) {
							...
							if (!(zephir_is_true(&_55$$32))) {
								ZEPHIR_CALL_METHOD(&sqlJoin, this_ptr, "_getsinglejoin", &_56, 282, &joinType, &joinSource, &modelAlias, &joinAlias, &relation);
								zephir_check_call_status();
							} else {
								ZEPHIR_CALL_METHOD(&sqlJoin, this_ptr, "_getmultijoin", &_57, 283, &joinType, &joinSource, &modelAlias, &joinAlias, &relation);
								zephir_check_call_status();
							}
							...
							if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
								...
								if (Z_TYPE_P(&relations) == IS_ARRAY) {
									if (zephir_fast_count_int(&relations) != 1) {
										...
										zephir_read_property(&_67$$45, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
							...
							if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
								...
								if (Z_TYPE_P(&relations) == IS_ARRAY) {
									if (zephir_fast_count_int(&relations) != 1) {
										...
										zephir_read_property(&_83$$60, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
								...
								if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
									...
									if (Z_TYPE_P(&relations) == IS_ARRAY) {
										if (zephir_fast_count_int(&relations) != 1) {
											...
											zephir_read_property(&_95$$74, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getOrderClause) {
	...
	if (Z_TYPE_P(&orderColumns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&orderColumns), _0)
		{
			...
			ZEPHIR_CALL_METHOD(&orderPartExpr, this_ptr, "_getexpression", &_3, 274, &_2$$5);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&orderPartExpr, this_ptr, "_getexpression", &_3, 274, &_9$$10);
				zephir_check_call_status();
	...
	if (zephir_array_isset_long(&group, 0)) {
		...
		if (Z_TYPE_P(&group) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&group), _0$$3)
			{
				...
				ZEPHIR_CALL_METHOD(&_2$$4, this_ptr, "_getexpression", &_3, 274, &groupItem);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_4$$5, this_ptr, "_getexpression", &_3, 274, &groupItem);
					zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_6$$6, this_ptr, "_getexpression", &_3, 274, &group);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getLimitClause) {
	...
	if (zephir_array_isset_string_fetch(&number, &limitClause, SL("number"), 0)) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "_getexpression", NULL, 274, &number);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&offset, &limitClause, SL("offset"), 0)) {
		ZEPHIR_CALL_METHOD(&_1$$4, this_ptr, "_getexpression", NULL, 274, &offset);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareSelect) {
	...
	if (ZEPHIR_IS_EMPTY(ast)) {
		ZEPHIR_OBS_NVAR(ast);
		zephir_read_property(ast, this_ptr, ZEND_STRL("_ast"), PH_NOISY_CC);
	}
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectedModels), _0)
		{
			...
			if (zephir_array_isset_string_fetch(&alias, &selectedModel, SL("alias"), 0)) {
				if (zephir_array_isset(&sqlAliases, &alias)) {
					...
					zephir_read_property(&_9$$20, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
					...
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&withs), _13$$24)
					{
						...
						if (Z_TYPE_P(&relation) == IS_OBJECT) {
							...
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								...
								zephir_read_property(&_22$$31, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
						...
						zephir_check_call_status();
							...
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								...
								if (Z_TYPE_P(&relation) == IS_OBJECT) {
									...
									zephir_read_property(&_34$$36, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
			...
			zephir_check_call_status();
				...
				if (zephir_array_isset_string_fetch(&alias, &selectedModel, SL("alias"), 0)) {
					if (zephir_array_isset(&sqlAliases, &alias)) {
						...
						zephir_read_property(&_47$$43, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
						...
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&withs), _51$$47)
						{
							...
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								...
								if (Z_TYPE_P(&relation) == IS_OBJECT) {
									...
									zephir_read_property(&_60$$54, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
							...
							zephir_check_call_status();
								...
								if (Z_TYPE_P(&relation) == IS_OBJECT) {
									...
									if (Z_TYPE_P(&relation) == IS_OBJECT) {
										...
										zephir_read_property(&_72$$59, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
	...
	if (!(zephir_is_true(merge))) {
		...
		zephir_read_property(&tempModels, this_ptr, ZEND_STRL("_models"), PH_NOISY_CC);
		ZEPHIR_OBS_VAR(&tempModelsInstances);
		zephir_read_property(&tempModelsInstances, this_ptr, ZEND_STRL("_modelsInstances"), PH_NOISY_CC);
		ZEPHIR_OBS_VAR(&tempSqlAliases);
		zephir_read_property(&tempSqlAliases, this_ptr, ZEND_STRL("_sqlAliases"), PH_NOISY_CC);
		ZEPHIR_OBS_VAR(&tempSqlAliasesModels);
		zephir_read_property(&tempSqlAliasesModels, this_ptr, ZEND_STRL("_sqlAliasesModels"), PH_NOISY_CC);
		ZEPHIR_OBS_VAR(&tempSqlModelsAliases);
		zephir_read_property(&tempSqlModelsAliases, this_ptr, ZEND_STRL("_sqlModelsAliases"), PH_NOISY_CC);
		ZEPHIR_OBS_VAR(&tempSqlAliasesModelsInstances);
		zephir_read_property(&tempSqlAliasesModelsInstances, this_ptr, ZEND_STRL("_sqlAliasesModelsInstances"), PH_NOISY_CC);
		ZEPHIR_INIT_VAR(&_77$$61);
		zephir_read_property(&_78$$61, this_ptr, ZEND_STRL("_models"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_77$$61, &_78$$61, &models);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_models"), &_77$$61);
		ZEPHIR_INIT_VAR(&_79$$61);
		zephir_read_property(&_80$$61, this_ptr, ZEND_STRL("_modelsInstances"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_79$$61, &_80$$61, &modelsInstances);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_modelsInstances"), &_79$$61);
		ZEPHIR_INIT_VAR(&_81$$61);
		zephir_read_property(&_82$$61, this_ptr, ZEND_STRL("_sqlAliases"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_81$$61, &_82$$61, &sqlAliases);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_sqlAliases"), &_81$$61);
		ZEPHIR_INIT_VAR(&_83$$61);
		zephir_read_property(&_84$$61, this_ptr, ZEND_STRL("_sqlAliasesModels"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_83$$61, &_84$$61, &sqlAliasesModels);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_sqlAliasesModels"), &_83$$61);
		ZEPHIR_INIT_VAR(&_85$$61);
		zephir_read_property(&_86$$61, this_ptr, ZEND_STRL("_sqlModelsAliases"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_85$$61, &_86$$61, &sqlModelsAliases);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_sqlModelsAliases"), &_85$$61);
		ZEPHIR_INIT_VAR(&_87$$61);
		zephir_read_property(&_88$$61, this_ptr, ZEND_STRL("_sqlAliasesModelsInstances"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_87$$61, &_88$$61, &sqlAliasesModelsInstances);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_sqlAliasesModelsInstances"), &_87$$61);
	}
	ZEPHIR_OBS_VAR(&joins);
	...
	if (zephir_fast_count_int(&joins)) {
		...
		ZEPHIR_CALL_METHOD(&sqlJoins, this_ptr, "_getjoins", NULL, 284, &select);
		zephir_check_call_status();
	} else {
		if (zephir_fast_count_int(&automaticJoins)) {
			zephir_array_update_string(&select, SL("joins"), &automaticJoins, PH_COPY | PH_SEPARATE);
	...
	if (Z_TYPE_P(&selectColumns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectColumns), _90)
		{
			...
			ZEPHIR_CALL_METHOD(&_92$$69, this_ptr, "_getselectcolumn", &_93, 285, &column);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_102$$84, this_ptr, "_getselectcolumn", &_93, 285, &column);
				zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&column);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_sqlColumnAliases"), &sqlColumnAliases);
	...
	if (zephir_array_isset_string_fetch(&where, ast, SL("where"), 0)) {
		ZEPHIR_CALL_METHOD(&_111$$101, this_ptr, "_getexpression", NULL, 274, &where);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&groupBy, ast, SL("groupBy"), 0)) {
		ZEPHIR_CALL_METHOD(&_112$$102, this_ptr, "_getgroupclause", NULL, 286, &groupBy);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&having, ast, SL("having"), 0)) {
		ZEPHIR_CALL_METHOD(&_113$$103, this_ptr, "_getexpression", NULL, 274, &having);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&order, ast, SL("orderBy"), 0)) {
		ZEPHIR_CALL_METHOD(&_114$$104, this_ptr, "_getorderclause", NULL, 287, &order);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&limit, ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_115$$105, this_ptr, "_getlimitclause", NULL, 288, &limit);
		zephir_check_call_status();
	...
	if (zephir_is_true(merge)) {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_models"), &tempModels);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_modelsInstances"), &tempModelsInstances);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_sqlAliases"), &tempSqlAliases);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_sqlAliasesModels"), &tempSqlAliasesModels);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_sqlModelsAliases"), &tempSqlModelsAliases);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_sqlAliasesModelsInstances"), &tempSqlAliasesModelsInstances);
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareInsert) {
	...
	if (Z_TYPE_P(&_5) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_5), _6)
		{
			...
			ZEPHIR_CALL_METHOD(&_10$$9, this_ptr, "_getexpression", &_12, 274, &exprValue, &_11$$9);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_15$$10, this_ptr, "_getexpression", &_12, 274, &exprValue, &_16$$10);
				zephir_check_call_status();
		...
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fields), _17$$11)
			{
				...
				if (!(zephir_is_true(&_19$$12))) {
					...
					zephir_read_property(&_22$$13, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (!(zephir_is_true(&_25$$14))) {
						...
						zephir_read_property(&_28$$15, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareUpdate) {
	...
	if (Z_TYPE_P(&updateValues) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&updateValues), _18)
		{
			...
			ZEPHIR_CALL_METHOD(&_20$$24, this_ptr, "_getexpression", &_23, 274, &_21$$24, &_22$$24);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&_26$$24, this_ptr, "_getexpression", &_23, 274, &exprColumn, &_27$$24);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_28$$25, this_ptr, "_getexpression", &_23, 274, &_29$$25, &_30$$25);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_33$$25, this_ptr, "_getexpression", &_23, 274, &exprColumn, &_34$$25);
				zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&where, &ast, SL("where"), 0)) {
		ZVAL_BOOL(&_36$$26, 1);
		ZEPHIR_CALL_METHOD(&_35$$26, this_ptr, "_getexpression", &_23, 274, &where, &_36$$26);
		zephir_check_call_status();
		zephir_array_update_string(&sqlUpdate, SL("where"), &_35$$26, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(&limit);
	if (zephir_array_isset_string_fetch(&limit, &ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_37$$27, this_ptr, "_getlimitclause", NULL, 288, &limit);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareDelete) {
	...
	if (zephir_array_isset_string_fetch(&where, &ast, SL("where"), 0)) {
		ZVAL_BOOL(&_19$$21, 1);
		ZEPHIR_CALL_METHOD(&_18$$21, this_ptr, "_getexpression", NULL, 274, &where, &_19$$21);
		zephir_check_call_status();
		zephir_array_update_string(&sqlDelete, SL("where"), &_18$$21, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(&limit);
	if (zephir_array_isset_string_fetch(&limit, &ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_20$$22, this_ptr, "_getlimitclause", NULL, 288, &limit);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, parse) {
	...
	zephir_read_property(&intermediate, this_ptr, ZEND_STRL("_intermediate"), PH_NOISY_CC);
	if (Z_TYPE_P(&intermediate) == IS_ARRAY) {
		RETURN_CCTOR(&intermediate);
	}
	ZEPHIR_OBS_VAR(&phql);
	zephir_read_property(&phql, this_ptr, ZEND_STRL("_phql"), PH_NOISY_CC);
	ZEPHIR_INIT_VAR(&ast);
	ZEPHIR_LAST_CALL_STATUS = phql_parse_phql(&ast, &phql);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&ast) == IS_ARRAY) {
		...
		if (zephir_array_isset_string_fetch(&uniqueId, &ast, SL("id"), 0)) {
			...
			if (zephir_array_isset_fetch(&irPhql, &_0$$5, &uniqueId, 0)) {
				if (Z_TYPE_P(&irPhql) == IS_ARRAY) {
					...
					zephir_update_property_zval(this_ptr, ZEND_STRL("_type"), &_1$$7);
					RETURN_CCTOR(&irPhql);
				}
			}
		}
		...
		if (zephir_array_isset_string_fetch(&type, &ast, SL("type"), 0)) {
			zephir_update_property_zval(this_ptr, ZEND_STRL("_ast"), &ast);
			zephir_update_property_zval(this_ptr, ZEND_STRL("_type"), &type);
			do {
				if (ZEPHIR_IS_LONG(&type, 309)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareselect", NULL, 279);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 306)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareinsert", NULL, 289);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 300)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareupdate", NULL, 290);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 303)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_preparedelete", NULL, 291);
					zephir_check_call_status();
					break;
				}
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_intermediate"), &irPhql);
	RETURN_CCTOR(&irPhql);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeSelect) {
	...
	if (Z_TYPE_P(&models) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&models), _0)
		{
			...
			ZEPHIR_OBS_NVAR(&model);
			zephir_read_property(&_2$$3, this_ptr, ZEND_STRL("_modelsInstances"), PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_OBS_NVAR(&model);
				zephir_read_property(&_7$$7, this_ptr, ZEND_STRL("_modelsInstances"), PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&columns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&columns), _17, _18, _15)
		{
			...
			if (ZEPHIR_IS_STRING(&_19$$28, "object")) {
				...
				zephir_read_property(&_20$$29, this_ptr, ZEND_STRL("_modelsInstances"), PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (ZEPHIR_IS_STRING(&_40$$46, "object")) {
					...
					zephir_array_fetch_string(&modelName, &column, SL("model"), PH_NOISY, "phalcon/mvc/model/query.zep", 2653);
					ZEPHIR_OBS_NVAR(&instance);
					zephir_read_property(&_41$$47, this_ptr, ZEND_STRL("_modelsInstances"), PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property(&_73, this_ptr, ZEND_STRL("_sharedLock"), PH_NOISY_CC | PH_READONLY);
	...
	if (isComplex == 0) {
		...
		if (_93$$87) {
			...
			if (zephir_is_true(&resultsetClassName)) {
				...
				ZEPHIR_CALL_FUNCTION(&_97$$101, "is_subclass_of", NULL, 264, &resultsetClassName, &_96$$101);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 292, &simpleColumnMap, &resultObject, &resultData, &cache, &_103$$87);
		zephir_check_call_status();
		RETURN_MM();
	}
	object_init_ex(return_value, phalcon_mvc_model_resultset_complex_ce);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 293, &columns1, &resultData, &cache);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeInsert) {
	...
	zephir_read_property(&manager, this_ptr, ZEND_STRL("_manager"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(&model);
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_modelsInstances"), PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 294, &_33, &insertModel);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeUpdate) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_modelsInstances"), PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_fetch(&model, &_0, &modelName, 0))) {
		zephir_read_property(&_1$$4, this_ptr, ZEND_STRL("_manager"), PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_INIT_NVAR(&field);
	ZEPHIR_INIT_NVAR(&number);
	ZEPHIR_CALL_METHOD(&records, this_ptr, "_getrelatedrecords", NULL, 295, &model, intermediate, &selectBindParams, &selectBindTypes);
	zephir_check_call_status();
	if (!(zephir_fast_count_int(&records))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZVAL_BOOL(&_28$$27, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 294, &_28$$27);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&connection, this_ptr, "getwriteconnection", NULL, 0, &model, intermediate, bindParams, bindTypes);
	...
	while (1) {
		...
		if (!(zephir_is_true(&_31$$28))) {
			...
			object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
			ZVAL_BOOL(&_33$$29, 0);
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 294, &_33$$29, &record);
			zephir_check_call_status();
			RETURN_MM();
		}
	...
	object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
	ZVAL_BOOL(&_35, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 294, &_35);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeDelete) {
	...
	ZEPHIR_CALL_METHOD(&records, this_ptr, "_getrelatedrecords", NULL, 295, &model, intermediate, bindParams, bindTypes);
	zephir_check_call_status();
	if (!(zephir_fast_count_int(&records))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZVAL_BOOL(&_2$$5, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 294, &_2$$5);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&connection, this_ptr, "getwriteconnection", NULL, 0, &model, intermediate, bindParams, bindTypes);
	...
	while (1) {
		...
		if (!(zephir_is_true(&_5$$6))) {
			...
			object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
			ZVAL_BOOL(&_7$$7, 0);
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 294, &_7$$7, &record);
			zephir_check_call_status();
			RETURN_MM();
		}
	...
	object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
	ZVAL_BOOL(&_9, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 294, &_9);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getRelatedRecords) {
	...
	ZEPHIR_CALL_METHOD(NULL, &query, "__construct", NULL, 296);
	zephir_check_call_status();
	zephir_read_property(&_5, this_ptr, ZEND_STRL("_dependencyInjector"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, &query, "setdi", NULL, 297, &_5);
	zephir_check_call_status();
	ZVAL_LONG(&_6, 309);
	ZEPHIR_CALL_METHOD(NULL, &query, "settype", NULL, 298, &_6);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &query, "setintermediate", NULL, 299, &selectIr);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(&query, "execute", NULL, 300, bindParams, bindTypes);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, execute) {
	...
	zephir_read_property(&uniqueRow, this_ptr, ZEND_STRL("_uniqueRow"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(&cacheOptions);
	zephir_read_property(&cacheOptions, this_ptr, ZEND_STRL("_cacheOptions"), PH_NOISY_CC);
	if (Z_TYPE_P(&cacheOptions) != IS_NULL) {
		...
		zephir_read_property(&_0$$3, this_ptr, ZEND_STRL("_dependencyInjector"), PH_NOISY_CC | PH_READONLY);
		...
		zephir_update_property_zval(this_ptr, ZEND_STRL("_cache"), &cache);
	}
	ZEPHIR_OBS_VAR(&defaultBindParams);
	zephir_read_property(&defaultBindParams, this_ptr, ZEND_STRL("_bindParams"), PH_NOISY_CC);
	...
	zephir_read_property(&defaultBindTypes, this_ptr, ZEND_STRL("_bindTypes"), PH_NOISY_CC);
	...
	ZEPHIR_OBS_VAR(&type);
	zephir_read_property(&type, this_ptr, ZEND_STRL("_type"), PH_NOISY_CC);
	do {
		if (ZEPHIR_IS_LONG(&type, 309)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executeselect", NULL, 301, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 306)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executeinsert", NULL, 302, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 300)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executeupdate", NULL, 303, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 303)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executedelete", NULL, 304, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSingleResult) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_uniqueRow"), PH_NOISY_CC | PH_READONLY);
	if (zephir_is_true(&_0)) {
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "execute", NULL, 0, bindParams, bindTypes);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "execute", NULL, 300, bindParams, bindTypes);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, setBindTypes) {
	...
	if (UNEXPECTED(merge)) {
		...
		if (Z_TYPE_P(&currentBindTypes) == IS_ARRAY) {
			...
			zephir_update_property_zval(this_ptr, ZEND_STRL("_bindTypes"), &_0$$4);
		} else {
...
PHP_METHOD(Phalcon_Mvc_Model_Query, setSharedLock) {
	...
	if (sharedLock) {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_sharedLock"), &__$true);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_sharedLock"), &__$false);
	}
	RETURN_THISW();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, setIntermediate) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_intermediate"), &intermediate);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, cache) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_cacheOptions"), cacheOptions);
	RETURN_THISW();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSql) {
	...
	ZEPHIR_CALL_METHOD(&intermediate, this_ptr, "parse", NULL, 0);
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_type"), PH_NOISY_CC | PH_READONLY);
	if (ZEPHIR_IS_LONG(&_0, 309)) {
		zephir_read_property(&_1$$3, this_ptr, ZEND_STRL("_bindParams"), PH_NOISY_CC | PH_READONLY);
		zephir_read_property(&_2$$3, this_ptr, ZEND_STRL("_bindTypes"), PH_NOISY_CC | PH_READONLY);
		ZVAL_BOOL(&_3$$3, 1);
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_executeselect", NULL, 301, &intermediate, &_1$$3, &_2$$3, &_3$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getReadConnection) {
	...
	ZEND_PARSE_PARAMETERS_START(1, 4)
		...
		Z_PARAM_ARRAY_OR_NULL(bindParams)
		Z_PARAM_ARRAY_OR_NULL(bindTypes)
	ZEND_PARSE_PARAMETERS_END();
