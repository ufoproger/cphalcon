...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Apcu, read) {
	...
	ZEPHIR_CALL_FUNCTION(&data, "apcu_fetch", NULL, 0, &_1);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Apcu, write) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "apcu_store", NULL, 0, &_1, data, &_2);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();

}

zend_object *zephir_init_properties_Phalcon_Mvc_Model_MetaData_Apcu(zend_class_entry *class_type) {
