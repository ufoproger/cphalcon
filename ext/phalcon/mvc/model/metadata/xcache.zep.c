...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Xcache, read) {
	...
	ZEPHIR_CALL_FUNCTION(&data, "xcache_get", NULL, 76, &_1);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Xcache, write) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "xcache_set", NULL, 77, &_1, data, &_2);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();

}

zend_object *zephir_init_properties_Phalcon_Mvc_Model_MetaData_Xcache(zend_class_entry *class_type) {
