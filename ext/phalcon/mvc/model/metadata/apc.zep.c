...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Apc, read) {
	...
	ZEPHIR_CALL_FUNCTION(&data, "apc_fetch", NULL, 74, &_1);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Apc, write) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "apc_store", NULL, 75, &_1, data, &_2);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();

}

zend_object *zephir_init_properties_Phalcon_Mvc_Model_MetaData_Apc(zend_class_entry *class_type) {
