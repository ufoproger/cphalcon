...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, _initialize) {
	...
	zephir_read_property(&_2, this_ptr, ZEND_STRL("_columnMap"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, setStrategy) {
	...
	bool is_null_true = 1;
	ZEND_PARSE_PARAMETERS_START(1, 1)
		Z_PARAM_OBJECT_OF_CLASS(strategy, phalcon_mvc_model_metadata_strategyinterface_ce)
	ZEND_PARSE_PARAMETERS_END();
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_strategy"), strategy);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, getStrategy) {
	...
	ZEPHIR_OBS_VAR(&_0);
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_strategy"), PH_NOISY_CC);
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_update_property_zval(this_ptr, ZEND_STRL("_strategy"), &_1$$3);
	}
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, readMetaData) {
	...
	zephir_read_property(&_1, this_ptr, ZEND_STRL("_metaData"), PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset(&_1, &key))) {
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "_initialize", NULL, 5, model, &key, &source, &schema);
		zephir_check_call_status();
	}
	zephir_read_property(&_2, this_ptr, ZEND_STRL("_metaData"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, readMetaDataIndex) {
	...
	zephir_read_property(&_3, this_ptr, ZEND_STRL("_metaData"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, readColumnMap) {
	...
	ZEPHIR_OBS_VAR(&data);
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_columnMap"), PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_fetch(&data, &_0, &keyName, 0))) {
		...
		zephir_check_call_status();
		zephir_read_property(&_1$$4, this_ptr, ZEND_STRL("_columnMap"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, isEmpty) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_metaData"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, reset) {
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_metaData"), &_0);
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_columnMap"), &_1);
	ZEPHIR_MM_RESTORE();
