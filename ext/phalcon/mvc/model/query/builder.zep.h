...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_model_query_builder_getjoins, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_model_query_builder_gethaving, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_model_query_builder_getoffset, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_model_query_builder_getgroupby, 0, 0, 0)
ZEND_END_ARG_INFO()
