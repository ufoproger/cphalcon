...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_model_query_getbindparams, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_model_query_getbindtypes, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_model_query_getintermediate, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_model_query_getcacheoptions, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_mvc_model_query_getsql, 0, 0, IS_ARRAY, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_model_query_clean, 0, 0, 0)
ZEND_END_ARG_INFO()
