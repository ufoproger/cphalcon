...
PHP_METHOD(Phalcon_Mvc_Model_Criteria, setModelName) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_model"), &modelName);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_Model_Criteria, bind) {
	...
	if (merge) {
		zephir_read_property(&_0$$3, this_ptr, ZEND_STRL("_params"), PH_NOISY_CC | PH_READONLY);
		if (zephir_array_isset_string(&_0$$3, SL("bind"))) {
			zephir_read_property(&_1$$4, this_ptr, ZEND_STRL("_params"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_OBS_VAR(&bind);
...
PHP_METHOD(Phalcon_Mvc_Model_Criteria, where) {
	...
	if (Z_TYPE_P(bindParams) == IS_ARRAY) {
		...
		zephir_read_property(&_1$$3, this_ptr, ZEND_STRL("_params"), PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(bindTypes) == IS_ARRAY) {
		...
		zephir_read_property(&_5$$6, this_ptr, ZEND_STRL("_params"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Criteria, inWhere) {
	...
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_hiddenParamNumber"), &hiddenParam);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_Model_Criteria, limit) {
	...
	if (zephir_is_numeric(offset)) {
		...
		ZEPHIR_CALL_FUNCTION(offset, "abs", NULL, 182, &_2$$4);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_3$$4);
...
PHP_METHOD(Phalcon_Mvc_Model_Criteria, fromInput) {
	...
	if (zephir_fast_count_int(&conditions)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &criteria, "where", NULL, 265, &_18$$16);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &criteria, "bind", NULL, 266, &bind);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_METHOD(NULL, &criteria, "setmodelname", NULL, 254, &modelName);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Criteria, createBuilder) {
	...
	zephir_read_property(&_3, this_ptr, ZEND_STRL("_params"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&builder, &manager, "createbuilder", NULL, 0, &_3);
	zephir_check_call_status();
	zephir_read_property(&_4, this_ptr, ZEND_STRL("_model"), PH_NOISY_CC | PH_READONLY);
