...
PHP_METHOD(Phalcon_Mvc_View, setViewsDir) {
	...
	if (Z_TYPE_P(viewsDir) == IS_STRING) {
		...
		zephir_update_property_zval(this_ptr, ZEND_STRL("_viewsDirs"), viewsDir);
	} else {
		...
		ZEPHIR_INIT_NVAR(&directory);
		ZEPHIR_INIT_NVAR(&position);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_viewsDirs"), &newViewsDir);
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_View, setLayoutsDir) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_layoutsDir"), &layoutsDir);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_View, setPartialsDir) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_partialsDir"), &partialsDir);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_View, setRenderLevel) {
	...
	ZVAL_LONG(&_0, level);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_renderLevel"), &_0);
	RETURN_THISW();
...
PHP_METHOD(Phalcon_Mvc_View, disableLevel) {
	...
	if (Z_TYPE_P(level) == IS_ARRAY) {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_disabledLevels"), level);
	} else {
...
PHP_METHOD(Phalcon_Mvc_View, setMainView) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_mainView"), &viewPath);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_View, setLayout) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_layout"), &layout);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_View, setTemplateBefore) {
	...
	if (Z_TYPE_P(templateBefore) != IS_ARRAY) {
		...
		zephir_update_property_zval(this_ptr, ZEND_STRL("_templatesBefore"), &_0$$3);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_templatesBefore"), templateBefore);
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_View, cleanTemplateBefore) {
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_templatesBefore"), &_0);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_View, setTemplateAfter) {
	...
	if (Z_TYPE_P(templateAfter) != IS_ARRAY) {
		...
		zephir_update_property_zval(this_ptr, ZEND_STRL("_templatesAfter"), &_0$$3);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_templatesAfter"), templateAfter);
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_View, cleanTemplateAfter) {
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_templatesAfter"), &_0);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_View, setVars) {
	...
	if (merge) {
		ZEPHIR_INIT_VAR(&_0$$3);
		zephir_read_property(&_1$$3, this_ptr, ZEND_STRL("_viewParams"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_0$$3, &_1$$3, &params);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_viewParams"), &_0$$3);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_viewParams"), &params);
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_View, getVar) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_viewParams"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_View, start) {
	...
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_content"), &__$null);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_View, _loadTemplateEngines) {
	...
	zephir_read_property(&engines, this_ptr, ZEND_STRL("_engines"), PH_NOISY_CC);
	if (ZEPHIR_IS_FALSE_IDENTICAL(&engines)) {
		...
		zephir_read_property(&registeredEngines, this_ptr, ZEND_STRL("_registeredEngines"), PH_NOISY_CC);
		if (Z_TYPE_P(&registeredEngines) != IS_ARRAY) {
			ZEPHIR_INIT_VAR(&_1$$4);
			object_init_ex(&_1$$4, phalcon_mvc_view_engine_php_ce);
			ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 316, this_ptr, &dependencyInjector);
			zephir_check_call_status();
		...
		zephir_update_property_zval(this_ptr, ZEND_STRL("_engines"), &engines);
	}
...
PHP_METHOD(Phalcon_Mvc_View, _engineRender) {
	...
	zephir_read_property(&basePath, this_ptr, ZEND_STRL("_basePath"), PH_NOISY_CC);
	...
	if (Z_TYPE_P(&_1) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_1), _2)
		{
			...
			ZEPHIR_CALL_METHOD(&_4$$3, this_ptr, "_isabsolutepath", &_5, 317, &viewPath);
			zephir_check_call_status();
			...
			if (Z_TYPE_P(cache) == IS_OBJECT) {
				...
				zephir_read_property(&_6$$6, this_ptr, ZEND_STRL("_renderLevel"), PH_NOISY_CC);
				renderLevel = zephir_get_intval(&_6$$6);
				ZEPHIR_OBS_NVAR(&_7$$6);
				zephir_read_property(&_7$$6, this_ptr, ZEND_STRL("_cacheLevel"), PH_NOISY_CC);
				...
				if (renderLevel >= cacheLevel) {
					...
					if (!(zephir_is_true(&_8$$7))) {
						...
						zephir_read_property(&viewOptions, this_ptr, ZEND_STRL("_options"), PH_NOISY_CC);
						...
						if (Z_TYPE_P(&cachedView) != IS_NULL) {
							zephir_update_property_zval(this_ptr, ZEND_STRL("_content"), &cachedView);
							RETURN_MM_NULL();
						}
					}
				...
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(engines), _15$$3, _16$$3, _13$$3)
				{
					...
					if ((zephir_file_exists(&viewEnginePath) == SUCCESS)) {
						if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
							...
							zephir_update_property_zval(this_ptr, ZEND_STRL("_activeRenderPaths"), &_17$$16);
					...
					zephir_check_call_status();
						...
						if ((zephir_file_exists(&viewEnginePath) == SUCCESS)) {
							if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
								...
								zephir_update_property_zval(this_ptr, ZEND_STRL("_activeRenderPaths"), &_24$$21);
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_31$$24, this_ptr, "_isabsolutepath", &_5, 317, &viewPath);
				zephir_check_call_status();
				...
				if (Z_TYPE_P(cache) == IS_OBJECT) {
					...
					zephir_read_property(&_32$$27, this_ptr, ZEND_STRL("_renderLevel"), PH_NOISY_CC);
					renderLevel = zephir_get_intval(&_32$$27);
					ZEPHIR_OBS_NVAR(&_33$$27);
					zephir_read_property(&_33$$27, this_ptr, ZEND_STRL("_cacheLevel"), PH_NOISY_CC);
					...
					ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(engines), _41$$24, _42$$24, _39$$24)
					{
						...
						if ((zephir_file_exists(&viewEnginePath) == SUCCESS)) {
							if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
								...
								zephir_update_property_zval(this_ptr, ZEND_STRL("_activeRenderPaths"), &_43$$37);
						...
						zephir_check_call_status();
							...
							if ((zephir_file_exists(&viewEnginePath) == SUCCESS)) {
								if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
									...
									zephir_update_property_zval(this_ptr, ZEND_STRL("_activeRenderPaths"), &_50$$42);
	...
	if (notExists == 1) {
		if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
			zephir_update_property_zval(this_ptr, ZEND_STRL("_activeRenderPaths"), &viewEnginePaths);
...
PHP_METHOD(Phalcon_Mvc_View, registerEngines) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_registeredEngines"), &engines);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_View, exists) {
	...
	zephir_read_property(&basePath, this_ptr, ZEND_STRL("_basePath"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(&engines);
	zephir_read_property(&engines, this_ptr, ZEND_STRL("_registeredEngines"), PH_NOISY_CC);
	if (Z_TYPE_P(&engines) != IS_ARRAY) {
		ZEPHIR_INIT_VAR(&_0$$3);
		zephir_create_array(&_0$$3, 1, 0);
...
PHP_METHOD(Phalcon_Mvc_View, render) {
	...
	ZEPHIR_INIT_ZVAL_NREF(_0);
	ZVAL_LONG(&_0, 0);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_currentRenderLevel"), &_0);
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_disabled"), PH_NOISY_CC | PH_READONLY);
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_0)) {
		ZEPHIR_CALL_FUNCTION(&_1$$3, "ob_get_contents", NULL, 115);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, ZEND_STRL("_content"), &_1$$3);
		RETURN_MM_BOOL(0);
	}
	zephir_update_property_zval(this_ptr, ZEND_STRL("_controllerName"), &controllerName);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_actionName"), &actionName);
	if (Z_TYPE_P(params) == IS_ARRAY) {
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "setvars", NULL, 0, params);
		zephir_check_call_status();
	}
	ZEPHIR_OBS_VAR(&layoutsDir);
	zephir_read_property(&layoutsDir, this_ptr, ZEND_STRL("_layoutsDir"), PH_NOISY_CC);
	if (!(zephir_is_true(&layoutsDir))) {
		ZEPHIR_INIT_NVAR(&layoutsDir);
		ZVAL_STRING(&layoutsDir, "layouts/");
	}
	ZEPHIR_OBS_VAR(&layout);
	zephir_read_property(&layout, this_ptr, ZEND_STRL("_layout"), PH_NOISY_CC);
	...
	zephir_read_property(&pickView, this_ptr, ZEND_STRL("_pickView"), PH_NOISY_CC);
	...
	zephir_read_property(&_3, this_ptr, ZEND_STRL("_cacheLevel"), PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property(&_4, this_ptr, ZEND_STRL("_eventsManager"), PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_content"), &_8);
	mustClean = 1;
	silence = 1;
	ZEPHIR_OBS_VAR(&disabledLevels);
	zephir_read_property(&disabledLevels, this_ptr, ZEND_STRL("_disabledLevels"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(&_9);
	zephir_read_property(&_9, this_ptr, ZEND_STRL("_renderLevel"), PH_NOISY_CC);
	...
	if (renderLevel) {
		if (renderLevel >= 1) {
			if (!(zephir_array_isset_long(&disabledLevels, 1))) {
				...
				ZVAL_LONG(&_10$$18, 1);
				zephir_update_property_zval(this_ptr, ZEND_STRL("_currentRenderLevel"), &_10$$18);
				if (silence) {
					ZVAL_BOOL(&_10$$18, 1);
				} else {
					ZVAL_BOOL(&_10$$18, 0);
		...
		if (renderLevel >= 2) {
			if (!(zephir_array_isset_long(&disabledLevels, 2))) {
				...
				ZVAL_LONG(&_12$$20, 2);
				zephir_update_property_zval(this_ptr, ZEND_STRL("_currentRenderLevel"), &_12$$20);
				ZEPHIR_OBS_VAR(&templatesBefore);
				zephir_read_property(&templatesBefore, this_ptr, ZEND_STRL("_templatesBefore"), PH_NOISY_CC);
				silence = 0;
		...
		if (renderLevel >= 3) {
			if (!(zephir_array_isset_long(&disabledLevels, 3))) {
				...
				ZVAL_LONG(&_21$$24, 3);
				zephir_update_property_zval(this_ptr, ZEND_STRL("_currentRenderLevel"), &_21$$24);
		...
		if (renderLevel >= 4) {
			if (!(zephir_array_isset_long(&disabledLevels, 4))) {
				...
				ZVAL_LONG(&_24$$26, 4);
				zephir_update_property_zval(this_ptr, ZEND_STRL("_currentRenderLevel"), &_24$$26);
				ZEPHIR_OBS_VAR(&templatesAfter);
				zephir_read_property(&templatesAfter, this_ptr, ZEND_STRL("_templatesAfter"), PH_NOISY_CC);
				silence = 0;
		...
		if (renderLevel >= 5) {
			if (!(zephir_array_isset_long(&disabledLevels, 5))) {
				...
				ZVAL_LONG(&_33$$30, 5);
				zephir_update_property_zval(this_ptr, ZEND_STRL("_currentRenderLevel"), &_33$$30);
				zephir_read_property(&_33$$30, this_ptr, ZEND_STRL("_mainView"), PH_NOISY_CC | PH_READONLY);
				if (silence) {
					ZVAL_BOOL(&_34$$30, 1);
				} else {
					ZVAL_BOOL(&_34$$30, 0);
		...
		ZVAL_LONG(&_36$$16, 0);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_currentRenderLevel"), &_36$$16);
		if (Z_TYPE_P(&cache) == IS_OBJECT) {
...
PHP_METHOD(Phalcon_Mvc_View, pick) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_pickView"), &pickView);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_View, partial) {
	...
	zephir_check_call_status();
	zephir_read_property(&_3, this_ptr, ZEND_STRL("_partialsDir"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_4);
...
PHP_METHOD(Phalcon_Mvc_View, isCaching) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_cacheLevel"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_View, getCache) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_cache"), PH_NOISY_CC | PH_READONLY);
	_1 = !zephir_is_true(&_0);
	if (!(_1)) {
		ZEPHIR_OBS_VAR(&_2);
		zephir_read_property(&_2, this_ptr, ZEND_STRL("_cache"), PH_NOISY_CC);
		_1 = Z_TYPE_P(&_2) != IS_OBJECT;
	}
	if (_1) {
		ZEPHIR_CALL_METHOD(&_3$$3, this_ptr, "_createcache", NULL, 0);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, ZEND_STRL("_cache"), &_3$$3);
	}
...
PHP_METHOD(Phalcon_Mvc_View, cache) {
	...
	if (Z_TYPE_P(options) == IS_ARRAY) {
		...
		if (zephir_array_isset_string_fetch(&cacheLevel, &cacheOptions, SL("level"), 1)) {
			zephir_update_property_zval(this_ptr, ZEND_STRL("_cacheLevel"), &cacheLevel);
		} else {
			ZEPHIR_INIT_ZVAL_NREF(_4$$9);
			ZVAL_LONG(&_4$$9, 5);
			zephir_update_property_zval(this_ptr, ZEND_STRL("_cacheLevel"), &_4$$9);
		}
		zephir_array_update_string(&viewOptions, SL("cache"), &cacheOptions, PH_COPY | PH_SEPARATE);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_options"), &viewOptions);
	} else {
		if (zephir_is_true(options)) {
			ZEPHIR_INIT_ZVAL_NREF(_5$$11);
			ZVAL_LONG(&_5$$11, 5);
			zephir_update_property_zval(this_ptr, ZEND_STRL("_cacheLevel"), &_5$$11);
		} else {
			ZEPHIR_INIT_ZVAL_NREF(_6$$12);
			ZVAL_LONG(&_6$$12, 0);
			zephir_update_property_zval(this_ptr, ZEND_STRL("_cacheLevel"), &_6$$12);
		}
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_View, getActiveRenderPath) {
	...
	zephir_read_property(&activeRenderPath, this_ptr, ZEND_STRL("_activeRenderPaths"), PH_NOISY_CC);
	if (viewsDirsCount == 1) {
...
PHP_METHOD(Phalcon_Mvc_View, disable) {
	...
	if (1) {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_disabled"), &__$true);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_disabled"), &__$false);
	}
	RETURN_THISW();
...
PHP_METHOD(Phalcon_Mvc_View, reset) {
	...
	if (0) {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_engines"), &__$true);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_engines"), &__$false);
	}
	zephir_update_property_zval(this_ptr, ZEND_STRL("_cache"), &__$null);
	ZEPHIR_INIT_ZVAL_NREF(_0);
	ZVAL_LONG(&_0, 5);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_renderLevel"), &_0);
	ZEPHIR_INIT_ZVAL_NREF(_0);
	ZVAL_LONG(&_0, 0);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_cacheLevel"), &_0);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_content"), &__$null);
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_templatesBefore"), &_1);
	ZEPHIR_INIT_VAR(&_2);
	array_init(&_2);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_templatesAfter"), &_2);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_View, getViewsDirs) {
	...
	ZEPHIR_OBS_VAR(&_0);
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_viewsDirs"), PH_NOISY_CC);
	if (Z_TYPE_P(&_0) == IS_STRING) {
		zephir_create_array(return_value, 1, 0);
		ZEPHIR_OBS_VAR(&_1$$3);
		zephir_read_property(&_1$$3, this_ptr, ZEND_STRL("_viewsDirs"), PH_NOISY_CC);
...
zend_object *zephir_init_properties_Phalcon_Mvc_View(zend_class_entry *class_type) {
	...
	
	{
		...
		zephir_read_property_ex(&_0, this_ptr, ZEND_STRL("_templatesAfter"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_0) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_1$$3);
			array_init(&_1$$3);
			zephir_update_property_zval_ex(this_ptr, ZEND_STRL("_templatesAfter"), &_1$$3);
		}
		zephir_read_property_ex(&_2, this_ptr, ZEND_STRL("_templatesBefore"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_2) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_3$$4);
			array_init(&_3$$4);
			zephir_update_property_zval_ex(this_ptr, ZEND_STRL("_templatesBefore"), &_3$$4);
		}
		zephir_read_property_ex(&_4, this_ptr, ZEND_STRL("_viewsDirs"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_4) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_5$$5);
			array_init(&_5$$5);
			zephir_update_property_zval_ex(this_ptr, ZEND_STRL("_viewsDirs"), &_5$$5);
		}
		zephir_read_property_ex(&_6, this_ptr, ZEND_STRL("_viewParams"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_6) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_7$$6);
			array_init(&_7$$6);
			zephir_update_property_zval_ex(this_ptr, ZEND_STRL("_viewParams"), &_7$$6);
		}
		ZEPHIR_MM_RESTORE();
