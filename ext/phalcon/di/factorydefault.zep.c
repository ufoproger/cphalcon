...
PHP_METHOD(Phalcon_Di_FactoryDefault, __construct) {
	...
	ZVAL_BOOL(&_5, 1);
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 56, &_3, &_4, &_5);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 56, &_3, &_4);
	zephir_check_call_status();
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_services"), &_1);
	ZEPHIR_MM_RESTORE();
