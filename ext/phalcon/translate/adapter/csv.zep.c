...
PHP_METHOD(Phalcon_Translate_Adapter_Csv, __construct) {
	...
	ZEPHIR_INIT_VAR(&_4);
	ZVAL_STRING(&_4, "\"");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "_load", NULL, 378, &_1, &_2, &_3, &_4);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Translate_Adapter_Csv, _load) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "rb");
	ZEPHIR_CALL_FUNCTION(&fileHandler, "fopen", NULL, 229, file, &_0);
	zephir_check_call_status();
	...
	while (1) {
		ZEPHIR_CALL_FUNCTION(&data, "fgetcsv", &_3, 379, &fileHandler, length, delimiter, enclosure);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Translate_Adapter_Csv, query) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_translate"), PH_NOISY_CC | PH_READONLY);
...
zend_object *zephir_init_properties_Phalcon_Translate_Adapter_Csv(zend_class_entry *class_type) {
	...
	
	{
		...
		zephir_read_property_ex(&_0, this_ptr, ZEND_STRL("_translate"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_0) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_1$$3);
			array_init(&_1$$3);
			zephir_update_property_zval_ex(this_ptr, ZEND_STRL("_translate"), &_1$$3);
		}
		ZEPHIR_MM_RESTORE();
