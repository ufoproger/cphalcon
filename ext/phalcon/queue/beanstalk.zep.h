...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_queue_beanstalk_connect, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_queue_beanstalk_stats, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_queue_beanstalk_listtubes, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_queue_beanstalk_listtubeused, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_queue_beanstalk_listtubeswatched, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_queue_beanstalk_peekready, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_queue_beanstalk_peekburied, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_queue_beanstalk_peekdelayed, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_queue_beanstalk_method_entry) {
	...
	PHP_ME(Phalcon_Queue_Beanstalk, connect, arginfo_phalcon_queue_beanstalk_connect, ZEND_ACC_PUBLIC)
#else
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Queue_Beanstalk, stats, arginfo_phalcon_queue_beanstalk_stats, ZEND_ACC_PUBLIC)
#else
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Queue_Beanstalk, listTubes, arginfo_phalcon_queue_beanstalk_listtubes, ZEND_ACC_PUBLIC)
#else
	PHP_ME(Phalcon_Queue_Beanstalk, listTubes, NULL, ZEND_ACC_PUBLIC)
#endif
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Queue_Beanstalk, listTubeUsed, arginfo_phalcon_queue_beanstalk_listtubeused, ZEND_ACC_PUBLIC)
#else
	PHP_ME(Phalcon_Queue_Beanstalk, listTubeUsed, NULL, ZEND_ACC_PUBLIC)
#endif
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Queue_Beanstalk, listTubesWatched, arginfo_phalcon_queue_beanstalk_listtubeswatched, ZEND_ACC_PUBLIC)
#else
	PHP_ME(Phalcon_Queue_Beanstalk, listTubesWatched, NULL, ZEND_ACC_PUBLIC)
#endif
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Queue_Beanstalk, peekReady, arginfo_phalcon_queue_beanstalk_peekready, ZEND_ACC_PUBLIC)
#else
	PHP_ME(Phalcon_Queue_Beanstalk, peekReady, NULL, ZEND_ACC_PUBLIC)
#endif
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Queue_Beanstalk, peekBuried, arginfo_phalcon_queue_beanstalk_peekburied, ZEND_ACC_PUBLIC)
#else
	PHP_ME(Phalcon_Queue_Beanstalk, peekBuried, NULL, ZEND_ACC_PUBLIC)
#endif
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Queue_Beanstalk, peekDelayed, arginfo_phalcon_queue_beanstalk_peekdelayed, ZEND_ACC_PUBLIC)
#else
