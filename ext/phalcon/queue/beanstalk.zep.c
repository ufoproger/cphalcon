...
PHP_METHOD(Phalcon_Queue_Beanstalk, connect) {
	...
	if (zephir_is_true(&_0)) {
		...
		ZEPHIR_CALL_FUNCTION(&connection, "pfsockopen", NULL, 336, &_1$$4, &_2$$4, &_3$$4, &_4$$4);
		ZEPHIR_UNREF(&_3$$4);
		ZEPHIR_UNREF(&_4$$4);
		zephir_check_call_status();
	} else {
		...
		ZEPHIR_CALL_FUNCTION(&connection, "fsockopen", NULL, 337, &_5$$5, &_6$$5, &_7$$5, &_8$$5);
		ZEPHIR_UNREF(&_7$$5);
		ZEPHIR_UNREF(&_8$$5);
		zephir_check_call_status();
	}
	...
	ZVAL_LONG(&_9, -1);
	ZEPHIR_CALL_FUNCTION(NULL, "stream_set_timeout", NULL, 338, &connection, &_9, &__$null);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, put) {
	...
	ZEPHIR_CALL_FUNCTION(&serialized, "serialize", NULL, 54, data);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&response, this_ptr, "readstatus", NULL, 339);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, reserve) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_4, "unserialize", NULL, 55, &_2);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 340, this_ptr, &_1, &_4);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, stats) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "write", NULL, 0, &_0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&response, this_ptr, "readyaml", NULL, 341);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, peekReady) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_5, "unserialize", NULL, 55, &_3);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 340, this_ptr, &_2, &_5);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, peekDelayed) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_6, "unserialize", NULL, 55, &_4);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 340, this_ptr, &_3, &_6);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, readYaml) {
	...
	if (zephir_fast_count_int(&response) > 1) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&data, "yaml_parse", NULL, 342, &response);
		zephir_check_call_status();
	} else {
...
PHP_METHOD(Phalcon_Queue_Beanstalk, read) {
	...
	if (length) {
		...
		ZEPHIR_CALL_FUNCTION(&_1$$5, "stream_get_line", NULL, 343, &connection, &_0$$5);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_2$$5);
		ZVAL_STRING(&_2$$5, "\r\n");
		ZEPHIR_INIT_VAR(&data);
		zephir_fast_trim(&data, &_1$$5, &_2$$5, ZEPHIR_TRIM_RIGHT);
		ZEPHIR_CALL_FUNCTION(&_3$$5, "stream_get_meta_data", NULL, 344, &connection);
		zephir_check_call_status();
		...
		ZVAL_STRING(&_6$$8, "\r\n");
		ZEPHIR_CALL_FUNCTION(&data, "stream_get_line", NULL, 343, &connection, &_5$$8, &_6$$8);
		zephir_check_call_status();
	}
...
PHP_METHOD(Phalcon_Queue_Beanstalk, write) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("fwrite", NULL, 345, &connection, &packet, &_1);
	zephir_check_call_status();
	RETURN_MM();
