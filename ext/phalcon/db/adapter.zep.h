...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_db_adapter_getdialecttype, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_db_adapter_gettype, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_db_adapter_getconnectionid, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_db_adapter_getsqlbindtypes, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_db_adapter_zephir_init_properties_phalcon_db_adapter, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEPHIR_INIT_FUNCS(phalcon_db_adapter_method_entry) {
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Db_Adapter, getDialectType, arginfo_phalcon_db_adapter_getdialecttype, ZEND_ACC_PUBLIC)
#else
	PHP_ME(Phalcon_Db_Adapter, getDialectType, NULL, ZEND_ACC_PUBLIC)
#endif
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Db_Adapter, getType, arginfo_phalcon_db_adapter_gettype, ZEND_ACC_PUBLIC)
#else
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Db_Adapter, getConnectionId, arginfo_phalcon_db_adapter_getconnectionid, ZEND_ACC_PUBLIC)
#else
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Db_Adapter, getSQLBindTypes, arginfo_phalcon_db_adapter_getsqlbindtypes, ZEND_ACC_PUBLIC)
#else
