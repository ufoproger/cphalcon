...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_db_adapter_pdo_geterrorinfo, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_db_adapter_pdo_method_entry) {
	...
	PHP_ME(Phalcon_Db_Adapter_Pdo, getErrorInfo, arginfo_phalcon_db_adapter_pdo_geterrorinfo, ZEND_ACC_PUBLIC)
#else
