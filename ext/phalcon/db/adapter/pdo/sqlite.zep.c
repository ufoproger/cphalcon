	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _4)
		{
			...
			if (_35$$3) {
				...
				ZVAL_STRING(&_39$$27, "");
				ZEPHIR_CALL_FUNCTION(&_40$$27, "preg_replace", &_41, 28, &_38$$27, &_39$$27, &_37$$27);
				zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(NULL, &_32$$3, "__construct", &_42, 141, &columnName, &definition);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (_72$$28) {
					...
					ZVAL_STRING(&_76$$52, "");
					ZEPHIR_CALL_FUNCTION(&_77$$52, "preg_replace", &_41, 28, &_75$$52, &_76$$52, &_74$$52);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_70$$28, "__construct", &_42, 141, &columnName, &definition);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Sqlite, describeIndexes) {
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _4)
		{
			...
			zephir_read_property(&_10$$3, this_ptr, ZEND_STRL("_dialect"), PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property(&_12$$3, this_ptr, ZEND_STRL("_dialect"), PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_read_property(&_30$$13, this_ptr, ZEND_STRL("_dialect"), PH_NOISY_CC | PH_READONLY);
				...
				ZEPHIR_INIT_NVAR(&describeIndex);
				zephir_array_update_multi(&indexes, &columns, SL("zs"), 3, &keyName, SL("columns"));
				zephir_read_property(&_32$$13, this_ptr, ZEND_STRL("_dialect"), PH_NOISY_CC | PH_READONLY);
