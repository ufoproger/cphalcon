			...
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _12$$41)
					{
						...
						ZVAL_STRING(&_14$$42, "\"");
						ZEPHIR_CALL_FUNCTION(&_15$$42, "addcslashes", &_16, 142, &value$$41, &_14$$42);
						zephir_check_call_status();
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							ZVAL_STRING(&_18$$43, "\"");
							ZEPHIR_CALL_FUNCTION(&_19$$43, "addcslashes", &_16, 142, &value$$41, &_18$$43);
							zephir_check_call_status();
				...
				ZVAL_STRING(&_25$$44, "\"");
				ZEPHIR_CALL_FUNCTION(&_26$$44, "addcslashes", &_16, 142, &typeValues, &_25$$44);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Sqlite, addColumn) {
	...
	if (zephir_is_true(&_4)) {
		...
		if (zephir_memnstr_str(&_5$$3, SL("CURRENT_TIMESTAMP"), "phalcon/db/dialect/sqlite.zep", 203)) {
			...
			ZVAL_STRING(&_6$$5, "\"");
			ZEPHIR_CALL_FUNCTION(&_7$$5, "addcslashes", NULL, 142, &defaultValue, &_6$$5);
			zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _0)
		{
			...
			if (zephir_is_true(&_9$$7)) {
				...
				if (zephir_memnstr_str(&_10$$10, SL("CURRENT_TIMESTAMP"), "phalcon/db/dialect/sqlite.zep", 360)) {
					...
					ZVAL_STRING(&_11$$12, "\"");
					ZEPHIR_CALL_FUNCTION(&_12$$12, "addcslashes", &_13, 142, &defaultValue, &_11$$12);
					zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (zephir_is_true(&_22$$14)) {
					...
					if (zephir_memnstr_str(&_23$$17, SL("CURRENT_TIMESTAMP"), "phalcon/db/dialect/sqlite.zep", 360)) {
						...
						ZVAL_STRING(&_24$$19, "\"");
						ZEPHIR_CALL_FUNCTION(&_25$$19, "addcslashes", &_13, 142, &defaultValue, &_24$$19);
						zephir_check_call_status();
		...
		if (Z_TYPE_P(&indexes) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&indexes), _28$$21)
			{
				...
				if (_30$$22) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_33$$23, this_ptr, "getcolumnlist", &_35, 43, &_34$$23);
					zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_37$$24, this_ptr, "getcolumnlist", &_35, 43, &_38$$24);
					zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (_40$$25) {
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_43$$26, this_ptr, "getcolumnlist", &_35, 43, &_44$$26);
						zephir_check_call_status();
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_46$$27, this_ptr, "getcolumnlist", &_35, 43, &_47$$27);
						zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&references, &definition, SL("references"), 0)) {
		...
		if (Z_TYPE_P(&references) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&references), _49$$28)
			{
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_52$$29, this_ptr, "getcolumnlist", &_35, 43, &_53$$29);
				zephir_check_call_status();
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_55$$29, this_ptr, "getcolumnlist", &_35, 43, &_56$$29);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_60$$32, this_ptr, "getcolumnlist", &_35, 43, &_61$$32);
					zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_63$$32, this_ptr, "getcolumnlist", &_35, 43, &_64$$32);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&referenceSql);
...
PHP_METHOD(Phalcon_Db_Dialect_Sqlite, listIndexesSql) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "escape", NULL, 42, &table);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	...
	if (!(Z_TYPE_P(&keyName) == IS_UNDEF) && Z_STRLEN_P(&keyName)) {
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "escape", NULL, 42, &keyName);
		zephir_check_call_status();
