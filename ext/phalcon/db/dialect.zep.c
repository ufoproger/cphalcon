...
PHP_METHOD(Phalcon_Db_Dialect, escapeSchema) {
	...
	if (ZEPHIR_IS_STRING(&escapeChar, "")) {
		ZEPHIR_OBS_VAR(&_0$$4);
		zephir_read_property(&_0$$4, this_ptr, ZEND_STRL("_escapeChar"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Db_Dialect, getColumnList) {
	...
	if (Z_TYPE_P(&columnList) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columnList), _0)
		{
			...
			ZVAL_COPY(&column, _0);
			ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "getsqlcolumn", &_3, 29, &column, &escapeChar, bindCounts);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "getsqlcolumn", &_3, 29, &column, &escapeChar, bindCounts);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpression) {
	...
	do {
		if (ZEPHIR_IS_STRING(&type, "scalar")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionscalar", NULL, 30, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "object")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionobject", NULL, 31, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "qualified")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionqualified", NULL, 32, &expression, &escapeChar);
			zephir_check_call_status();
			RETURN_MM();
		}
		...
		if (ZEPHIR_IS_STRING(&type, "binary-op")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionbinaryoperations", NULL, 33, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "unary-op")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionunaryoperations", NULL, 34, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "parentheses")) {
			...
			ZEPHIR_CALL_METHOD(&_7$$14, this_ptr, "getsqlexpression", NULL, 35, &_8$$14, &escapeChar, bindCounts);
			zephir_check_call_status();
			ZEPHIR_CONCAT_SVS(return_value, "(", &_7$$14, ")");
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "functionCall")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionfunctioncall", NULL, 36, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "list")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionlist", NULL, 37, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "all")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionall", NULL, 38, &expression, &escapeChar);
			zephir_check_call_status();
			RETURN_MM();
		}
		...
		if (ZEPHIR_IS_STRING(&type, "cast")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressioncastvalue", NULL, 39, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "convert")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionconvertvalue", NULL, 40, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "case")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressioncase", NULL, 41, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
	} while(0);
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlTable) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "escape", NULL, 42, table, &escapeChar);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Db_Dialect, select) {
	...
	zephir_read_property(&escapeChar, this_ptr, ZEND_STRL("_escapeChar"), PH_NOISY_CC);
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getcolumnlist", NULL, 43, &columns, &escapeChar, &bindCounts);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	ZEPHIR_CONCAT_SV(&_1, " ", &_0);
	zephir_concat_self(&sql, &_1);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "getsqlexpressionfrom", NULL, 44, &tables, &escapeChar);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_3);
	...
	if (_4) {
		...
		ZEPHIR_CALL_METHOD(&_5$$9, this_ptr, "getsqlexpressionjoins", NULL, 45, &_6$$9, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_8) {
		ZEPHIR_CALL_METHOD(&_9$$10, this_ptr, "getsqlexpressionwhere", NULL, 46, &where, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_11) {
		ZEPHIR_CALL_METHOD(&_12$$11, this_ptr, "getsqlexpressiongroupby", NULL, 47, &groupBy, &escapeChar);
		zephir_check_call_status();
	...
	if (_14) {
		ZEPHIR_CALL_METHOD(&_15$$12, this_ptr, "getsqlexpressionhaving", NULL, 48, &having, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_17) {
		ZEPHIR_CALL_METHOD(&_18$$13, this_ptr, "getsqlexpressionorderby", NULL, 49, &orderBy, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_20) {
		...
		ZEPHIR_CALL_METHOD(&sql, this_ptr, "getsqlexpressionlimit", NULL, 50, &_21$$14, &escapeChar, &bindCounts);
		zephir_check_call_status();
	}
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionScalar) {
	...
	if (zephir_array_isset_string(&expression, SL("column"))) {
		...
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlcolumn", NULL, 29, &_0$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_OBS_VAR(&value);
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionBinaryOperations) {
	...
	ZEPHIR_CALL_METHOD(&right, this_ptr, "getsqlexpression", NULL, 35, &_1, &escapeChar, bindCounts);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionUnaryOperations) {
	...
	if (zephir_array_isset_string_fetch(&right, &expression, SL("right"), 0)) {
		...
		ZEPHIR_CALL_METHOD(&_3$$4, this_ptr, "getsqlexpression", NULL, 35, &right, &escapeChar, bindCounts);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionFunctionCall) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_customFunctions"), PH_NOISY_CC | PH_READONLY);
	...
	if (_1) {
		...
		if (Z_TYPE_P(&values) == IS_ARRAY) {
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_6$$6, this_ptr, "getsqlexpression", &_5, 35, &item, &escapeChar, bindCounts);
					zephir_check_call_status();
	...
	if (Z_TYPE_P(&_2) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_2), _3)
		{
			...
			if (ZEPHIR_IS_STRING(&_5$$3, "when")) {
				...
				ZEPHIR_CALL_METHOD(&_6$$4, this_ptr, "getsqlexpression", NULL, 35, &_7$$4, &escapeChar, bindCounts);
				zephir_check_call_status();
				zephir_array_fetch_string(&_9$$4, &whenClause, SL("then"), PH_NOISY | PH_READONLY, "phalcon/db/dialect.zep", 733);
				ZEPHIR_CALL_METHOD(&_8$$4, this_ptr, "getsqlexpression", NULL, 35, &_9$$4, &escapeChar, bindCounts);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_11$$5, this_ptr, "getsqlexpression", NULL, 35, &_12$$5, &escapeChar, bindCounts);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (ZEPHIR_IS_STRING(&_14$$6, "when")) {
					...
					ZEPHIR_CALL_METHOD(&_15$$7, this_ptr, "getsqlexpression", NULL, 35, &_16$$7, &escapeChar, bindCounts);
					zephir_check_call_status();
					zephir_array_fetch_string(&_18$$7, &whenClause, SL("then"), PH_NOISY | PH_READONLY, "phalcon/db/dialect.zep", 733);
					ZEPHIR_CALL_METHOD(&_17$$7, this_ptr, "getsqlexpression", NULL, 35, &_18$$7, &escapeChar, bindCounts);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_20$$8, this_ptr, "getsqlexpression", NULL, 35, &_21$$8, &escapeChar, bindCounts);
					zephir_check_call_status();
	...
	if (Z_TYPE_P(expression) == IS_ARRAY) {
		...
		if (Z_TYPE_P(expression) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expression), _0$$3)
			{
				...
				ZEPHIR_CALL_METHOD(&_2$$4, this_ptr, "getsqltable", &_3, 51, &table, &escapeChar);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_4$$5, this_ptr, "getsqltable", &_3, 51, &table, &escapeChar);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionJoins) {
	...
	if (Z_TYPE_P(expression) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expression), _0)
		{
				...
				if (!(zephir_array_isset_long(&joinConditionsArray, 0))) {
					...
					if (Z_TYPE_P(&joinConditionsArray) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&joinConditionsArray), _4$$6)
						{
							...
							ZEPHIR_CALL_METHOD(&_6$$7, this_ptr, "getsqlexpression", &_3, 35, &condition, &escapeChar, bindCounts);
							zephir_check_call_status();
						...
						while (1) {
							...
							zephir_check_call_status();
								ZEPHIR_CALL_METHOD(&_7$$8, this_ptr, "getsqlexpression", &_3, 35, &condition, &escapeChar, bindCounts);
								zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&joinTable, this_ptr, "getsqltable", &_11, 51, &_10$$3, &escapeChar);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (_13$$11) {
					if (!(zephir_array_isset_long(&joinConditionsArray, 0))) {
						ZEPHIR_CALL_METHOD(&joinCondition, this_ptr, "getsqlexpression", &_3, 35, &joinConditionsArray, &escapeChar, bindCounts);
						zephir_check_call_status();
					} else {
						ZEPHIR_INIT_NVAR(&joinCondition);
						array_init(&joinCondition);
						...
						if (Z_TYPE_P(&joinConditionsArray) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&joinConditionsArray), _14$$14)
							{
								...
								ZEPHIR_CALL_METHOD(&_16$$15, this_ptr, "getsqlexpression", &_3, 35, &condition, &escapeChar, bindCounts);
								zephir_check_call_status();
							...
							while (1) {
								...
								ZEPHIR_CALL_METHOD(&condition, &joinConditionsArray, "current", NULL, 0);
								zephir_check_call_status();
									ZEPHIR_CALL_METHOD(&_17$$16, this_ptr, "getsqlexpression", &_3, 35, &condition, &escapeChar, bindCounts);
									zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&joinTable, this_ptr, "getsqltable", &_11, 51, &_20$$11, &escapeChar);
				zephir_check_call_status();
		...
		if (Z_TYPE_P(expression) == IS_ARRAY) {
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_4$$6, this_ptr, "getsqlexpression", &_3, 35, &field, &escapeChar, bindCounts);
					zephir_check_call_status();
		...
		if (Z_TYPE_P(expression) == IS_ARRAY) {
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&fieldSql, this_ptr, "getsqlexpression", &_3, 35, &_6$$7, &escapeChar, bindCounts);
					zephir_check_call_status();
					ZEPHIR_OBS_NVAR(&type);
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionLimit) {
	...
	if (Z_TYPE_P(&value) == IS_ARRAY) {
		...
		if (_2$$4) {
			ZEPHIR_CALL_METHOD(&_3$$7, this_ptr, "getsqlexpression", NULL, 35, &offset, &escapeChar, bindCounts);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, prepareColumnAlias) {
	...
	if (!ZEPHIR_IS_STRING(&alias, "")) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "escape", NULL, 42, &alias, &escapeChar);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, prepareTable) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "escape", NULL, 42, &table, &escapeChar);
	zephir_check_call_status();
	zephir_get_strval(&table, &_0);
	if (!ZEPHIR_IS_STRING(&schema, "")) {
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "escapeschema", NULL, 52, &schema, &escapeChar);
		zephir_check_call_status();
	...
	if (!ZEPHIR_IS_STRING(&alias, "")) {
		ZEPHIR_CALL_METHOD(&_3$$4, this_ptr, "escape", NULL, 42, &alias, &escapeChar);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, prepareQualified) {
	...
	if (!ZEPHIR_IS_STRING(&domain, "")) {
		...
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "escape", NULL, 42, &_0$$3, &escapeChar);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "escape", NULL, 42, &column, &escapeChar);
	zephir_check_call_status();
	RETURN_MM();
