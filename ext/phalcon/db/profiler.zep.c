...
PHP_METHOD(Phalcon_Db_Profiler, startProfile) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_activeProfile"), &activeProfile);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Db_Profiler, stopProfile) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_activeProfile"), PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_totalSeconds"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_1);
	zephir_sub_function(&_1, &finalTime, &initialTime);
	ZEPHIR_INIT_VAR(&_2);
	zephir_add_function(&_2, &_0, &_1);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_totalSeconds"), &_2);
...
PHP_METHOD(Phalcon_Db_Profiler, getNumberTotalStatements) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_allProfiles"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Db_Profiler, reset) {
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_allProfiles"), &_0);
	RETURN_THIS();
