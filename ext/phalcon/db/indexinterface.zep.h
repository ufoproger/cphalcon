...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_db_indexinterface_getname, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_db_indexinterface_getcolumns, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_db_indexinterface_gettype, 0, 0, 0)
ZEND_END_ARG_INFO()
