...
PHP_METHOD(Phalcon_Db_Adapter, __construct) {
	...
	if (!(zephir_array_isset_string_fetch(&dialectClass, &descriptor, SL("dialectClass"), 0))) {
		...
		zephir_read_property(&_2$$3, this_ptr, ZEND_STRL("_dialectType"), PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&dialectClass) == IS_STRING) {
		...
		zephir_update_property_zval(this_ptr, ZEND_STRL("_dialect"), &_3$$4);
	} else {
...
PHP_METHOD(Phalcon_Db_Adapter, setDialect) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_dialect"), dialect);
...
PHP_METHOD(Phalcon_Db_Adapter, escapeIdentifier) {
	...
	if (Z_TYPE_P(identifier) == IS_ARRAY) {
		zephir_read_property(&_0$$3, this_ptr, ZEND_STRL("_dialect"), PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		zephir_read_property(&_3$$3, this_ptr, ZEND_STRL("_dialect"), PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property(&_6, this_ptr, ZEND_STRL("_dialect"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Db_Adapter, createSavepoint) {
	...
	zephir_read_property(&dialect, this_ptr, ZEND_STRL("_dialect"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Db_Adapter, setNestedTransactionsWithSavepoints) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_transactionLevel"), PH_NOISY_CC | PH_READONLY);
	...
	if (nestedTransactionsWithSavepoints) {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_transactionsWithSavepoints"), &__$true);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_transactionsWithSavepoints"), &__$false);
	}
	RETURN_THIS();
...
zend_object *zephir_init_properties_Phalcon_Db_Adapter(zend_class_entry *class_type) {
	...
	
	{
		...
		zephir_read_property_ex(&_0, this_ptr, ZEND_STRL("_descriptor"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_0) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_1$$3);
			array_init(&_1$$3);
			zephir_update_property_zval_ex(this_ptr, ZEND_STRL("_descriptor"), &_1$$3);
		}
		ZEPHIR_MM_RESTORE();
