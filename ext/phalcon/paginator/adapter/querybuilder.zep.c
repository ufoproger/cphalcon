...
PHP_METHOD(Phalcon_Paginator_Adapter_QueryBuilder, setQueryBuilder) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_builder"), builder);
	RETURN_THISW();
...
PHP_METHOD(Phalcon_Paginator_Adapter_QueryBuilder, paginate) {
	...
	zephir_read_property(&originalBuilder, this_ptr, ZEND_STRL("_builder"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(&columns);
	...
	ZEPHIR_OBS_VAR(&limit);
	zephir_read_property(&limit, this_ptr, ZEND_STRL("_limitRows"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(&_0);
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_page"), PH_NOISY_CC);
	...
	if (hasHaving) {
		...
		zephir_read_property(&modelClass, &builder, ZEND_STRL("_models"), PH_NOISY_CC);
		if (Z_TYPE_P(&modelClass) == IS_ARRAY) {
			ZEPHIR_CALL_FUNCTION(&_11$$17, "array_values", NULL, 190, &modelClass);
			zephir_check_call_status();
		...
		zephir_check_call_status();
		if (zephir_is_true(&row)) {
			zephir_read_property(&_22$$18, &row, ZEND_STRL("rowcount"), PH_NOISY_CC | PH_READONLY);
	...
	ZVAL_LONG(&_10, 1);
	zephir_update_property_zval(&page, ZEND_STRL("first"), &_10);
	ZEPHIR_INIT_ZVAL_NREF(_10);
	ZVAL_LONG(&_10, previous);
	zephir_update_property_zval(&page, ZEND_STRL("before"), &_10);
	ZEPHIR_INIT_ZVAL_NREF(_10);
	ZVAL_LONG(&_10, previous);
	zephir_update_property_zval(&page, ZEND_STRL("previous"), &_10);
	ZEPHIR_INIT_ZVAL_NREF(_10);
	ZVAL_LONG(&_10, numberPage);
	zephir_update_property_zval(&page, ZEND_STRL("current"), &_10);
	zephir_update_property_zval(&page, ZEND_STRL("last"), &totalPages);
	zephir_update_property_zval(&page, ZEND_STRL("next"), &next);
	zephir_update_property_zval(&page, ZEND_STRL("total_pages"), &totalPages);
	zephir_update_property_zval(&page, ZEND_STRL("total_items"), &rowcount);
	zephir_read_property(&_10, this_ptr, ZEND_STRL("_limitRows"), PH_NOISY_CC | PH_READONLY);
	zephir_update_property_zval(&page, ZEND_STRL("limit"), &_10);
	RETURN_CCTOR(&page);
