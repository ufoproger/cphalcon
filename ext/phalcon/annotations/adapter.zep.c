...
PHP_METHOD(Phalcon_Annotations_Adapter, setReader) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_reader"), reader);
...
PHP_METHOD(Phalcon_Annotations_Adapter, getReader) {
	...
	ZEPHIR_OBS_VAR(&_0);
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_reader"), PH_NOISY_CC);
	if (Z_TYPE_P(&_0) != IS_OBJECT) {
		...
		zephir_update_property_zval(this_ptr, ZEND_STRL("_reader"), &_1$$3);
	}
