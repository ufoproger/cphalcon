...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_validation_message_getfield, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_validation_message_method_entry) {
	...
	PHP_ME(Phalcon_Validation_Message, getField, arginfo_phalcon_validation_message_getfield, ZEND_ACC_PUBLIC)
#else
