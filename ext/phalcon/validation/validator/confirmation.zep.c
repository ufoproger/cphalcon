...
PHP_METHOD(Phalcon_Validation_Validator_Confirmation, validate) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "compare", NULL, 387, &value, &valueWith);
	zephir_check_call_status();
	if (!(zephir_is_true(&_2))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_3$$4, "__construct", NULL, 384, &_5$$4, &field, &_6$$4, &code);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Validation_Validator_Confirmation, compare) {
	...
	if (zephir_is_true(&_0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_4$$3, "mb_strtolower", NULL, 184, &a, &_3$$3);
		zephir_check_call_status();
		zephir_get_strval(&a, &_4$$3);
		ZEPHIR_INIT_NVAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "utf-8");
		ZEPHIR_CALL_FUNCTION(&_5$$3, "mb_strtolower", NULL, 184, &b, &_3$$3);
		zephir_check_call_status();
