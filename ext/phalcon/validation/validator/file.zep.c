...
PHP_METHOD(Phalcon_Validation_Validator_File, validate) {
	...
	if (_5) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_8$$3, "__construct", NULL, 384, &_10$$3, &field, &_9$$3, &code);
		zephir_check_call_status();
	...
	if (!(_14)) {
		...
		ZEPHIR_CALL_FUNCTION(&_16, "is_uploaded_file", NULL, 210, &_15);
		zephir_check_call_status();
	...
	if (_14) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_17$$4, "__construct", NULL, 384, &_20$$4, &field, &_18$$4, &code);
		zephir_check_call_status();
	...
	if (_22) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_23$$5, "__construct", NULL, 384, &_26$$5, &field, &_24$$5, &code);
		zephir_check_call_status();
	...
	if (zephir_is_true(&_27)) {
		...
		ZEPHIR_CALL_FUNCTION(&_35$$6, "floatval", NULL, 256, &_34$$6);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_35$$6, "floatval", NULL, 256, &_39$$6);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_40$$6, "floatval", NULL, 256, &bytes);
		zephir_check_call_status();
		if (ZEPHIR_GT(&_35$$6, &_40$$6)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_41$$9, "__construct", NULL, 384, &_44$$9, &field, &_42$$9, &code);
			zephir_check_call_status();
	...
	if (zephir_is_true(&_45)) {
		...
		if ((zephir_function_exists_ex(ZEND_STRL("finfo_open")) == SUCCESS)) {
			...
			ZEPHIR_GET_CONSTANT(&_47$$13, "FILEINFO_MIME_TYPE");
			ZEPHIR_CALL_FUNCTION(&tmp, "finfo_open", NULL, 0, &_47$$13);
			zephir_check_call_status();
			zephir_array_fetch_string(&_48$$13, &value, SL("tmp_name"), PH_NOISY | PH_READONLY, "phalcon/validation/validator/file.zep", 210);
			ZEPHIR_CALL_FUNCTION(&mime, "finfo_file", NULL, 0, &tmp, &_48$$13);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(NULL, "finfo_close", NULL, 0, &tmp);
			zephir_check_call_status();
		} else {
		...
		if (!(zephir_fast_in_array(&mime, &types))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_49$$15, "__construct", NULL, 384, &_52$$15, &field, &_50$$15, &code);
			zephir_check_call_status();
	...
	if (_54) {
		...
		ZEPHIR_CALL_FUNCTION(&tmp, "getimagesize", NULL, 218, &_56$$16);
		zephir_check_call_status();
		...
		if (_61$$16) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_62$$20, "__construct", NULL, 384, &_65$$20, &field, &_63$$20, &code);
			zephir_check_call_status();
		...
		if (zephir_is_true(&_66$$16)) {
			...
			if (_69$$21) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_70$$23, "__construct", NULL, 384, &_73$$23, &field, &_71$$23, &code);
				zephir_check_call_status();
