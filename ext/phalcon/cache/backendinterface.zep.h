...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_cache_backendinterface_getfrontend, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_cache_backendinterface_getoptions, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_cache_backendinterface_getlastkey, 0, 0, 0)
ZEND_END_ARG_INFO()
