...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_cache_frontend_base64_start, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_cache_frontend_base64_getcontent, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_cache_frontend_base64_stop, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_cache_frontend_base64_method_entry) {
	...
	PHP_ME(Phalcon_Cache_Frontend_Base64, start, arginfo_phalcon_cache_frontend_base64_start, ZEND_ACC_PUBLIC)
#else
	PHP_ME(Phalcon_Cache_Frontend_Base64, start, NULL, ZEND_ACC_PUBLIC)
#endif
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Cache_Frontend_Base64, getContent, arginfo_phalcon_cache_frontend_base64_getcontent, ZEND_ACC_PUBLIC)
#else
	PHP_ME(Phalcon_Cache_Frontend_Base64, getContent, NULL, ZEND_ACC_PUBLIC)
#endif
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Cache_Frontend_Base64, stop, arginfo_phalcon_cache_frontend_base64_stop, ZEND_ACC_PUBLIC)
#else
