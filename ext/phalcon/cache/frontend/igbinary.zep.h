...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_cache_frontend_igbinary_start, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_cache_frontend_igbinary_getcontent, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_cache_frontend_igbinary_stop, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_cache_frontend_igbinary_method_entry) {
	...
	PHP_ME(Phalcon_Cache_Frontend_Igbinary, start, arginfo_phalcon_cache_frontend_igbinary_start, ZEND_ACC_PUBLIC)
#else
	PHP_ME(Phalcon_Cache_Frontend_Igbinary, start, NULL, ZEND_ACC_PUBLIC)
#endif
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Cache_Frontend_Igbinary, getContent, arginfo_phalcon_cache_frontend_igbinary_getcontent, ZEND_ACC_PUBLIC)
#else
	PHP_ME(Phalcon_Cache_Frontend_Igbinary, getContent, NULL, ZEND_ACC_PUBLIC)
#endif
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Cache_Frontend_Igbinary, stop, arginfo_phalcon_cache_frontend_igbinary_stop, ZEND_ACC_PUBLIC)
#else
