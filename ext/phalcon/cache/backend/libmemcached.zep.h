...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_cache_backend_libmemcached__connect, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_cache_backend_libmemcached_method_entry) {
	...
	PHP_ME(Phalcon_Cache_Backend_Libmemcached, _connect, arginfo_phalcon_cache_backend_libmemcached__connect, ZEND_ACC_PUBLIC)
#else
