...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_cache_backend_memcache__connect, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_cache_backend_memcache_method_entry) {
	...
	PHP_ME(Phalcon_Cache_Backend_Memcache, _connect, arginfo_phalcon_cache_backend_memcache__connect, ZEND_ACC_PUBLIC)
#else
