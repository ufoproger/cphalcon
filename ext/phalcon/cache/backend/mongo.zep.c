...
PHP_METHOD(Phalcon_Cache_Backend_Mongo, _getCollection) {
	...
	zephir_read_property(&mongoCollection, this_ptr, ZEND_STRL("_collection"), PH_NOISY_CC);
	if (Z_TYPE_P(&mongoCollection) != IS_OBJECT) {
		...
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, ZEND_STRL("_collection"), &mongoCollection);
	}
...
PHP_METHOD(Phalcon_Cache_Backend_Mongo, get) {
	...
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "_getcollection", NULL, 102);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Cache_Backend_Mongo, save) {
	...
	ZEPHIR_CALL_METHOD(&collection, this_ptr, "_getcollection", NULL, 102);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	zephir_time(&_1);
...
PHP_METHOD(Phalcon_Cache_Backend_Mongo, delete) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "_getcollection", NULL, 102);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	zephir_create_array(&_1, 1, 0);
	zephir_read_property(&_2, this_ptr, ZEND_STRL("_prefix"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_3);
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_4, "rand", NULL, 103);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Cache_Backend_Mongo, exists) {
	...
	if (zephir_is_true(&lastKey)) {
		ZEPHIR_CALL_METHOD(&_1$$5, this_ptr, "_getcollection", NULL, 102);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Cache_Backend_Mongo, increment) {
	...
	ZEPHIR_CONCAT_VV(&prefixedKey, &_0, keyName);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_lastKey"), &prefixedKey);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "_getcollection", NULL, 102);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
	zephir_create_array(&_2, 1, 0);
