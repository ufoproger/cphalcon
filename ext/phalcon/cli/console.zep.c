...
PHP_METHOD(Phalcon_Cli_Console, handle) {
	...
	if (_5) {
		zephir_read_property(&_0, this_ptr, ZEND_STRL("_arguments"), PH_NOISY_CC | PH_READONLY);
		_5 = zephir_is_true(&_0);
	}
	if (_5) {
		zephir_read_property(&_6$$6, this_ptr, ZEND_STRL("_arguments"), PH_NOISY_CC | PH_READONLY);
	...
	if (zephir_is_true(&moduleName)) {
		...
		zephir_read_property(&modules, this_ptr, ZEND_STRL("_modules"), PH_NOISY_CC);
	...
	zephir_check_call_status();
	zephir_read_property(&_17, this_ptr, ZEND_STRL("_options"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Cli_Console, setArgument) {
	...
	if (Z_TYPE_P(&arguments) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&arguments), _1)
		{
			...
			if (Z_TYPE_P(&arg) == IS_STRING) {
				...
				ZVAL_STRING(&_3$$5, "--");
				ZVAL_LONG(&_4$$5, 2);
				ZEPHIR_CALL_FUNCTION(&_5$$5, "strncmp", &_6, 117, &arg, &_3$$5, &_4$$5);
				zephir_check_call_status();
				if (ZEPHIR_IS_LONG(&_5$$5, 0)) {
					...
					ZVAL_STRING(&_18$$9, "-");
					ZVAL_LONG(&_19$$9, 1);
					ZEPHIR_CALL_FUNCTION(&_20$$9, "strncmp", &_6, 117, &arg, &_18$$9, &_19$$9);
					zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (Z_TYPE_P(&arg) == IS_STRING) {
					...
					ZVAL_STRING(&_23$$14, "--");
					ZVAL_LONG(&_24$$14, 2);
					ZEPHIR_CALL_FUNCTION(&_25$$14, "strncmp", &_6, 117, &arg, &_23$$14, &_24$$14);
					zephir_check_call_status();
					if (ZEPHIR_IS_LONG(&_25$$14, 0)) {
						...
						ZVAL_STRING(&_37$$18, "-");
						ZVAL_LONG(&_38$$18, 1);
						ZEPHIR_CALL_FUNCTION(&_39$$18, "strncmp", &_6, 117, &arg, &_37$$18, &_38$$18);
						zephir_check_call_status();
	...
	if (str) {
		...
		zephir_update_property_zval(this_ptr, ZEND_STRL("_arguments"), &_42$$22);
	} else {
		...
		zephir_update_property_zval(this_ptr, ZEND_STRL("_arguments"), &handleArgs);
	}
	zephir_update_property_zval(this_ptr, ZEND_STRL("_options"), &opts);
	RETURN_THIS();
...
zend_object *zephir_init_properties_Phalcon_Cli_Console(zend_class_entry *class_type) {
	...
	
	{
		...
		zephir_read_property_ex(&_0, this_ptr, ZEND_STRL("_options"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_0) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_1$$3);
			array_init(&_1$$3);
			zephir_update_property_zval_ex(this_ptr, ZEND_STRL("_options"), &_1$$3);
		}
		zephir_read_property_ex(&_2, this_ptr, ZEND_STRL("_modules"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_2) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_3$$4);
			array_init(&_3$$4);
			zephir_update_property_zval_ex(this_ptr, ZEND_STRL("_modules"), &_3$$4);
		}
		zephir_read_property_ex(&_4, this_ptr, ZEND_STRL("_arguments"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_4) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_5$$5);
			array_init(&_5$$5);
			zephir_update_property_zval_ex(this_ptr, ZEND_STRL("_arguments"), &_5$$5);
		}
		ZEPHIR_MM_RESTORE();
