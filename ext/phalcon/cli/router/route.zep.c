...
PHP_METHOD(Phalcon_Cli_Router_Route, __construct) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_delimiter"), &delimiter);
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_id"), &routeId);
...
PHP_METHOD(Phalcon_Cli_Router_Route, compilePattern) {
	...
	if (zephir_memnstr_str(&pattern, SL(":"), "phalcon/cli/router/route.zep", 94)) {
		zephir_read_property(&_0$$3, this_ptr, ZEND_STRL("_delimiter"), PH_NOISY_CC | PH_READONLY);
		...
		if (zephir_memnstr_str(&pattern, SL(":delimiter"), "phalcon/cli/router/route.zep", 100)) {
			...
			zephir_read_property(&_2$$4, this_ptr, ZEND_STRL("_delimiter"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_INIT_VAR(&_3$$4);
			ZVAL_STRING(&_3$$4, ":delimiter");
			zephir_fast_str_replace(&_1$$4, &_3$$4, &_2$$4, &pattern);
			zephir_get_strval(&pattern, &_1$$4);
		}
		zephir_read_property(&_4$$3, this_ptr, ZEND_STRL("_delimiter"), PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property(&_6$$3, this_ptr, ZEND_STRL("_delimiter"), PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property(&_8$$3, this_ptr, ZEND_STRL("_delimiter"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&part);
		...
		zephir_read_property(&_10$$3, this_ptr, ZEND_STRL("_delimiter"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&part);
		...
		zephir_read_property(&_12$$3, this_ptr, ZEND_STRL("_delimiter"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&part);
		ZEPHIR_CONCAT_VS(&part, &_12$$3, ":params");
		if (zephir_memnstr(&pattern, &part, "phalcon/cli/router/route.zep", 130)) {
			ZEPHIR_INIT_VAR(&_13$$9);
			zephir_read_property(&_14$$9, this_ptr, ZEND_STRL("_delimiter"), PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property(&_16$$3, this_ptr, ZEND_STRL("_delimiter"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&part);
		ZEPHIR_CONCAT_VS(&part, &_16$$3, ":int");
		if (zephir_memnstr(&pattern, &part, "phalcon/cli/router/route.zep", 136)) {
			ZEPHIR_INIT_VAR(&_17$$10);
			zephir_read_property(&_18$$10, this_ptr, ZEND_STRL("_delimiter"), PH_NOISY_CC | PH_READONLY);
						...
						if (bracketCount == 0) {
							...
							if (!(notValid)) {
								...
								if (_25$$18) {
									...
									zephir_read_property(&_28$$28, this_ptr, ZEND_STRL("_delimiter"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Cli_Router_Route, reConfigure) {
	...
	if (!(zephir_start_with_str(&pattern, SL("#")))) {
		...
		if (zephir_memnstr_str(&pattern, SL(":delimiter"), "phalcon/cli/router/route.zep", 401)) {
			...
			zephir_read_property(&_5$$21, this_ptr, ZEND_STRL("_delimiter"), PH_NOISY_CC | PH_READONLY);
