...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_http_cookieinterface_delete, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_http_cookieinterface_method_entry) {
	...
	PHP_ABSTRACT_ME(Phalcon_Http_CookieInterface, delete, arginfo_phalcon_http_cookieinterface_delete)
