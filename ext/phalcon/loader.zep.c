...
PHP_METHOD(Phalcon_Loader, setExtensions) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_extensions"), &extensions);
	RETURN_THIS();
	...
	if (merge) {
		...
		if (Z_TYPE_P(&preparedNamespaces) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&preparedNamespaces), _2$$3, _3$$3, _0$$3)
			{
				...
				zephir_read_property(&_4$$4, this_ptr, ZEND_STRL("_namespaces"), PH_NOISY_CC | PH_READONLY);
				...
				zephir_read_property(&_7$$4, this_ptr, ZEND_STRL("_namespaces"), PH_NOISY_CC | PH_READONLY);
			...
			while (1) {
				...
				zephir_check_call_status();
					zephir_read_property(&_9$$6, this_ptr, ZEND_STRL("_namespaces"), PH_NOISY_CC | PH_READONLY);
					...
					zephir_read_property(&_12$$6, this_ptr, ZEND_STRL("_namespaces"), PH_NOISY_CC | PH_READONLY);
		...
		zephir_update_property_zval(this_ptr, ZEND_STRL("_namespaces"), &preparedNamespaces);
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Loader, registerDirs) {
	...
	if (merge) {
		...
		zephir_read_property(&_1$$3, this_ptr, ZEND_STRL("_directories"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_0$$3, &_1$$3, &directories);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_directories"), &_0$$3);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_directories"), &directories);
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Loader, registerFiles) {
	...
	if (merge) {
		ZEPHIR_INIT_VAR(&_0$$3);
		zephir_read_property(&_1$$3, this_ptr, ZEND_STRL("_files"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_0$$3, &_1$$3, &files);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_files"), &_0$$3);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_files"), &files);
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Loader, registerClasses) {
	...
	if (merge) {
		ZEPHIR_INIT_VAR(&_0$$3);
		zephir_read_property(&_1$$3, this_ptr, ZEND_STRL("_classes"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_0$$3, &_1$$3, &classes);
		zephir_update_property_zval(this_ptr, ZEND_STRL("_classes"), &_0$$3);
	} else {
		zephir_update_property_zval(this_ptr, ZEND_STRL("_classes"), &classes);
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Loader, register) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_registered"), PH_NOISY_CC | PH_READONLY);
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_register", NULL, 230, &_1$$3, &__$true, &_3$$3);
		zephir_check_call_status();
		if (1) {
			zephir_update_property_zval(this_ptr, ZEND_STRL("_registered"), &__$true);
		} else {
			zephir_update_property_zval(this_ptr, ZEND_STRL("_registered"), &__$false);
		}
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Loader, unregister) {
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZVAL_STRING(&_2$$3, "autoLoad");
		zephir_array_fast_append(&_1$$3, &_2$$3);
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_unregister", NULL, 231, &_1$$3);
		zephir_check_call_status();
		if (0) {
			zephir_update_property_zval(this_ptr, ZEND_STRL("_registered"), &__$true);
		} else {
...
PHP_METHOD(Phalcon_Loader, loadFiles) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_files"), PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
		{
			...
			zephir_read_property(&_3$$3, this_ptr, ZEND_STRL("_eventsManager"), PH_NOISY_CC);
			if (Z_TYPE_P(&_3$$3) == IS_OBJECT) {
				zephir_update_property_zval(this_ptr, ZEND_STRL("_checkedPath"), &filePath);
				zephir_read_property(&_4$$4, this_ptr, ZEND_STRL("_eventsManager"), PH_NOISY_CC | PH_READONLY);
				ZEPHIR_INIT_NVAR(&_5$$4);
				ZVAL_STRING(&_5$$4, "loader:beforeCheckPath");
				ZEPHIR_CALL_METHOD(NULL, &_4$$4, "fire", NULL, 0, &_5$$4, this_ptr, &filePath);
				zephir_check_call_status();
			}
			ZEPHIR_CALL_FUNCTION(&_6$$3, "call_user_func", &_7, 232, &fileCheckingCallback, &filePath);
			zephir_check_call_status();
			if (zephir_is_true(&_6$$3)) {
				ZEPHIR_OBS_NVAR(&_8$$5);
				zephir_read_property(&_8$$5, this_ptr, ZEND_STRL("_eventsManager"), PH_NOISY_CC);
				if (Z_TYPE_P(&_8$$5) == IS_OBJECT) {
					zephir_update_property_zval(this_ptr, ZEND_STRL("_foundPath"), &filePath);
					zephir_read_property(&_9$$6, this_ptr, ZEND_STRL("_eventsManager"), PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_read_property(&_11$$7, this_ptr, ZEND_STRL("_eventsManager"), PH_NOISY_CC);
				if (Z_TYPE_P(&_11$$7) == IS_OBJECT) {
					zephir_update_property_zval(this_ptr, ZEND_STRL("_checkedPath"), &filePath);
					zephir_read_property(&_12$$8, this_ptr, ZEND_STRL("_eventsManager"), PH_NOISY_CC | PH_READONLY);
					ZEPHIR_INIT_NVAR(&_13$$8);
					ZVAL_STRING(&_13$$8, "loader:beforeCheckPath");
					ZEPHIR_CALL_METHOD(NULL, &_12$$8, "fire", NULL, 0, &_13$$8, this_ptr, &filePath);
					zephir_check_call_status();
				}
				ZEPHIR_CALL_FUNCTION(&_14$$7, "call_user_func", &_7, 232, &fileCheckingCallback, &filePath);
				zephir_check_call_status();
				if (zephir_is_true(&_14$$7)) {
					ZEPHIR_OBS_NVAR(&_15$$9);
					zephir_read_property(&_15$$9, this_ptr, ZEND_STRL("_eventsManager"), PH_NOISY_CC);
					if (Z_TYPE_P(&_15$$9) == IS_OBJECT) {
						zephir_update_property_zval(this_ptr, ZEND_STRL("_foundPath"), &filePath);
						zephir_read_property(&_16$$10, this_ptr, ZEND_STRL("_eventsManager"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Loader, autoLoad) {
	...
	zephir_read_property(&classes, this_ptr, ZEND_STRL("_classes"), PH_NOISY_CC);
	...
	zephir_read_property(&namespaces, this_ptr, ZEND_STRL("_namespaces"), PH_NOISY_CC);
	zephir_read_property(&_2, this_ptr, ZEND_STRL("fileCheckingCallback"), PH_NOISY_CC | PH_READONLY);
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _10$$6)
				{
					...
					if (Z_TYPE_P(&extensions) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _13$$9)
						{
							...
							ZEPHIR_CALL_FUNCTION(&_17$$10, "call_user_func", &_18, 232, &fileCheckingCallback, &filePath);
							zephir_check_call_status();
						...
						while (1) {
							...
							zephir_check_call_status();
								...
								ZEPHIR_CALL_FUNCTION(&_23$$14, "call_user_func", &_18, 232, &fileCheckingCallback, &filePath);
								zephir_check_call_status();
					...
					zephir_check_call_status();
						...
						if (Z_TYPE_P(&extensions) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _27$$18)
							{
								...
								ZEPHIR_CALL_FUNCTION(&_31$$19, "call_user_func", &_18, 232, &fileCheckingCallback, &filePath);
								zephir_check_call_status();
							...
							while (1) {
								...
								zephir_check_call_status();
									...
									ZEPHIR_CALL_FUNCTION(&_36$$23, "call_user_func", &_18, 232, &fileCheckingCallback, &filePath);
									zephir_check_call_status();
					...
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _42$$27)
					{
						...
						if (Z_TYPE_P(&extensions) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _45$$30)
							{
								...
								ZEPHIR_CALL_FUNCTION(&_49$$31, "call_user_func", &_18, 232, &fileCheckingCallback, &filePath);
								zephir_check_call_status();
							...
							while (1) {
								...
								zephir_check_call_status();
									...
									ZEPHIR_CALL_FUNCTION(&_54$$35, "call_user_func", &_18, 232, &fileCheckingCallback, &filePath);
									zephir_check_call_status();
						...
						zephir_check_call_status();
							...
							if (Z_TYPE_P(&extensions) == IS_ARRAY) {
								ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _58$$39)
								{
									...
									ZEPHIR_CALL_FUNCTION(&_62$$40, "call_user_func", &_18, 232, &fileCheckingCallback, &filePath);
									zephir_check_call_status();
								...
								while (1) {
									...
									zephir_check_call_status();
										...
										ZEPHIR_CALL_FUNCTION(&_67$$44, "call_user_func", &_18, 232, &fileCheckingCallback, &filePath);
										zephir_check_call_status();
	...
	zephir_read_property(&directories, this_ptr, ZEND_STRL("_directories"), PH_NOISY_CC);
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _70)
		{
			...
			if (Z_TYPE_P(&extensions) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _73$$48)
				{
					...
					ZEPHIR_CALL_FUNCTION(&_77$$49, "call_user_func", &_18, 232, &fileCheckingCallback, &filePath);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						ZEPHIR_CALL_FUNCTION(&_82$$53, "call_user_func", &_18, 232, &fileCheckingCallback, &filePath);
						zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&extensions) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _86$$57)
					{
						...
						ZEPHIR_CALL_FUNCTION(&_90$$58, "call_user_func", &_18, 232, &fileCheckingCallback, &filePath);
						zephir_check_call_status();
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							ZEPHIR_CALL_FUNCTION(&_95$$62, "call_user_func", &_18, 232, &fileCheckingCallback, &filePath);
							zephir_check_call_status();
...
zend_object *zephir_init_properties_Phalcon_Loader(zend_class_entry *class_type) {
	...
	
	{
		...
		zephir_read_property_ex(&_0, this_ptr, ZEND_STRL("_files"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_0) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_1$$3);
			array_init(&_1$$3);
			zephir_update_property_zval_ex(this_ptr, ZEND_STRL("_files"), &_1$$3);
		}
		zephir_read_property_ex(&_2, this_ptr, ZEND_STRL("_directories"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_2) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_3$$4);
			array_init(&_3$$4);
			zephir_update_property_zval_ex(this_ptr, ZEND_STRL("_directories"), &_3$$4);
		}
		zephir_read_property_ex(&_4, this_ptr, ZEND_STRL("_namespaces"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_4) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_5$$5);
			array_init(&_5$$5);
			zephir_update_property_zval_ex(this_ptr, ZEND_STRL("_namespaces"), &_5$$5);
		}
		zephir_read_property_ex(&_6, this_ptr, ZEND_STRL("_extensions"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_6) == IS_NULL) {
			...
			zephir_update_property_zval_ex(this_ptr, ZEND_STRL("_extensions"), &_7$$6);
		}
		zephir_read_property_ex(&_9, this_ptr, ZEND_STRL("_classes"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_9) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_10$$7);
			array_init(&_10$$7);
			zephir_update_property_zval_ex(this_ptr, ZEND_STRL("_classes"), &_10$$7);
		}
		ZEPHIR_MM_RESTORE();
