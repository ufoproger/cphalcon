...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_validationinterface_getvalidators, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_validationinterface_getentity, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_validationinterface_method_entry) {
	...
	PHP_ABSTRACT_ME(Phalcon_ValidationInterface, getEntity, arginfo_phalcon_validationinterface_getentity)
