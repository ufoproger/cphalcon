...
ZEPHIR_INIT_CLASS(Phalcon_Session_Bag) {
	...
	zend_class_implements(phalcon_session_bag_ce, 1, zephir_get_internal_ce(SL("iteratoraggregate")));
	zend_class_implements(phalcon_session_bag_ce, 1, zend_ce_arrayaccess);
	zend_class_implements(phalcon_session_bag_ce, 1, zend_ce_countable);
	return SUCCESS;
...
PHP_METHOD(Phalcon_Session_Bag, initialize) {
	...
	zephir_read_property(&session, this_ptr, ZEND_STRL("_session"), PH_NOISY_CC);
	if (Z_TYPE_P(&session) != IS_OBJECT) {
		...
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, ZEND_STRL("_session"), &session);
	}
	zephir_read_property(&_2, this_ptr, ZEND_STRL("_name"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Session_Bag, destroy) {
	...
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	zephir_update_property_zval(this_ptr, ZEND_STRL("_data"), &_1);
	zephir_read_property(&_2, this_ptr, ZEND_STRL("_session"), PH_NOISY_CC | PH_READONLY);
	zephir_read_property(&_3, this_ptr, ZEND_STRL("_name"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Session_Bag, set) {
	...
	zephir_read_property(&_1, this_ptr, ZEND_STRL("_session"), PH_NOISY_CC | PH_READONLY);
	zephir_read_property(&_2, this_ptr, ZEND_STRL("_name"), PH_NOISY_CC | PH_READONLY);
	zephir_read_property(&_3, this_ptr, ZEND_STRL("_data"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Session_Bag, remove) {
	...
	if (zephir_array_isset(&data, &property)) {
		...
		zephir_read_property(&_1$$4, this_ptr, ZEND_STRL("_session"), PH_NOISY_CC | PH_READONLY);
		zephir_read_property(&_2$$4, this_ptr, ZEND_STRL("_name"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Session_Bag, getIterator) {
	...
	zephir_read_property(&_1, this_ptr, ZEND_STRL("_data"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 365, &_1);
	zephir_check_call_status();
	RETURN_MM();
