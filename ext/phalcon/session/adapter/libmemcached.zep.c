...
PHP_METHOD(Phalcon_Session_Adapter_Libmemcached, __construct) {
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("_lifetime"), &_1);
	...
	ZEPHIR_OBS_VAR(&_5);
	zephir_read_property(&_5, this_ptr, ZEND_STRL("_lifetime"), PH_NOISY_CC);
	zephir_array_update_string(&_4, SL("lifetime"), &_5, PH_COPY | PH_SEPARATE);
	ZEPHIR_CALL_METHOD(NULL, &_3, "__construct", NULL, 270, &_4);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_6);
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 271, &_3, &_6);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("_libmemcached"), &_2);
	ZEPHIR_INIT_VAR(&_7);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_set_save_handler", NULL, 0, &_7, &_9, &_10, &_11, &_12, &_13);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Session_Adapter_Libmemcached, read) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_libmemcached"), PH_NOISY_CC | PH_READONLY);
	zephir_read_property(&_2, this_ptr, ZEND_STRL("_lifetime"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Session_Adapter_Libmemcached, write) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_libmemcached"), PH_NOISY_CC | PH_READONLY);
	zephir_read_property(&_1, this_ptr, ZEND_STRL("_lifetime"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Session_Adapter_Libmemcached, destroy) {
	...
	if (_0) {
		zephir_read_property(&_1, this_ptr, ZEND_STRL("_libmemcached"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_2, &_1, "exists", NULL, 0, &id);
		zephir_check_call_status();
		_0 = zephir_is_true(&_2);
	}
	if (_0) {
		zephir_read_property(&_3$$5, this_ptr, ZEND_STRL("_libmemcached"), PH_NOISY_CC | PH_READONLY);
