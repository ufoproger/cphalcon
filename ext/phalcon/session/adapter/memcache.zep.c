...
PHP_METHOD(Phalcon_Session_Adapter_Memcache, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_4, "__construct", NULL, 270, &_5);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &_3, "__construct", NULL, 272, &_4, &options);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Session_Adapter_Memcache, destroy) {
	...
	if (_0) {
		zephir_read_property(&_1, this_ptr, ZEND_STRL("_memcache"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_2, &_1, "exists", NULL, 0, &id);
		zephir_check_call_status();
		_0 = zephir_is_true(&_2);
	}
	if (_0) {
		zephir_read_property(&_3$$5, this_ptr, ZEND_STRL("_memcache"), PH_NOISY_CC | PH_READONLY);
