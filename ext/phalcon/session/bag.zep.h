...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_session_bag_initialize, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_session_bag_destroy, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_session_bag___unset, 0, 1, IS_VOID, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_session_bag_method_entry) {
	...
	PHP_ME(Phalcon_Session_Bag, initialize, arginfo_phalcon_session_bag_initialize, ZEND_ACC_PUBLIC)
#else
	PHP_ME(Phalcon_Session_Bag, initialize, NULL, ZEND_ACC_PUBLIC)
#endif
#if PHP_VERSION_ID >= 80000
	PHP_ME(Phalcon_Session_Bag, destroy, arginfo_phalcon_session_bag_destroy, ZEND_ACC_PUBLIC)
#else
